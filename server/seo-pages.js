...
function renderShell(main, routePath) {
  return `
    ...
    ${routePath === "/" ? "" : `<details class="mobile-store-menu">
    ...
    <main>
      ...
      <section class="section engagement-feature home-engagement-preview" aria-labelledby="featured-engagement-rings-title">
        ...
        <div class="ring-showcase ring-preview-showcase" aria-label="Featured engagement ring designs">
          <a class="engagement-preview-card" href="/products/queen-aurelia-oval-marquise-ring"><img src="/queen-aurelia-oval-marquise-ring.jpeg" alt="Queen Aurelia oval and marquise engagement ring" width="899" height="1600" loading="lazy" decoding="async"><span><strong>Queen Aurelia</strong><small>Oval & marquise signature</small><em>View &amp; Buy</em></span></a>
          <a class="engagement-preview-card" href="/products/monarch-pink-diamond-ring-pink-oval-engagement-ring"><img src="/pink-oval-engagement-ring.jpeg" alt="Monarch Pink oval diamond engagement ring" width="900" height="900" loading="lazy" decoding="async"><span><strong>Monarch Pink</strong><small>Pink oval design</small><em>View &amp; Buy</em></span></a>
          <a class="engagement-preview-card" href="/products/monarch-canary-oval-ring-yellow-oval-diamond-ring"><img src="/yellow-oval-diamond-ring.jpeg" alt="Monarch Canary yellow oval diamond engagement ring" width="900" height="900" loading="lazy" decoding="async"><span><strong>Monarch Canary</strong><small>Yellow oval design</small><em>View &amp; Buy</em></span></a>
          <a class="engagement-preview-card desktop-only-featured-ring" href="/products/marquise-crown-diamond-engagement-ring"><img src="/mens-band-black-01-catalog.webp" alt="Marquise Crown diamond engagement ring" width="720" height="720" loading="lazy" decoding="async"><span><strong>Marquise Crown</strong><small>Sculptural marquise design</small><em>View &amp; Buy</em></span></a>
          <a class="engagement-preview-card desktop-only-featured-ring" href="/products/k24b-marquise-diamond-engagement-ring"><img src="/assets/customer-products/02-BDD4A1EE-BA1A-4B48-9782-CBF67D6172D2-catalog.webp" alt="La Marquesa K24B marquise engagement ring" width="720" height="720" loading="lazy" decoding="async"><span><strong>La Marquesa K24B</strong><small>Marquise with graduated accents</small><em>View &amp; Buy</em></span></a>
          <a class="engagement-preview-card desktop-only-featured-ring" href="/products/radiant-pave-diamond-engagement-ring"><img src="/assets/customer-products/03-548DB3E3-12A3-46B9-B2B6-F55850911923-catalog.webp" alt="Reina Luz radiant pavé diamond engagement ring" width="720" height="720" loading="lazy" decoding="async"><span><strong>Reina Luz</strong><small>Radiant center &amp; pavé band</small><em>View &amp; Buy</em></span></a>
        </div>
      </section>
      <section class="home-category-section" aria-labelledby="home-category-title">
        ...
        <nav class="home-category-carousel" aria-label="Featured jewelry categories">
          <a href="/category/engagement-rings" style="--category-image:url('/pink-oval-engagement-ring.jpeg')"><strong>Engagement Rings</strong><small>Premade and custom</small></a>
          <a href="/products" style="--category-image:url('/yellow-gold-diamond-cuban-link-bracelet.jpeg')"><strong>Fine Jewelry</strong><small>Shop all products</small></a>
          <a href="/select-diamond" style="--category-image:url('/live-diamond-selection.jpeg')"><strong>Live Diamonds</strong><small>Certified stones</small></a>
          <a href="/cvd-lab-grown-diamond-jewelry" style="--category-image:url('/triple-row-diamond-tennis-bracelet.jpeg')"><strong>CVD Lab Jewelry</strong><small>Modern diamond pieces</small></a>
          <a href="/category/mens-earrings" style="--category-image:url('/round-diamond-studs.jpeg')"><strong>Men's Earrings</strong><small>Studs and custom</small></a>
          <a href="/category/womens-earrings" style="--category-image:url('/blue-monarch-diamond-studs.jpeg')"><strong>Women's Earrings</strong><small>Classic and custom</small></a>
        </nav>
      </section>
