...
const OFFICIAL_SOCIAL_LINKS = [ "https://www.instagram.com/los_thejeweler/", "https://www.facebook.com/profile.php?id=100089172553878", GOOGLE_BUSINESS_PROFILE_URL ];
...
const staticPageMeta = {
    ...
    "/jewelry-financing": {
        ...
        priority: "0.8",
        sections: [ [ "$500 first custom-order credit", "New customers can receive a $500 credit on a first eligible custom jewelry order of $2,500 or more. Mention the offer in the custom design request so eligibility can be confirmed during quote review. Promotions cannot stack." ], [ "15% off with THEDON15", "Enter THEDON15 in the promotion-code field at secure Stripe Checkout for 15% off eligible items in the current order. Choose either THEDON15 or the $500 first custom-order credit; promotions cannot stack." ], [ "How Buy Now, Pay Later works", "Add an eligible item to cart and continue to secure Stripe Checkout. If an eligible provider is available for the order and customer, select it, review the provider's payment schedule and disclosures, then submit an application. Approval is handled by the provider, not The Don Jewelers." ], [ "Affirm", "Affirm may offer pay-over-time plans for eligible purchases. Available terms, interest or APR, required down payment, and total cost are shown by Affirm before acceptance. Eligibility and approval vary by customer and order." ], [ "Klarna", "Klarna may offer installment or pay-later choices for eligible purchases. The available schedule, any fees or interest, and the first payment timing appear before acceptance. Klarna makes the approval decision." ], [ "Afterpay", "Afterpay may divide an eligible purchase into scheduled installments. The exact schedule, initial payment, spending limit, and late-fee rules are provided by Afterpay before acceptance. Approval is not guaranteed." ], [ "Eligibility and approval", "Provider availability can vary by order amount, location, currency, device, customer history, and Stripe eligibility. Financing logos explain possible options; they do not promise that every provider will appear or approve every application." ], [ "Payments, returns, and custom orders", "Payments are managed through the selected financing provider. Refunds and canceled orders follow the store return policy and the provider's processing timeline. Custom or made-to-order work may require deposits and may have different cancellation limits, so review the order details before payment." ], [ "Questions before applying", "Call (484) 761-2008 or book a private consultation for help choosing an item or understanding the checkout path. The Don Jewelers can explain the purchase process but does not make credit decisions or change a provider's terms." ] ]
    },
    "/diamond-education": {
    ...
    "/engagement-ring-consultation-easton-bethlehem": {
        ...
        priority: "0.92",
        sections: [ [ "Prepare before the appointment", "Bring your proposal timing, budget range, preferred diamond origin and shape, ring size if known, and a few inspiration photos. You do not need every specification decided before speaking with a jeweler." ], [ "Compare the full ring, not only the diamond", "Review center-stone proportions, setting height, basket, prongs, band width, metal, wedding-band fit, daily wear, and production timing as one complete design." ], [ "Appointment-only service", "Easton and Bethlehem clients should confirm the consultation format and appointment details directly before traveling. Remote planning and nationwide service may be available where appropriate." ] ]
    },
    "/custom-jewelry-project-gallery": {
        ...
        priority: "0.88",
        sections: [ [ "Start with owned inspiration", "Use these finished pieces and design directions to explain proportion, stone layout, metal color, engraving, and overall style. Every new commission is reviewed as its own project." ], [ "From idea to specifications", "A useful custom request includes the jewelry type, metal, diamond or gemstone preference, dimensions, ring size or chain length, budget, timeline, and inspiration files." ], [ "Review before production", "Custom work should move through specification and approval steps before final production. Exact pricing, availability, CAD needs, and timing are confirmed personally." ] ]
    },
    "/the-don-jewelers": {
    ...
    "/custom-engagement-ring-process": {
        ...
        priority: "0.9",
        sections: [ [ "Start with the right path", "Begin with a center diamond when carat, shape, color, clarity, or certificate matters most. Begin with a setting when the overall ring style, band, basket, metal, and wedding band fit are the priority." ], [ "Build the design around real constraints", "A strong custom ring plan includes diamond type, shape, carat target, setting style, metal, basket/head, prongs, band profile, ring size, wedding band plan, budget, and timeline." ], [ "Use CAD and quote review before commitment", "The Don Jewelers & Jewelry reviews the design request, confirms availability, checks fit and durability, and prepares a private quote before final production decisions." ] ]
    },
    "/engagement-ring-cost-guide": {
        ...
        priority: "0.88",
        sections: [ [ "Main cost drivers", "The center diamond usually drives the largest cost difference. Carat size, lab-grown versus natural origin, color, clarity, cut quality, certificate, and shape all affect the final quote." ], [ "Setting and metal upgrades", "Platinum, 18K gold, hidden halo baskets, pave bands, cathedral shoulders, three-stone accents, engraving, and matching wedding bands can change the quote even when the same diamond is used." ], [ "Best next step", "Send the design details and ideal budget so the quote can be built around the look, durability, and payment path that make sense for the buyer." ] ]
    },
    "/lab-diamond-buying-guide": {
        ...
        priority: "0.88",
        sections: [ [ "Compare by certificate and specs", "A serious lab diamond search should review certificate, growth method, carat, measurements, color, clarity, cut, polish, symmetry, fluorescence, image, video, and price." ], [ "Match the diamond to the setting", "Oval, round, radiant, emerald, cushion, pear, marquise, princess, Asscher, and heart shapes need different baskets, prong styles, and wedding band planning." ], [ "Use live inventory with a human review", "The site can surface live CVD inventory, but final purchase decisions should still confirm availability, certificate details, setting compatibility, and insured checkout path." ] ]
    },
    "/private-jeweler-vs-retail-store": {
        ...
        priority: "0.86",
        sections: [ [ "Private jeweler advantage", "A private jeweler can focus on the buyer's budget, exact style, diamond sourcing goals, CAD revisions, timeline, and custom details instead of pushing a limited showcase selection." ], [ "Retail store advantage", "A retail store can be convenient for quick browsing, standardized warranties, and seeing preset rings in person. The tradeoff is often less flexibility on custom build details." ], [ "Best fit for custom buyers", "For engagement rings, pendants, tennis bracelets, and one-of-one designs, appointment-based private quote review is usually the better path when the design matters more than buying a preset piece." ] ]
    },
    "/service-areas": {
        title: "Private Jeweler Service Areas | NY PA NJ CT Ohio",
        description: "Explore private jeweler service areas across New York, Pennsylvania, New Jersey, Connecticut, Ohio, Florida, the Tri-State region, and nationwide.",
        label: "Service Areas",
        priority: "0.86"
    },
    "/custom-jeweler-syracuse-ny": {
        title: "Custom Jeweler Syracuse NY | Engagement Rings & Diamonds",
        description: "Private custom jewelry service for Syracuse and Central New York clients seeking engagement rings, certified diamonds, CAD design, pendants, and earrings.",
        label: "Custom Jeweler Syracuse NY",
        priority: "0.84"
    },
    "/custom-jeweler-floral-park-ny": {
        title: "Custom Jeweler Floral Park NY | Engagement Rings",
        description: "Custom engagement rings and fine jewelry for Floral Park, Queens, Nassau County, and western Long Island with private consultation and diamond sourcing.",
        label: "Custom Jeweler Floral Park NY",
        priority: "0.84"
    },
    "/custom-jeweler-long-island-ny": {
        title: "Custom Jeweler Long Island NY | Lab & Natural Diamonds",
        description: "Private jeweler service for Long Island clients comparing custom engagement rings, diamonds, wedding bands, pendants, earrings, and insured delivery.",
        label: "Custom Jeweler Long Island NY",
        priority: "0.86"
    },
    "/custom-jeweler-new-york-state": {
        title: "Custom Jeweler New York State | Private Diamond Jeweler",
        description: "Private custom jewelry and diamond sourcing across New York State, including NYC, Long Island, Syracuse, and Central New York.",
        label: "Custom Jeweler New York State",
        priority: "0.86"
    },
    "/custom-jeweler-philadelphia-pa": {
        title: "Custom Jeweler Philadelphia PA | Engagement Rings",
        description: "Custom engagement rings, certified diamonds, pendants, tennis bracelets, earrings, and CAD design for Philadelphia-area clients.",
        label: "Custom Jeweler Philadelphia PA",
        priority: "0.84"
    },
    "/custom-jeweler-pennsylvania": {
        title: "Custom Jeweler Pennsylvania | Statewide Private Jeweler",
        description: "Statewide private jeweler service from Allentown and the Lehigh Valley to Philadelphia, Harrisburg, Scranton, Pittsburgh, and surrounding Pennsylvania communities.",
        label: "Custom Jeweler Pennsylvania",
        priority: "0.88"
    },
    "/custom-jewelry-pennsylvania": {
        title: "Custom Jewelry Pennsylvania | Private Design & Certified Diamonds",
        description: "Design custom jewelry in Pennsylvania with private consultation, CAD planning, GIA or IGI certified diamonds, insured nationwide shipping, and clear quote support.",
        label: "Custom Jewelry Pennsylvania",
        priority: "0.9"
    },
    "/jewelry-store-easton-pa": {
        title: "Jewelry Store Easton PA | Private Jeweler & Custom Jewelry",
        description: "A private jewelry-store alternative for Easton PA clients seeking engagement rings, custom jewelry, certified diamonds, appointments, and insured delivery.",
        label: "Jewelry Store Easton PA",
        priority: "0.9"
    },
    "/engagement-rings-easton-pa": {
        title: "Engagement Rings Easton PA | Custom Lab & Natural Diamond Rings",
        description: "Shop or design engagement rings for Easton PA with lab-grown or natural diamonds, CAD settings, ring-sizing guidance, financing options, and private consultation.",
        label: "Engagement Rings Easton PA",
        priority: "0.92"
    },
    "/diamond-jewelry-pennsylvania": {
        title: "Diamond Jewelry Pennsylvania | Rings, Pendants & Tennis Jewelry",
        description: "Diamond jewelry for Pennsylvania clients including engagement rings, pendants, earrings, tennis bracelets, certified stones, custom design, and insured shipping.",
        label: "Diamond Jewelry Pennsylvania",
        priority: "0.9"
    },
    "/diamond-district-custom-jewelry-nyc": {
        title: "Diamond District Custom Jewelry NYC | Private Jeweler",
        description: "Create Diamond District custom jewelry in NYC with one-to-one design guidance, CAD approval, certified diamond sourcing, secure checkout, and nationwide service.",
        label: "Diamond District Custom Jewelry NYC",
        priority: "0.94"
    },
    "/custom-jeweler-northern-new-jersey": {
        title: "Custom Jeweler Northern New Jersey | Engagement Rings",
        description: "Private custom jewelry service for Northern New Jersey clients seeking engagement rings, certified diamonds, pendants, earrings, and CAD design.",
        label: "Custom Jeweler Northern New Jersey",
        priority: "0.84"
    },
    "/custom-jeweler-ohio": {
        title: "Custom Jeweler Ohio | Engagement Rings & Lab Diamonds",
        description: "Remote private jeweler service for Ohio clients seeking custom engagement rings, CVD lab-grown diamonds, natural diamonds, pendants, and insured shipping.",
...
const categoryPageMeta = {
    ...
    "diamond-tennis-chains": [ "Diamond Tennis Chains | Custom Tennis Chains | The Don Jewelers", "Shop diamond tennis chains and custom tennis chain options in lab grown or natural diamonds from The Don Jewelers.", "Diamond Tennis Chains", "0.85" ],
    "diamond-tennis-bracelets": [ "Diamond Tennis Bracelets | The Don Jewelers", "Shop diamond tennis bracelets, custom bracelet builds, and fine diamond jewelry from The Don Jewelers.", "Diamond Tennis Bracelets", "0.85" ],
    "mens-rings": [ "Men's Diamond Rings | The Don Jewelers", "Shop men's diamond rings, gold rings, wedding bands, and custom ring designs from The Don Jewelers.", "Men's Rings", "0.82" ],
    "womens-rings": [ "Women's Diamond Rings | The Don Jewelers", "Shop women's diamond rings, gemstone rings, eternity bands, and custom ring designs from The Don Jewelers.", "Women's Rings", "0.82" ],
    ...
    necklaces: [ "Diamond Necklaces & Gold Necklaces | The Don Jewelers", "Shop diamond necklaces, gold necklaces, and custom necklace designs from The Don Jewelers.", "Necklaces", "0.8" ],
    ...
    anklets: [ "Diamond Anklets & Gold Anklets | The Don Jewelers", "Shop diamond anklets, gold anklets, and custom anklet designs from The Don Jewelers.", "Anklets", "0.78" ],
    watches: [ "Luxury Diamond Watches | The Don Jewelers", "Shop luxury watches, diamond watches, and custom iced-out watch designs from The Don Jewelers.", "Watches", "0.8" ]
};
...
function pageMetaForPath(pathname) {
    ...
    if (staticPageMeta[clean]) {
        const meta = {
            path: clean,
            ...staticPageMeta[clean]
        };
        const expanded = prioritySeoSections(meta);
        return expanded.length && !meta.sections ? {
            ...meta,
            sections: expanded
        } : meta;
    }
...
function prioritySeoSections(meta) {
    ...
    const priorityPaths = [ "/custom-jewelry-nyc", "/nyc-diamond-district-jeweler", "/custom-engagement-rings-nyc", "/diamond-pendants", "/diamond-tennis-chains", "/cvd-lab-grown-diamond-jewelry", "/natural-diamond-jewelry", "/engagement-ring-consultation-easton-bethlehem", "/engagement-rings-lehigh-valley", "/diamond-jeweler-pennsylvania", "/custom-jeweler-pennsylvania", "/custom-jewelry-pennsylvania", "/jewelry-store-easton-pa", "/engagement-rings-easton-pa", "/diamond-jewelry-pennsylvania", "/diamond-district-custom-jewelry-nyc" ];
...
function productImage(product) {
    ...
    const optimized = !/^https?:\/\//i.test(String(source)) && /\.(?:png|jpe?g)$/i.test(String(source)) ? String(source).replace(/^\//, "").replace(/\.(?:png|jpe?g)$/i, "-catalog.webp") : source;
...
function specEntries(product) {
    ...
    const rows = [ [ "Jewelry Type", specs.jewelryType || metadata.jewelryType ], [ "Metal", specs.metal || metadata.metal ], [ "Diamond Type", specs.diamondType || metadata.growthMethod || (/lgd/i.test(product?.source || "") ? "CVD Lab-Grown Diamond" : "") ], [ "Carat Weight", specs.caratWeight ? `${specs.caratWeight} CTW` : metadata.diamondWeight ? `${metadata.diamondWeight} CTW` : "" ], [ "Diamond Pieces", specs.diamondPieces || metadata.diamondPieces ], [ "Color", specs.color || metadata.color ], [ "Clarity", specs.clarity || metadata.clarity ], [ "Shape", specs.shape || metadata.shape ], [ "Gross Weight", specs.grossWeight ? `${specs.grossWeight} g` : metadata.grossWeight ? `${metadata.grossWeight} g` : "" ], [ "Size / Length", specs.size || metadata.size ], [ "Stock Number", specs.stockNumber || metadata.stockNumber || product?.externalId ], [ "Availability", product?.availability || specs.availability || metadata.availability ] ];
...
function productSeoCopy(product) {
    ...
    const detailText = [ specs["Jewelry Type"] && `jewelry type: ${specs["Jewelry Type"]}`, specs.Metal && `metal: ${specs.Metal}`, specs["Carat Weight"] && `diamond weight: ${specs["Carat Weight"]}`, specs["Diamond Pieces"] && `diamond pieces: ${specs["Diamond Pieces"]}`, specs.Shape && `shape: ${specs.Shape}`, specs.Color && `color: ${specs.Color}`, specs.Clarity && `clarity: ${specs.Clarity}`, specs["Gross Weight"] && `gross weight: ${specs["Gross Weight"]}`, specs["Size / Length"] && `size or length: ${specs["Size / Length"]}` ].filter(Boolean).join("; ");
...
function productSitemapDiversityKey(product) {
    const specs = Object.fromEntries(specEntries(product));
    return [ product?.source || "", product?.category || "", product?.name || "", specs["Jewelry Type"] || "", specs.Metal || "", specs.Shape || "", specs.Color || "", specs.Clarity || "", specs["Carat Weight"] || "", specs["Size / Length"] || "" ].map(value => slugify(value)).join("|");
}
...
function productSitemapScore(product) {
    ...
    let score = 0;
    if (product.source === "manual") score += 1e3;
...
function sitemapProducts(products) {
    ...
    const live = products.filter(product => product.source !== "manual").sort((a, b) => productSitemapScore(b) - productSitemapScore(a));
    const seen = new Set;
    const diverseLive = [];
...
function productTitle(product) {
    const specs = Object.fromEntries(specEntries(product));
    const parts = [ specs["Carat Weight"] ? specs["Carat Weight"].replace(/ CTW$/i, " Carat") : "", specs.Shape, /lab|cvd/i.test(specs["Diamond Type"] || "") ? "Lab Diamond" : "", specs.Color, specs.Clarity, specs["Stock Number"] ].filter(Boolean);
    const base = parts.length ? `${product.name} ${parts.join(" ")}` : product.name;
    const category = product?.category && !String(base).toLowerCase().includes(String(product.category).toLowerCase()) ? ` ${product.category}` : "";
...
function injectHead(template, {title: title, description: description, url: url, image: image, imageAlt: imageAlt = title, jsonLd: jsonLd, noindex: noindex = false, ogType: ogType = "website"}) {
    let html = template.replace(/<title>[\s\S]*?<\/title>/i, `<title>${escapeHtml(title)}</title>`).replace(/<meta name="description" content="[^"]*"\s*\/?>/i, `<meta name="description" content="${escapeHtml(description)}" />`).replace(/<meta name="robots" content="[^"]*"\s*\/?>/i, `<meta name="robots" content="${noindex ? "noindex,follow" : "index,follow,max-image-preview:large"}" />`).replace(/<link rel="canonical" href="[^"]*"\s*\/?>/i, `<link rel="canonical" href="${escapeHtml(url)}" />`);
    html = html.replace(/\s*<meta property="og:[^"]+" content="[^"]*"\s*\/?>/gi, "").replace(/\s*<meta name="twitter:[^"]+" content="[^"]*"\s*\/?>/gi, "");
    const meta = ` <meta property="og:title" content="${escapeHtml(title)}" /> <meta property="og:description" content="${escapeHtml(description)}" /> <meta property="og:url" content="${escapeHtml(url)}" /> <meta property="og:type" content="${escapeHtml(ogType)}" /> <meta property="og:site_name" content="${escapeHtml(BUSINESS_NAME)}" /> <meta property="og:image" content="${escapeHtml(image)}" /> <meta property="og:image:alt" content="${escapeHtml(imageAlt)}" /> <meta name="twitter:card" content="summary_large_image" /> <meta name="twitter:title" content="${escapeHtml(title)}" /> <meta name="twitter:description" content="${escapeHtml(description)}" /> <meta name="twitter:image" content="${escapeHtml(image)}" /> <meta name="twitter:image:alt" content="${escapeHtml(imageAlt)}" /> ${process.env.GOOGLE_SITE_VERIFICATION ? `<meta name="google-site-verification" content="${escapeHtml(process.env.GOOGLE_SITE_VERIFICATION)}" />` : ""} ${jsonLd.map(item => `<script type="application/ld+json" data-server-jsonld="true">${JSON.stringify(item).replace(/</g, "\\u003c")}<\/script>`).join("\n")} `;
    return html.replace("</head>", `${meta}\n</head>`);
}

function renderShell(main, routePath) {
    return ` <header class="site-header"> <a class="brand brand-menu-button" href="/" aria-label="The Don Jewelers home"> <span class="brand-mark" aria-hidden="true">TD</span> <span class="brand-copy"><strong>The Don Jewelers & Jewelry</strong><small>Luxury custom jewelry</small></span> <span class="header-menu-cue"><strong>More options</strong><small>Click here</small></span> </a> <nav class="nav-links" aria-label="Primary navigation"> <a href="/products">Fine Jewelry</a> <a href="/category/engagement-rings">Engagement Rings</a> <a href="/select-diamond">Live Diamonds</a> <a class="nav-highlight" href="/start-custom-ring-design">Custom Design</a> </nav> <form class="global-search global-search-header" role="search" action="/search" method="get" aria-label="Search jewelry, diamonds, and pages"> <input name="q" type="search" placeholder="Search all jewelry & diamonds" aria-label="Search every product, diamond, category, and page"> <button type="submit">Search</button> </form> </header> <aside class="financing-announcement" aria-label="Jewelry financing options"> <span class="financing-pulse" aria-hidden="true"></span> <strong><span class="finance-desktop-copy">$500 first custom-order credit</span><span class="finance-mobile-copy">$500 custom-order credit</span></strong> <span class="finance-desktop-copy">New clients: $500 off an eligible custom order of $2,500+. Or use THEDON15 at checkout. Promotions cannot stack.</span> <span class="finance-mobile-copy">Eligible $2,500+ orders · Financing available · Terms apply</span> <span class="bnpl-logos" aria-label="Eligible financing providers"><span class="bnpl-logo affirm-logo">affirm</span><span class="bnpl-logo klarna-logo">Klarna.</span><span class="bnpl-logo afterpay-logo">Afterpay</span></span> <a href="/jewelry-financing">Explore financing</a> </aside> ${routePath === "/" ? "" : `<details class="mobile-store-menu"> <summary>Shop and design options</summary> <nav aria-label="Mobile storefront navigation"> <a href="/category/engagement-rings">Engagement Rings</a><a href="/products">Fine Jewelry</a><a href="/select-diamond">Live Diamonds</a><a href="/start-custom-ring-design">Start Custom Design</a><a href="/request/appointment">Book an Appointment</a><a href="/jewelry-financing">Financing</a> </nav> <form role="search" action="/search" method="get"><label for="mobile-site-search">Search jewelry and diamonds</label><div><input id="mobile-site-search" name="q" type="search" placeholder="What are you looking for?"><button type="submit">Search</button></div></form> </details>`} ${main} <a class="sticky-appointment-cta" href="/request/appointment" aria-label="Book a private jewelry appointment"><span>Book Appointment</span><small>Private jeweler consultation</small></a> <footer class="site-footer"> <div><p><strong>${BUSINESS_NAME}</strong></p><p>Luxury private jeweler for custom jewelry, certified diamonds, and fine jewelry consultations nationwide.</p></div> <div class="footer-contact"><strong>Speak with a private jeweler</strong><a href="tel:+14847612008">Call or text ${PHONE_DISPLAY}</a><a href="mailto:${CONTACT_EMAIL}">${CONTACT_EMAIL}</a><span>Appointment-only service and insured nationwide shipping.</span></div> <nav class="footer-navigation" aria-label="Footer navigation"><div class="footer-link-group"><strong>Shop</strong><a href="/products">Fine Jewelry</a><a href="/category/engagement-rings">Engagement Rings</a><a href="/select-diamond">Live Diamonds</a></div><div class="footer-link-group"><strong>Services</strong><a href="/start-custom-ring-design">Custom Design</a><a href="/request/appointment">Appointments</a><a href="/jewelry-financing">Financing</a></div><div class="footer-link-group"><strong>Buyer protection</strong><a href="/shipping-policy">Shipping</a><a href="/warranty-policy">Warranty</a><a href="/refund-return-policy">Returns</a></div><div class="footer-link-group"><strong>Learn</strong><a href="/diamond-education">Diamond Education</a><a href="/custom-jewelry-project-gallery">Project Gallery</a><a href="/blog">Journal</a></div></nav> </footer> <script>window.__SSR_ROUTE__=${JSON.stringify(routePath)};<\/script> `;
}
...
async function productPage(req, res, slug) {
    ...
    const image = productImage(product);
    const jsonLd = [ productJsonLd(product, url), breadcrumbJsonLd([ [ "Home", "/" ], [ product.category || "Products", categoryPath(product.category) ], [ product.name, canonicalPath ] ]) ];
...
function diamondJsonLd(diamond, url) {
    ...
    return {
        ...
        review: storeReview(),
        additionalProperty: [ [ "Carat", diamond.carat ], [ "Shape", diamond.shape ], [ "Color", diamond.color ], [ "Clarity", diamond.clarity ], [ "Cut", diamond.cut ], [ "Polish", diamond.polish ], [ "Symmetry", diamond.symmetry ], [ "Fluorescence", diamond.fluorescence ], [ "Lab", diamond.lab || diamond.certificate ], [ "Certificate Number", diamond.reportNumber || diamond.certificate ], [ "Growth Method", diamond.growthMethod || "CVD" ] ].filter(([, value]) => value).map(([name, value]) => ({
            "@type": "PropertyValue",
            name: name,
            value: String(value)
        })),
...
function diamondMain(diamond) {
    const price = Number(String(diamond.price || "").replace(/[^0-9.]/g, ""));
    const rows = [ [ "Stock Number", diamond.stockNumber ], [ "Certificate", diamond.reportNumber || diamond.certificate ], [ "Carat", diamond.carat ], [ "Shape", diamond.shape ], [ "Color", diamond.color ], [ "Clarity", diamond.clarity ], [ "Cut", diamond.cut ], [ "Polish", diamond.polish ], [ "Symmetry", diamond.symmetry ], [ "Lab", diamond.lab || diamond.certificate ], [ "Growth Method", diamond.growthMethod || "CVD" ] ].filter(([, value]) => value);
    return ` <main> <section class="product-detail-hero catalog-jewelry-detail supplier-product-hero"> <div class="product-media-stack"> ${diamond.imageUrl || diamond.mediaUrl ? `<img src="${escapeHtml(absoluteUrl(diamond.imageUrl || diamond.mediaUrl))}" alt="${escapeHtml(diamondAlt(diamond))}" loading="eager">` : `<div class="product-image-placeholder">Lab Diamond</div>`} </div> <div> <p class="eyebrow">Certified Lab-Grown Diamond</p> <h1>${escapeHtml(diamondTitle(diamond).replace(" | The Don Jewelers", ""))}</h1> <p class="product-detail-price">${price ? escapeHtml(money(price)) : "Request Pricing"}</p> <dl class="summary-list product-spec-list">${rows.map(([label, value]) => `<div><dt>${escapeHtml(label)}</dt><dd>${escapeHtml(value)}</dd></div>`).join("")}</dl> <div class="builder-actions"> <a class="button button-gold" href="/request/product?product=${encodeURIComponent(diamondTitle(diamond))}&category=Live%20Diamond%20Selection">Request / Buy This Diamond</a> ${diamond.reportUrl ? `<a class="button button-light" href="${escapeHtml(diamond.reportUrl)}" target="_blank" rel="noopener noreferrer">View Certificate</a>` : ""} </div> </div> </section> </main> `;
}

async function cachedLooseDiamonds() {
    if (!databaseConfigured()) return [];
    const keys = [ "certified:1", "certified-color:1" ];
    const payloads = await Promise.all(keys.map(key => getInventoryCache(key, {
        allowStale: true
    }).catch(() => null)));
...
async function findDiamond(identifier) {
    ...
    return diamonds.find(diamond => [ diamond.reportNumber, diamond.certificate, diamond.stockNumber, diamond.id ].filter(Boolean).some(value => String(value).toLowerCase() === clean || slugify(value) === clean)) || null;
}
...
async function diamondPage(req, res, certNumber) {
    ...
    const jsonLd = [ diamondJsonLd(diamond, url), breadcrumbJsonLd([ [ "Home", "/" ], [ "Lab-Grown Diamonds", "/select-diamond" ], [ title.replace(" | The Don Jewelers", ""), pathName ] ]) ];
    const template = fs.readFileSync(INDEX_HTML, "utf8");
    const page = injectHead(template, {
        title: title,
        description: description,
...
function moneyPageCtas(pathname = "") {
    ...
    if (/financing/i.test(pathText)) {
        return [ {
            href: "/products",
            label: "Shop Eligible Jewelry"
        }, {
            href: "/request/appointment",
            label: "Ask About Financing"
        }, {
            href: "tel:+14847612008",
            label: "Call (484) 761-2008"
        } ];
    }
    if (/pendant|tennis|bracelet|chain|jewelry|private|appointment|custom|don-jewelers/i.test(pathText)) {
        return [ {
            ...
            href: "/products",
            label: "Browse Jewelry"
        } ];
    }
    if (/ring|engagement|diamond/i.test(pathText)) {
        return [ {
            href: "/start-custom-ring-design",
            label: "Start Custom Ring Design"
        }, {
            href: "/request/appointment",
            label: "Book Appointment"
        }, {
            href: "/select-diamond",
            label: "View Live Diamonds"
        } ];
    }
    return [ {
        href: "/request/appointment",
...
function homeMain() {
    return ` <main> <section class="hero"> <a class="hero-media" href="/products/queen-aurelia-oval-marquise-ring" aria-label="View the Queen Aurelia engagement ring"> <picture><source type="image/webp" srcset="/queen-aurelia-hero-480.webp 480w, /queen-aurelia-hero-768.webp 768w, /queen-aurelia-hero-1200.webp 1200w" sizes="100vw"><img src="/queen-aurelia-oval-marquise-ring.jpeg" loading="eager" fetchpriority="high" decoding="sync" width="899" height="1600" alt="Queen Aurelia oval and marquise custom engagement ring by The Don Jewelers"></picture> </a> <div class="hero-content"> <p class="eyebrow">Private jeweler · NYC Diamond District access</p> <h1>Luxury custom jewelry. Made personal.</h1> <p>Designed for you and built to last, with custom engagement rings, GIA and IGI certified diamond options, and one-to-one guidance from design through insured delivery.</p> <div class="hero-actions"> <a class="button button-gold" href="/start-custom-ring-design">Start Your Custom Design</a> <a class="button button-ghost" href="/select-diamond">View Live Diamonds</a> </div> <div class="hero-trust-strip" aria-label="Why clients choose The Don Jewelers"> <span><strong>GIA & IGI</strong> certified options</span> <span><strong>Insured</strong> nationwide shipping</span> <span><strong>Financing</strong> for eligible buyers</span> <span><strong>Lifetime</strong> craftsmanship support</span> </div> <a class="hero-review-preview" href="#google-reviews-title" aria-label="Read verified Google reviews"> <span class="review-stars" aria-hidden="true">★★★★★</span> <span><strong>“Carlos is a 10/10 guy.”</strong><small>Matthew Haddad · Verified on Google</small></span> <em>Read reviews →</em> </a> <div class="hero-assurance-links"><a href="/shipping-policy">Insured shipping</a><a href="/warranty-policy">Craftsmanship support</a><a href="/refund-return-policy">Return policy</a><span>Secure Stripe checkout</span></div> </div> </section> <section class="section engagement-feature home-engagement-preview" aria-labelledby="featured-engagement-rings-title"> <div> <p class="eyebrow">Engagement Rings</p> <h2 id="featured-engagement-rings-title">Start with the ring</h2> <p>Explore signature designs, then choose your diamond, metal, ring size, and custom details.</p> <div class="hero-actions"><a class="button button-gold" href="/category/engagement-rings">View Engagement Rings</a><a class="button button-light" href="/start-custom-ring-design">Design Your Ring</a></div> </div> <div class="ring-showcase ring-preview-showcase" aria-label="Featured engagement ring designs"> <a class="engagement-preview-card" href="/products/queen-aurelia-oval-marquise-ring"><img src="/queen-aurelia-oval-marquise-ring.jpeg" alt="Queen Aurelia oval and marquise engagement ring" width="899" height="1600" loading="lazy" decoding="async"><span><strong>Queen Aurelia</strong><small>Oval & marquise signature</small><em>View &amp; Buy</em></span></a> <a class="engagement-preview-card" href="/products/monarch-pink-diamond-ring-pink-oval-engagement-ring"><img src="/pink-oval-engagement-ring.jpeg" alt="Monarch Pink oval diamond engagement ring" width="900" height="900" loading="lazy" decoding="async"><span><strong>Monarch Pink</strong><small>Pink oval design</small><em>View &amp; Buy</em></span></a> <a class="engagement-preview-card" href="/products/monarch-canary-oval-ring-yellow-oval-diamond-ring"><img src="/yellow-oval-diamond-ring.jpeg" alt="Monarch Canary yellow oval diamond engagement ring" width="900" height="900" loading="lazy" decoding="async"><span><strong>Monarch Canary</strong><small>Yellow oval design</small><em>View &amp; Buy</em></span></a> <a class="engagement-preview-card desktop-only-featured-ring" href="/products/marquise-crown-diamond-engagement-ring"><img src="/mens-band-black-01-catalog.webp" alt="Marquise Crown diamond engagement ring" width="720" height="720" loading="lazy" decoding="async"><span><strong>Marquise Crown</strong><small>Sculptural marquise design</small><em>View &amp; Buy</em></span></a> <a class="engagement-preview-card desktop-only-featured-ring" href="/products/k24b-marquise-diamond-engagement-ring"><img src="/assets/customer-products/02-BDD4A1EE-BA1A-4B48-9782-CBF67D6172D2-catalog.webp" alt="La Marquesa K24B marquise engagement ring" width="720" height="720" loading="lazy" decoding="async"><span><strong>La Marquesa K24B</strong><small>Marquise with graduated accents</small><em>View &amp; Buy</em></span></a> <a class="engagement-preview-card desktop-only-featured-ring" href="/products/radiant-pave-diamond-engagement-ring"><img src="/assets/customer-products/03-548DB3E3-12A3-46B9-B2B6-F55850911923-catalog.webp" alt="Reina Luz radiant pavé diamond engagement ring" width="720" height="720" loading="lazy" decoding="async"><span><strong>Reina Luz</strong><small>Radiant center &amp; pavé band</small><em>View &amp; Buy</em></span></a> </div> </section> <section class="section custom-collection-home" aria-labelledby="custom-collection-home-title"><div class="section-heading"><p class="eyebrow">Custom Jewelry &amp; Collections</p><h2 id="custom-collection-home-title">Start Your Custom Today</h2><p>Explore six signature concepts, then request the metal, stones, dimensions, engraving, and finish you want.</p></div><div class="product-grid"><article class="product-card"><a class="product-image-link" href="/products/archangel-slaying-lucifer-concept"><img src="/archangel-slaying-lucifer-concept.png?v=approved-custom-renders-20260829" alt="Archangel Slaying Lucifer Pendant" loading="lazy" decoding="async" width="720" height="720"></a><div class="product-card-body"><p class="eyebrow">Custom Jewelry &amp; Collections</p><h3>Archangel Slaying Lucifer Pendant</h3><p class="muted">Price available upon request</p><div class="card-actions"><a class="button button-dark" href="/products/archangel-slaying-lucifer-concept">View Details</a><a class="button button-gold" href="/request/product?product=Archangel%20Slaying%20Lucifer%20Pendant&amp;category=Custom%20Jewelry%20%26%20Collections&amp;intent=product-inquiry">Request Price</a></div></div></article><article class="product-card"><a class="product-image-link" href="/products/jesus-ring-by-the-don-jewelers"><img src="/jesus-ring-by-the-don-jewelers.png?v=approved-custom-renders-20260829" alt="Jesus Ring by The Don Jewelers" loading="lazy" decoding="async" width="720" height="720"></a><div class="product-card-body"><p class="eyebrow">Custom Jewelry &amp; Collections</p><h3>Jesus Ring by The Don Jewelers</h3><p class="muted">Price available upon request</p><div class="card-actions"><a class="button button-dark" href="/products/jesus-ring-by-the-don-jewelers">View Details</a><a class="button button-gold" href="/request/product?product=Jesus%20Ring%20by%20The%20Don%20Jewelers&amp;category=Custom%20Jewelry%20%26%20Collections&amp;intent=product-inquiry">Request Price</a></div></div></article><article class="product-card"><a class="product-image-link" href="/products/fear-no-evil-baby-angel-ring"><img src="/fear-no-evil-baby-angel-ring.png?v=approved-custom-renders-20260829" alt="Fear No Evil Baby Angel Ring by The Don Jewelers" loading="lazy" decoding="async" width="720" height="720"></a><div class="product-card-body"><p class="eyebrow">Custom Jewelry &amp; Collections</p><h3>Fear No Evil Baby Angel Ring by The Don Jewelers</h3><p class="muted">Price available upon request</p><div class="card-actions"><a class="button button-dark" href="/products/fear-no-evil-baby-angel-ring">View Details</a><a class="button button-gold" href="/request/product?product=Fear%20No%20Evil%20Baby%20Angel%20Ring%20by%20The%20Don%20Jewelers&amp;category=Custom%20Jewelry%20%26%20Collections&amp;intent=product-inquiry">Request Price</a></div></div></article><article class="product-card"><a class="product-image-link" href="/products/fear-no-evil-baby-angel-pendant"><img src="/fear-no-evil-baby-angel-pendant.png?v=approved-custom-renders-20260829" alt="Fear No Evil Baby Angel Pendant by The Don Jewelers" loading="lazy" decoding="async" width="720" height="720"></a><div class="product-card-body"><p class="eyebrow">Custom Jewelry &amp; Collections</p><h3>Fear No Evil Baby Angel Pendant by The Don Jewelers</h3><p class="muted">Price available upon request</p><div class="card-actions"><a class="button button-dark" href="/products/fear-no-evil-baby-angel-pendant">View Details</a><a class="button button-gold" href="/request/product?product=Fear%20No%20Evil%20Baby%20Angel%20Pendant%20by%20The%20Don%20Jewelers&amp;category=Custom%20Jewelry%20%26%20Collections&amp;intent=product-inquiry">Request Price</a></div></div></article><article class="product-card"><a class="product-image-link" href="/products/rose-gold-ruby-twin-dragon-ring"><img src="/rose-gold-ruby-twin-dragon-ring.png?v=approved-custom-renders-20260829" alt="Rose Gold &amp; Ruby Twin Dragon Ring" loading="lazy" decoding="async" width="720" height="720"></a><div class="product-card-body"><p class="eyebrow">Custom Jewelry &amp; Collections</p><h3>Rose Gold &amp; Ruby Twin Dragon Ring</h3><p class="muted">Price available upon request</p><div class="card-actions"><a class="button button-dark" href="/products/rose-gold-ruby-twin-dragon-ring">View Details</a><a class="button button-gold" href="/request/product?product=Rose%20Gold%20%26amp%3B%20Ruby%20Twin%20Dragon%20Ring&amp;category=Custom%20Jewelry%20%26%20Collections&amp;intent=product-inquiry">Request Price</a></div></div></article><article class="product-card"><a class="product-image-link" href="/products/custom-dejaun-diamond-name-pendant"><img src="/custom-dejaun-diamond-name-pendant.jpeg?v=approved-custom-renders-20260829" alt="Déjà Vu Diamond Name Pendant" loading="lazy" decoding="async" width="720" height="720"></a><div class="product-card-body"><p class="eyebrow">Custom Jewelry &amp; Collections</p><h3>Déjà Vu Diamond Name Pendant</h3><p class="muted">Price available upon request</p><div class="card-actions"><a class="button button-dark" href="/products/custom-dejaun-diamond-name-pendant">View Details</a><a class="button button-gold" href="/request/product?product=D%C3%A9j%C3%A0%20Vu%20Diamond%20Name%20Pendant&amp;category=Custom%20Jewelry%20%26%20Collections&amp;intent=product-inquiry">Request Price</a></div></div></article></div><div class="hero-actions collection-more-action"><a class="button button-gold" href="/category/custom-jewelry">View All Custom Jewelry</a><a class="button button-light" href="/start-custom-ring-design">Start a Custom Design</a></div></section> <section class="home-category-section" aria-labelledby="home-category-title"> <div class="home-category-heading"><p class="eyebrow">Shop the Collection</p><h2 id="home-category-title">Find Your Piece</h2></div> <nav class="home-category-carousel" aria-label="Featured jewelry categories"> <a href="/category/engagement-rings" style="--category-image:url('/pink-oval-engagement-ring.jpeg')"><strong>Engagement Rings</strong><small>Premade and custom</small></a> <a href="/products" style="--category-image:url('/yellow-gold-diamond-cuban-link-bracelet.jpeg')"><strong>Fine Jewelry</strong><small>Shop all products</small></a> <a href="/select-diamond" style="--category-image:url('/live-diamond-selection.jpeg')"><strong>Live Diamonds</strong><small>Certified stones</small></a> <a href="/cvd-lab-grown-diamond-jewelry" style="--category-image:url('/triple-row-diamond-tennis-bracelet.jpeg')"><strong>CVD Lab Jewelry</strong><small>Modern diamond pieces</small></a> <a href="/category/mens-earrings" style="--category-image:url('/round-diamond-studs.jpeg')"><strong>Men's Earrings</strong><small>Studs and custom</small></a> <a href="/category/womens-earrings" style="--category-image:url('/blue-monarch-diamond-studs.jpeg')"><strong>Women's Earrings</strong><small>Classic and custom</small></a> </nav> </section> <section class="section google-reviews-section" aria-labelledby="google-reviews-title"> <div class="section-heading review-summary-heading"><div><p class="eyebrow">Verified Google review</p><h2 id="google-reviews-title">A custom ring and a client story</h2><p>Photos from Catlin Rogers's featured five-star review are presented first, followed by direct links to both business profiles.</p></div><div class="google-profile-actions"><a class="button button-light" href="https://share.google/8uvOiIx224kLzQU3Y" target="_blank" rel="noopener noreferrer">View Google profile</a><a class="button button-light" href="https://share.google/z4jwjnAfyaquvfGCz" target="_blank" rel="noopener noreferrer">View second profile</a></div></div> <article class="google-review-feature"><div class="review-feature-media"><p class="review-featured-label">Featured client story</p><div class="review-photo-gallery"><a href="/catlin-rogers-review-ring.png" target="_blank" rel="noopener"><img src="/catlin-rogers-review-ring.png" alt="Catlin Rogers wearing her custom red gemstone engagement ring" width="320" height="320" loading="lazy" decoding="async"></a><a href="/catlin-rogers-review-proposal.png" target="_blank" rel="noopener"><img src="/catlin-rogers-review-proposal.png" alt="Catlin Rogers celebrating her engagement" width="320" height="320" loading="lazy" decoding="async"></a></div></div><div class="review-feature-copy"><p class="review-stars" aria-label="5 out of 5 stars">★★★★★</p><blockquote>“The entire process was smooth, professional, and personalized. They listened to exactly what we wanted and brought our vision to life beautifully. The craftsmanship is absolutely stunning.”</blockquote><p><strong>Catlin Rogers</strong><span>Verified on Google · Lehigh Valley, Pennsylvania</span></p></div></article> </section> <section class="trust-block-section" aria-label="Private jeweler services"> <article><strong>Custom engagement rings</strong><p>Plan the diamond, setting, metal, ring size, CAD design, budget, and timeline directly with a private jeweler.</p><a href="/custom-engagement-rings">Explore custom engagement rings</a></article> <article><strong>Certified diamond sourcing</strong><p>Compare GIA and IGI certified lab-grown or natural diamonds by shape, measurements, cut, color, clarity, and price.</p><a href="/select-diamond">Select a live diamond</a></article> <article><strong>Private service nationwide</strong><p>Work by appointment or remote consultation with secure Stripe checkout, eligible financing, and insured nationwide shipping.</p><a href="/request/appointment">Book a private appointment</a></article> </section> <section class="seo-guide-section" aria-labelledby="home-buying-path"> <div class="section-heading"><p class="eyebrow">A clearer way to buy</p><h2 id="home-buying-path">Why choose The Don Jewelers?</h2></div> <div class="trust-block-section"> <article><strong>Personal guidance</strong><p>Work one-to-one from the first idea through diamond approval, CAD review, production, checkout, and delivery.</p></article> <article><strong>Clear specifications</strong><p>Review the diamond report, metal, dimensions, setting details, pricing, and order terms before approving custom work.</p></article> <article><strong>Built around your next step</strong><p>Browse fine jewelry, choose a live diamond, start a custom ring, or book a consultation without navigating an overloaded menu.</p></article> </div> </section> <section class="seo-guide-section authority-proof" aria-labelledby="home-authority-proof"> <div class="section-heading"><p class="eyebrow">Experience you can verify</p><h2 id="home-authority-proof">Real projects, clear guidance, documented buyer protection</h2><p>Review completed work, diamond education, and the policies that apply before payment.</p></div> <div class="trust-block-section"> <article><strong>Original project gallery</strong><p>See custom jewelry examples and details behind one-of-one client work.</p><a href="/custom-jewelry-project-gallery">View custom projects</a></article> <article><strong>Diamond education</strong><p>Compare certification, cut, color, clarity, lab-grown and natural diamond options.</p><a href="/diamond-education">Read diamond guides</a></article> <article><strong>Transparent policies</strong><p>Review shipping, warranty, returns, financing and custom-order approval terms.</p><a href="/custom-order-policy">Review buyer protections</a></article> </div> </section> </main>`;
}
...
function articleMain(article) {
    return ` <main> <section class="page-hero"> <div class="page-hero-copy"><p class="eyebrow">Jewelry Education</p><h1>${escapeHtml(article.title)}</h1><p>${escapeHtml(article.description)}</p></div> </section> <article class="seo-guide-section resource-article"> <img class="resource-feature-image" src="/${escapeHtml(article.image)}" alt="${escapeHtml(article.title)} by The Don Jewelers & Jewelry" loading="eager" decoding="async" fetchpriority="high" width="1200" height="800"> ${article.sections.map(([heading, body]) => `<section><h2>${escapeHtml(heading)}</h2><p>${escapeHtml(body)}</p></section>`).join("")} <div class="builder-actions"> <a class="button button-gold" href="/request/appointment">Book a Private Appointment</a> <a class="button button-dark" href="/start-custom-ring-design">Start Custom Ring Design</a> <a class="button button-light" href="/blog">More Jewelry Guides</a> </div> </article> </main>`;
}
...
function localBusinessJsonLd() {
    return {
        ...
        areaServed: LOCATION_TARGETS.map(name => ({
            "@type": "Place",
            name: name
        })),
        address: {
...
function staticPage(req, res, pathname) {
    ...
    const jsonLd = [ pageJsonLd(meta, url), websiteJsonLd(), localBusinessJsonLd(), breadcrumbJsonLd([ [ "Home", "/" ], ...meta.path === "/" ? [] : [ [ meta.label, meta.path ] ] ]), ...faqJsonLd(meta.sections) ? [ faqJsonLd(meta.sections) ] : [] ];
    const template = fs.readFileSync(INDEX_HTML, "utf8");
    const page = injectHead(template, {
        title: meta.title,
        description: meta.description,
...
async function sitemap(req, res) {
    ...
    const basePaths = [ [ "/", "weekly", "1.0" ], [ "/products", "daily", "0.9" ], [ "/select-diamond", "daily", "0.8" ], [ "/custom-orders", "monthly", "0.8" ], [ "/start-custom-ring-design", "monthly", "0.95" ], [ "/ring-size-guide", "monthly", "0.82" ], [ "/diamond-shape-guide", "monthly", "0.84" ], [ "/category/engagement-rings", "weekly", "0.9" ], [ "/category/wedding-bands", "weekly", "0.8" ], [ "/category/chains", "weekly", "0.8" ], [ "/category/bracelets", "weekly", "0.8" ], [ "/category/pendants-charms", "weekly", "0.8" ], [ "/custom-engagement-rings", "monthly", "0.9" ], [ "/lab-diamond-rings", "monthly", "0.85" ], [ "/natural-diamond-rings", "monthly", "0.85" ], [ "/diamond-tennis-chains", "monthly", "0.85" ], [ "/diamond-tennis-bracelets", "monthly", "0.85" ], [ "/diamond-pendants", "monthly", "0.85" ], [ "/diamond-crosses", "monthly", "0.8" ], [ "/custom-jewelry", "monthly", "0.9" ], [ "/jewelry-financing", "monthly", "0.8" ], [ "/diamond-education", "monthly", "0.8" ], [ "/lab-diamonds-vs-natural-diamonds", "monthly", "0.8" ], [ "/jewelry-care", "monthly", "0.75" ], [ "/custom-cad-design", "monthly", "0.85" ], [ "/nyc-diamond-district-jeweler", "monthly", "0.95" ], [ "/private-jeweler", "monthly", "0.9" ], [ "/appointment-only-jeweler", "monthly", "0.85" ], [ "/engagement-rings-allentown-pa", "monthly", "0.9" ], [ "/engagement-rings-lehigh-valley", "monthly", "0.9" ], [ "/custom-jewelry-nyc", "monthly", "0.9" ], [ "/custom-jeweler-new-jersey", "monthly", "0.88" ], [ "/diamond-jeweler-connecticut", "monthly", "0.88" ], [ "/tri-state-custom-jeweler", "monthly", "0.9" ], [ "/diamond-jeweler-pennsylvania", "monthly", "0.88" ], [ "/free-engagement-ring-consultation", "monthly", "0.9" ], [ "/lab-diamond-engagement-rings-allentown", "monthly", "0.88" ], [ "/private-jeweler-allentown", "monthly", "0.86" ], [ "/custom-engagement-rings-nyc", "monthly", "0.9" ], [ "/engagement-rings-nyc", "monthly", "0.92" ], [ "/engagement-rings-tri-state", "monthly", "0.9" ], [ "/lab-diamond-engagement-rings-nyc", "monthly", "0.9" ], [ "/custom-diamond-pendants-nyc", "monthly", "0.86" ], [ "/custom-jewelry-allentown-pa", "monthly", "0.88" ], [ "/custom-jewelry-lehigh-valley", "monthly", "0.88" ], [ "/tennis-bracelets-allentown-pa", "monthly", "0.86" ], [ "/cvd-lab-grown-diamond-jewelry", "daily", "0.88" ], [ "/diamond-rings-near-me", "monthly", "0.88" ], [ "/engagement-rings-new-jersey", "monthly", "0.88" ], [ "/engagement-rings-connecticut", "monthly", "0.88" ], [ "/engagement-ring-consultation-easton-bethlehem", "monthly", "0.92" ], [ "/custom-jewelry-project-gallery", "monthly", "0.88" ], [ "/the-don-jewelers", "monthly", "0.95" ], [ "/the-don-jewelers-and-jewelry", "monthly", "0.95" ], [ "/don-jewelers-nyc", "monthly", "0.9" ], [ "/the-don-jewelers-engagement-rings", "monthly", "0.92" ], [ "/diamond-pendants-allentown-pa", "monthly", "0.84" ], [ "/custom-engagement-ring-process", "monthly", "0.9" ], [ "/engagement-ring-cost-guide", "monthly", "0.88" ], [ "/lab-diamond-buying-guide", "monthly", "0.88" ], [ "/private-jeweler-vs-retail-store", "monthly", "0.86" ], [ "/service-areas", "monthly", "0.86" ], [ "/custom-jeweler-syracuse-ny", "monthly", "0.84" ], [ "/custom-jeweler-floral-park-ny", "monthly", "0.84" ], [ "/custom-jeweler-long-island-ny", "monthly", "0.86" ], [ "/custom-jeweler-new-york-state", "monthly", "0.86" ], [ "/custom-jeweler-philadelphia-pa", "monthly", "0.84" ], [ "/custom-jeweler-pennsylvania", "monthly", "0.88" ], [ "/custom-jewelry-pennsylvania", "monthly", "0.9" ], [ "/jewelry-store-easton-pa", "monthly", "0.9" ], [ "/engagement-rings-easton-pa", "monthly", "0.92" ], [ "/diamond-jewelry-pennsylvania", "monthly", "0.9" ], [ "/diamond-district-custom-jewelry-nyc", "monthly", "0.94" ], [ "/custom-jeweler-northern-new-jersey", "monthly", "0.84" ], [ "/custom-jeweler-ohio", "monthly", "0.82" ], [ "/blog", "weekly", "0.7" ] ];
    const urls = [ ...basePaths.map(([pagePath, changefreq, priority]) => xmlUrl(`${SITE_URL}${pagePath}`, null, changefreq, priority)), ...sitemapProducts(products).map(product => xmlUrl(`${SITE_URL}${productPath(product)}`, product.updatedAt || product.sourceUpdatedAt, product.source === "manual" ? "weekly" : "daily", product.source === "manual" ? "0.8" : "0.68")), ...seoArticles.map(article => xmlUrl(`${SITE_URL}/blog/${article.slug}`, article.updated, "monthly", "0.78")) ];
...
function robots(req, res) {
    const body = `User-agent: * Allow: / Disallow: /admin Disallow: /api/ Disallow: /checkout Disallow: /checkout-success Disallow: /checkout-cancel Disallow: /account Disallow: /cart?* Sitemap: ${SITE_URL}/sitemap.xml `;
    res.statusCode = 200;
