...
- `vercel.json` is present for SPA routing.
...
- Add real production environment variables in Vercel for any private APIs, including `DIAMOND_API_KEY` if the live diamond API is used.
