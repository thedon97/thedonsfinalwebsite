...
const featuredSeoImages = [ primarySeoImage, "queen-aurelia-oval-marquise-ring.jpeg", "engagement-ring-feature.jpg", "triple-row-diamond-tennis-bracelet.jpeg", "diamond-banner.jpg" ];
...
const officialSocialLinks = [ "https://www.instagram.com/los_thejeweler/", "https://www.facebook.com/profile.php?id=100089172553878", googleBusinessProfileUrl ];

const verifiedGoogleReviews = [ {
    name: "Catlin Rogers",
    rating: 5,
    profile: "Google Profile · 4 reviews · 4 photos",
    featured: true,
    photos: [ {
        src: "/catlin-rogers-review-ring.png",
        alt: "Catlin Rogers wearing her custom red gemstone engagement ring"
    }, {
        src: "/catlin-rogers-review-proposal.png",
        alt: "Catlin Rogers celebrating her engagement"
    } ],
    text: "I couldn’t be happier with my custom engagement ring from Don Jewelers & Jewelry! From the very beginning, the entire process was smooth, professional, and personalized. They took the time to listen to exactly what we wanted and brought our vision to life beautifully. The craftsmanship is absolutely stunning. Every detail is perfect, and the ring sparkles even more in person. I’ve received so many compliments, and I can’t stop looking at it! It’s clear they truly care about the quality of their work and making each piece special. If you’re looking for a trustworthy jeweler who creates beautiful custom jewelry and provides outstanding customer service, I highly recommend Don Jewelers & Jewelry. They made such an important moment in our lives even more memorable. Thank you for creating a ring I’ll cherish forever! Located in Lehigh Valley, PA!"
}, {
    name: "Chris Torres",
    rating: 5,
    profile: "Google Profile · 5 reviews",
    text: "This is the best jeweler in town. This place is trustworthy, kind, and truly experienced. The Don made it happen—my wife’s engagement ring came out extremely beautiful. This is all 100% real jewelry; you won’t have to go anywhere else! Kay Jewelers has nothing on The Don!"
}, {
    name: "Alex Cruz",
    rating: 5,
    profile: "Google Profile · 5 reviews",
    text: "Los helped me out with a custom diamond pinky ring that looks great and helps represent the brand well! Thanks again!!"
}, {
    name: "Los",
    rating: 5,
    profile: "Google Profile · 5 reviews",
    text: "Had the wonderful opportunity to work with Carlos on a giveaway. I won a beautiful gemstone and Carlos turned it into a ring."
}, {
    name: "Matthew Haddad",
    rating: 5,
    profile: "Google Profile · 5 reviews",
    text: "Carlos is a 10/10 guy. Easy to deal with and completes all the orders I have in any reasonable timeframe!"
}, {
    name: "Johnny Billz",
    rating: 5,
    profile: "Google Profile · 5 reviews",
    text: "Carlos is not only efficient but knowledgeable about everything that he has crafted. Ensures that his clients get exactly what they are looking for! Highly recommend."
}, {
    name: "Sasha",
    rating: 5,
    profile: "Google Profile · 4 reviews",
    text: "This is the jeweler to go to for a custom engagement ring and lab grown diamond. From the design to the pricing, the experience was phenomenal."
}, {
    name: "Ahmed Mohammed",
    rating: 5,
    profile: "Google Profile · 4 reviews",
    text: "Ordered a custom engagement ring. The owner, Carlos, was super knowledgeable, accommodating, and very fair on price, especially for the quality he provides. Truly a gem to work with."
}, {
    name: "Karen Meneses",
    rating: 5,
    profile: "Google Profile · 4 reviews",
    text: "Ordered something from here. He delivered in a timely manner and made sure I was happy with my piece."
} ];
...
const baseCarats = [ [ "1 carat", 1900 ], [ "1.5 carat", 2160 ], [ "2 carat", 2420 ], [ "2.5 carat", 2680 ], [ "3 carat", 2940 ], [ "3.5 carat", 3200 ], [ "4 carat", 3460 ], [ "4.5 carat", 3720 ], [ "5 carat", 3980 ], [ "5.5 carat", 4240 ], [ "6 carat", 4500 ] ];

const lunaCarats = [ [ "1 carat", 2200 ], [ "1.5 carat", 2460 ], [ "2 carat", 2720 ], [ "2.5 carat", 2980 ], [ "3 carat", 3240 ], [ "3.5 carat", 3500 ], [ "4 carat", 3760 ], [ "4.5 carat", 4020 ], [ "5 carat", 4280 ], [ "5.5 carat", 4540 ], [ "6 carat", 4800 ] ];

const ovalCarats = [ [ "1 carat", 1600 ], [ "1.5 carat", 1860 ], [ "2 carat", 2120 ], [ "2.5 carat", 2380 ], [ "3 carat", 2640 ], [ "3.5 carat", 2900 ], [ "4 carat", 3160 ], [ "4.5 carat", 3420 ], [ "5 carat", 3680 ], [ "5.5 carat", 3940 ], [ "6 carat", 4200 ] ];

const mensWeddingBandDiamondWeights = [ [ "6mm / approx. 1.50 ctw", 2800 ], [ "8mm / approx. 2.50 ctw", 3950 ], [ "10mm / approx. 4.00 ctw", 5650 ], [ "12mm / approx. 5.50 ctw", 7250 ], [ "14mm / approx. 7.00 ctw", 9250 ] ];
...
const tennisBraceletPointers = [ [ "10 pointers / approx. 5.5 carats", 1499 ], [ "15 pointers", 2399 ], [ "20 pointers", 3299 ], [ "25 pointers", 4199 ], [ "30 pointers", 5099 ], [ "35 pointers", 5999 ], [ "40 pointers", 6899 ] ];

const earringCarats = [ [ "1 carat", 650 ], [ "1.5 carat", 925 ], [ "2 carat", 1300 ], [ "2.5 carat", 1675 ], [ "3 carat", 2050 ], [ "3.5 carat", 2425 ], [ "4 carat", 2800 ], [ "4.5 carat", 3175 ], [ "5 carat", 3550 ], [ "5.5 carat", 3925 ], [ "6 carat", 4300 ] ];

const premiumStudEarringCarats = [ [ "1 carat", 1075 ], [ "1.5 carat", 1325 ], [ "2 carat", 1575 ], [ "2.5 carat", 1825 ], [ "3 carat", 2075 ], [ "3.5 carat", 2325 ], [ "4 carat", 2575 ], [ "4.5 carat", 2825 ], [ "5 carat", 3075 ], [ "5.5 carat", 3325 ], [ "6 carat", 3575 ] ];

const monarchRingCarats = [ [ "1 carat", 1950 ], [ "1.5 carat", 2325 ], [ "2 carat", 2700 ], [ "2.5 carat", 3075 ], [ "3 carat", 3450 ], [ "3.5 carat", 3825 ], [ "4 carat", 4200 ], [ "4.5 carat", 4575 ], [ "5 carat", 4950 ], [ "5.5 carat", 5325 ], [ "6 carat", 5700 ] ];

const queenAureliaCarats = [ [ "1 carat", 2600 ], [ "1.5 carat", 3e3 ], [ "2 carats", 3400 ], [ "2.5 carats", 3800 ], [ "3 carats", 4200 ], [ "3.5 carats", 4600 ], [ "4 carats", 5e3 ], [ "4.5 carats", 5400 ], [ "5 carats", 5800 ], [ "5.5 carats", 6200 ], [ "6 carats", 6600 ] ];
...
const premiumStudProducts = [ [ "asscher-diamond-stud-earrings", "Asscher Diamond Stud Earrings", "asscher-stud-earrings-product-black.png", "Asscher cut diamond screw-back stud earrings", "Asscher" ], [ "cushion-diamond-stud-earrings", "Cushion Diamond Stud Earrings", "cushion-stud-earrings-product-black.png", "Cushion cut diamond screw-back stud earrings", "Cushion" ], [ "emerald-diamond-stud-earrings", "Emerald Diamond Stud Earrings", "emerald-stud-earrings-product-black.png", "Emerald cut diamond screw-back stud earrings", "Emerald" ], [ "oval-diamond-stud-earrings", "Oval Diamond Stud Earrings", "oval-stud-earrings-product-black.png", "Oval cut diamond screw-back stud earrings", "Oval" ], [ "pear-diamond-stud-earrings", "Pear Diamond Stud Earrings", "pear-stud-earrings-product-black.png", "Pear shape diamond screw-back stud earrings", "Pear" ], [ "round-brilliant-diamond-stud-earrings", "Round Brilliant Diamond Stud Earrings", "round-stud-earrings-product-black.png", "Round brilliant diamond screw-back stud earrings", "Round" ] ].map(([id, name, image, alt, shape]) => ({
    id: id,
    ...
    fields: [ [ "Total Diamond Weight", premiumStudEarringCarats ], [ "Diamond Shape", [ shape ] ], [ "Diamond Type", [ "Lab-Grown Diamond", "Natural Diamond" ] ], [ "Diamond Color", [ "D", "E", "F" ] ], [ "Clarity", [ "VVS", "VS" ] ], [ "Metal", metals ], [ "Back Type", [ "Screw back" ] ], [ "Specification Note", [ "Weight varies. Request weight details." ] ] ]
}));
...
const ringQuoteFields = (stoneShape, styleOptions = [ "Custom ring" ]) => [ [ "Metal", ringMetalOptions ], [ "Ring Size", ringSizes ], [ "Stone Shape", Array.isArray(stoneShape) ? stoneShape : [ stoneShape ] ], [ "Diamond Type", [ "Lab-Grown Diamond", "Natural Diamond", "Not sure yet" ] ], [ "Diamond Color", [ "D", "E", "F", "Custom color request" ] ], [ "Clarity", [ "VVS", "VS", "SI by request" ] ], [ "Setting Style", styleOptions ], [ "Specification Note", [ "Final pricing varies by gold, diamond type, carat weight, stone quality, and customization." ] ] ];

const emeraldRadianceMetals = [ [ "14K Yellow Gold", 1400 ], [ "14K White Gold", 1400 ], [ "14K Rose Gold", 1400 ], [ "18K Yellow Gold", 1800 ], [ "18K White Gold", 1800 ], [ "18K Rose Gold", 1800 ] ];
...
const mensBandFields = (diamondLayout, finishOptions) => [ [ "Metal", bandMetalOptions ], [ "Ring Size", ringSizes ], [ "Band Width", [ "6mm", "7mm", "8mm", "10mm", "Custom width" ] ], [ "Diamond Layout", diamondLayout ], [ "Diamond Type", [ "Lab-Grown Diamond", "Natural Diamond", "Not sure yet" ] ], [ "Diamond Color", [ "D", "E", "F", "Custom color request" ] ], [ "Clarity", [ "VVS", "VS", "SI by request" ] ], [ "Finish", finishOptions ], [ "Specification Note", [ "Request final pricing by exact gold weight, diamond weight, ring size, width, and finish." ] ] ];
...
const ankletProducts = [ {
    ...
    buttons: [ "Add to Cart", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    fields: [ [ "Metal", [ [ "14K Yellow Gold", 1e3 ], [ "14K White Gold", 1e3 ], [ "14K Rose Gold", 1e3 ], [ "18K Yellow Gold", 1350 ], [ "18K White Gold", 1350 ], [ "18K Rose Gold", 1350 ] ] ], [ "Anklet Length", ankletLengthOptions ], [ "Diamond Type", [ "Lab-Grown Diamond" ] ], [ "Estimated Diamond Weight", [ "Approx. 0.55 to 0.75 CTW" ] ], [ "Specification Note", [ "Weight varies. Request weight details." ] ] ]
} ];

const customCollectionProducts = [ {
    id: "archangel-slaying-lucifer-concept",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Custom Pendants", "Made to Order", "Signature Collection" ],
    name: "Archangel Slaying Lucifer Pendant",
    ...
    badges: [ "Custom Jewelry", "Made to Order", "Custom Pendants" ],
    buttons: [ "Request Price", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    fields: [ [ "Collection", [ "Custom Jewelry & Collections" ] ], [ "Design Type", [ "Custom Pendants" ] ], [ "Production", [ "Made to Order" ] ], [ "Customization", [ "Confirm metal, stones, size, engraving, and finish during consultation" ] ] ],
    notice: "Concept render supplied by The Don Jewelers. Final dimensions, metal weight, stone count, stone weight, and pricing are confirmed before production."
}, {
    id: "fear-no-evil-baby-angel-pendant",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Custom Pendants", "Made to Order", "Signature Collection" ],
    name: "Fear No Evil Baby Angel Pendant by The Don Jewelers",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
    ...
    id: "fear-no-evil-baby-angel-ring",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Custom Rings", "Made to Order", "Signature Collection" ],
    name: "Fear No Evil Baby Angel Ring by The Don Jewelers",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
    ...
    badges: [ "Custom Jewelry", "Made to Order", "Custom Rings" ],
    buttons: [ "Request Price", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    fields: [ [ "Collection", [ "Custom Jewelry & Collections" ] ], [ "Design Type", [ "Custom Rings" ] ], [ "Production", [ "Made to Order" ] ], [ "Customization", [ "Confirm metal, stones, size, engraving, and finish during consultation" ] ] ],
    notice: "Concept render supplied by The Don Jewelers. Final dimensions, metal weight, stone count, stone weight, and pricing are confirmed before production."
}, {
    id: "jesus-ring-by-the-don-jewelers",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Religious Pieces", "Made to Order", "Signature Collection" ],
    name: "Jesus Ring by The Don Jewelers",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
    ...
    badges: [ "Custom Jewelry", "Made to Order", "Religious Pieces" ],
    buttons: [ "Request Price", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    fields: [ [ "Collection", [ "Custom Jewelry & Collections" ] ], [ "Design Type", [ "Religious Pieces" ] ], [ "Production", [ "Made to Order" ] ], [ "Customization", [ "Confirm metal, stones, size, engraving, and finish during consultation" ] ] ],
    notice: "Concept render supplied by The Don Jewelers. Final dimensions, metal weight, stone count, stone weight, and pricing are confirmed before production."
}, {
    id: "rose-gold-ruby-twin-dragon-ring",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Custom Rings", "Made to Order", "Signature Collection" ],
    name: "Rose Gold & Ruby Twin Dragon Ring",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
    ...
    id: "rose-gold-sapphire-twin-dragon-ring",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Custom Rings", "Made to Order", "Signature Collection" ],
    name: "Rose Gold & Sapphire Twin Dragon Ring",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
    ...
    id: "yellow-gold-ruby-twin-dragon-ring",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Custom Rings", "Made to Order", "Signature Collection" ],
    name: "Yellow Gold & Ruby Twin Dragon Ring",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
    ...
    id: "yellow-gold-ruby-twin-dragon-pendant",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Custom Pendants", "Made to Order", "Signature Collection" ],
    name: "Yellow Gold & Ruby Twin Dragon Pendant",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
    ...
    id: "yellow-gold-sapphire-twin-dragon-pendant",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Custom Pendants", "Made to Order", "Signature Collection" ],
    name: "Yellow Gold & Sapphire Twin Dragon Pendant",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
    ...
    id: "yellow-gold-sapphire-twin-dragon-ring",
    category: "Custom Jewelry & Collections",
    secondaryCategories: [ "Custom Rings", "Made to Order", "Signature Collection" ],
    name: "Yellow Gold & Sapphire Twin Dragon Ring",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
...
const uploadedMensBandProducts = [ {
    ...
    buttons: [ "Add to Cart", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    fields: [ [ "Diamond Size", lunaCarats ], [ "Stone Shape", shapes ], [ "Diamond Color", [ "D", "E", "F", "Custom color request" ] ], [ "Clarity", [ "VVS", "VS" ] ], [ "Metal", metals ], [ "Ring Size", ringSizes ] ]
}, {
...
const uploadedRingProducts = [ {
    ...
    buttons: [ "Add to Cart", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    fields: [ [ "Metal", emeraldRadianceMetals ], [ "Ring Size", ringSizes ], [ "Center Stone", [ "Emerald", "Green gemstone", "Custom gemstone" ] ], [ "Stone Shape", [ "Emerald cut" ] ], [ "Diamond Quality", [ "VVS", "VS" ] ], [ "Diamond Color", [ "D", "E", "F" ] ], [ "Setting Style", [ "Pave band", "Four-prong emerald setting" ] ] ]
}, {
...
const products = [ ...customCollectionProducts, ...ankletProducts, ...uploadedMensBandProducts, ...uploadedRingProducts, {
    ...
    fields: [ [ "Diamond Size", queenAureliaCarats ], [ "Center Stone Shape", [ "Oval", "Marquise" ] ], [ "Side Stone Shape", [ "Marquise side stones" ] ], [ "Band Detail", [ "Carved marquise-side band" ] ], [ "Diamond Color", [ "D", "E", "F" ] ], [ "Clarity", [ "VVS", "VS" ] ], [ "Metal", metals ], [ "Ring Size", ringSizes ] ]
}, {
    id: "luna-solitaire",
    category: "Engagement Rings",
    ...
    fields: [ [ "Metal", [ "14K Yellow Gold", "14K White Gold", "14K Rose Gold", "18K Yellow Gold", "18K White Gold", "18K Rose Gold", "Platinum" ] ], [ "Ruby Size", [ "7-carat ruby" ] ], [ "Diamond Halo", [ "Approx. 1 carat of diamonds in halo and bail" ] ], [ "Diamond Color", [ "D", "E", "F" ] ], [ "Clarity", [ "VVS", "VS" ] ], [ "Necklace Style", [ "Ruby diamond halo pendant necklace" ] ], [ "Chain Included", [ "14K chain included" ] ] ]
}, {
    ...
    buttons: [ "Add to Cart", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    fields: [ [ "Metal", [ [ "14K Yellow Gold", 1e3 ], [ "14K White Gold", 1e3 ], [ "14K Rose Gold", 1e3 ], [ "18K Yellow Gold", 1350 ], [ "18K White Gold", 1350 ], [ "18K Rose Gold", 1350 ] ] ], [ "Bracelet Length", [ "6.5 inches", "7 inches", "7.5 inches", "8 inches", "Custom Size - Message Request" ] ], [ "Diamond Type", [ "Lab-Grown Diamond" ] ], [ "Estimated Diamond Weight", [ "Approx. 0.55 to 0.75 CTW" ] ], [ "Platinum Option", [ "Available by custom quote" ] ], [ "Specification Note", [ "Weight varies. Request weight details." ] ] ]
}, {
    ...
    category: "Custom Jewelry",
    name: "Déjà Vu Diamond Name Pendant",
    price: "Request Pricing",
    estimate: null,
    priceLabel: "Price available upon request",
    image: "custom-dejaun-diamond-name-pendant.jpeg",
    alt: "Custom Déjà Vu diamond name pendant render",
    lede: "Custom Déjà Vu name pendant render with diamond coverage and script lettering. Made to order from the client's name or word.",
    cta: "Request Custom Name Pendant",
    badges: [ "Custom CAD Design", "Custom Jewelry", "Made to Order" ],
    notice: handcraftedNotice,
    buttons: [ "Request Price", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    fields: [ [ "Metal", pendantMetals ], [ "Lettering", [ "Déjà Vu", "Custom name", "Custom word" ] ], [ "Diamond Style", [ "Full diamond layout", "Partial diamond layout", "No stones" ] ], [ "Specification Note", [ "Weight varies. Request weight details." ] ] ]
}, {
...
function allProducts() {
    return [ ...products, ...window.__CUSTOMER_PRODUCTS__ || [], ...storedImportProducts(), ...approvedPreviewProducts ].filter(product => !/marquise.*surround|surround.*marquise/i.test(product.name || ""));
}
...
function productGallery(product) {
    ...
    return ` <div class="product-gallery" aria-label="${productName(product)} gallery"> ${images.map(image => `<img src="${asset(image)}" alt="${productName(product)} additional view" ${imageSafety}>`).join("")} </div> `;
}
...
function productBadges(product) {
    return (product.badges || []).length ? `<div class="product-badges">${product.badges.map(badge => `<span>${badge}</span>`).join("")}</div>` : "";
}
...
function productActionButtons(product) {
    const buttons = product.buttons || (product.price === "Request Pricing" || product.estimate === null ? [ "Request Price", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ] : []);
    ...
    return `<div class="builder-actions product-extra-actions"> ${buttons.filter(label => !/cart/i.test(label)).map((label, index) => {
...
const categories = [ [ "start-custom-ring-design", "Start Your Custom Ring Design", "engagement-ring-feature.jpg" ], [ "engagement-rings", "Engagement Rings", "emerald-accent-engagement-ring.jpeg" ], [ "custom-jewelry", "Custom Jewelry & Collections", "archangel-slaying-lucifer-concept.png" ], [ "select-diamond", "Live Diamond Selection", "live-diamond-selection.jpeg" ], [ "cvd-lab-grown-diamond-jewelry", "CVD Lab-Grown Diamond Jewelry", "https://dna3.dnalinks.in/TJ4594NCW/1.jpg" ], [ "wedding-bands", "Wedding Bands", "mens-asscher-cut-filigree-diamond-wedding-band.jpg" ], [ "diamond-tennis-chains", "Diamond Tennis Chains", "triple-row-diamond-tennis-bracelet.jpeg" ], [ "diamond-tennis-bracelets", "Diamond Tennis Bracelets", "diamond-bracelet.png" ], [ "mens-rings", "Men's Rings", "medusa-diamond-signet-ring.jpeg" ], [ "womens-rings", "Women's Rings", "ring-product-black-02.png" ], [ "mens-earrings", "Men's Earrings", "https://dna3.dnalinks.in/TJ6671ESC/1.jpg" ], [ "womens-earrings", "Women's Earrings", "blue-monarch-diamond-studs.jpeg" ], [ "pendants-charms", "Pendants / Charms", "large-round-diamond-cross-pendant.jpeg" ], [ "chains", "Gold Chains", "yellow-gold-rope-chain-triple.jpeg" ], [ "necklaces", "Necklaces", "red-diamond-necklace.png" ], [ "bracelets", "Bracelets", "diamond-bracelet.png" ], [ "anklets", "Anklets", "bracelet-05.png" ], [ "watches", "Watches", "iced-cartier-santos-watch.jpeg" ], [ "custom-orders", "Custom Orders", "don-logo.jpg" ] ];

const globalFaqs = [ [ "Do you make custom engagement rings?", "Yes. The Don Jewelers & Jewelry designs custom engagement rings with lab grown diamonds, natural diamonds, 14K gold, 18K gold, platinum, CAD design, and private diamond sourcing." ], [ "Do you serve NYC and the Diamond District?", "Yes. The business serves clients looking for an NYC jeweler, Manhattan jeweler, Diamond District jeweler, private jeweler, and appointment-only jewelry consultation." ], [ "Do you work with clients in Pennsylvania?", "Yes. The Don Jewelers & Jewelry serves Lehigh Valley PA, Easton PA, Bethlehem PA, Allentown PA, and clients throughout Pennsylvania." ], [ "Can I finance jewelry?", "Jewelry financing may be available through third-party providers depending on approval, purchase amount, order type, and provider terms." ], [ "Do you source lab grown and natural diamonds?", "Yes. Clients can request lab grown diamonds, natural diamonds, IGI or GIA certified stones, VVS, VS, specific shapes, color ranges, and budget targets." ], [ "Do you offer CAD jewelry design?", "Yes. CAD jewelry design is available for custom rings, pendants, chains, bracelets, name pendants, grillz, and other one-of-one jewelry projects." ] ];

const servicePages = [ ["engagement-rings-nyc","Engagement Rings NYC","Engagement rings in NYC with private jeweler support for lab-grown diamonds, natural diamonds, custom settings, CAD design, ring sizing, appointment booking, and personalized quotes.","engagement-ring-feature.jpg",["engagement rings NYC","custom diamond rings NYC","private jeweler NYC"],["custom-engagement-rings","lab-diamond-rings","natural-diamond-rings"],"NYC clients"], ["engagement-rings-tri-state","Engagement Rings Tri-State Area","Custom engagement rings for Tri-State clients across New York, New Jersey, Connecticut, Pennsylvania, Allentown, and Lehigh Valley with diamond sourcing and private quote support.","engagement-ring-feature.jpg",["engagement rings Tri-State","custom engagement rings NY NJ CT PA","private diamond jeweler"],["custom-engagement-rings","engagement-rings-nyc","jewelry-financing"],"Tri-State clients"], ["custom-jewelry-allentown-pa","Custom Jewelry Allentown PA","Custom jewelry for Allentown PA clients including engagement rings, diamond pendants, tennis bracelets, chains, CAD design, lab diamonds, natural diamonds, and appointment-based quotes.","custom-jewelry-process.jpg",["custom jewelry Allentown PA","custom engagement rings Allentown","diamond pendants Allentown"],["custom-jewelry","custom-cad-design","engagement-rings-allentown-pa"],"Allentown PA clients"], ["custom-jewelry-lehigh-valley","Custom Jewelry Lehigh Valley","Private custom jeweler serving Lehigh Valley clients with engagement rings, diamond jewelry, pendants, tennis bracelets, CAD design, financing guidance, and insured shipping.","custom-jewelry-process.jpg",["custom jewelry Lehigh Valley","private jeweler Lehigh Valley","diamond jewelry Lehigh Valley"],["custom-jewelry","custom-cad-design","engagement-rings-lehigh-valley"],"Lehigh Valley clients"], ["diamond-pendants-allentown-pa","Diamond Pendants Allentown PA","Diamond pendants for Allentown PA and Lehigh Valley clients including custom name pendants, initial pendants, cross pendants, religious charms, and CAD-designed pieces.","diamond-pendant-necklaces.jpg",["diamond pendants Allentown PA","custom pendants Lehigh Valley","diamond charms Allentown"],["diamond-pendants","custom-pendants","custom-cad-design"],"Allentown PA and Lehigh Valley clients"], [ "custom-engagement-rings", "Custom Engagement Rings", "Custom engagement rings in NYC, Manhattan, the Diamond District, and Lehigh Valley PA with lab grown or natural diamonds, CAD design, and private jeweler guidance.", "queen-aurelia-oval-marquise-ring.jpeg", [ "engagement rings NYC", "custom engagement rings", "diamond engagement rings", "bridal jewelry" ], [ "custom-jewelry", "lab-diamond-rings", "natural-diamond-rings" ] ], [ "lab-diamond-rings", "Lab Diamond Rings", "Lab diamond rings with IGI certified stones, VVS and VS options, 14K or 18K gold, platinum settings, and custom CAD ring design.", "queen-aurelia-oval-marquise-ring.jpeg", [ "lab diamond rings", "lab grown diamonds", "diamond engagement rings" ], [ "custom-engagement-rings", "lab-diamonds-vs-natural-diamonds", "diamond-education" ] ], [ "natural-diamond-rings", "Natural Diamond Rings", "Natural diamond rings sourced for clients who want GIA or IGI paperwork, investment-quality details, and private jeweler consultation.", "classic-marquise-engagement-ring.jpeg", [ "natural diamonds", "diamond dealer", "private jeweler" ], [ "custom-engagement-rings", "diamond-education", "lab-diamonds-vs-natural-diamonds" ] ], [ "diamond-tennis-chains", "Diamond Tennis Chains", "Diamond tennis chains in 14K and 18K yellow gold, white gold, and rose gold with lab grown or natural diamond options.", "triple-row-diamond-tennis-bracelet.jpeg", [ "diamond tennis chain", "tennis chains NYC", "diamond chains" ], [ "diamond-tennis-bracelets", "custom-jewelry", "jewelry-financing" ] ], [ "diamond-tennis-bracelets", "Diamond Tennis Bracelets", "Diamond tennis bracelets with custom carat weight, pointer size, gold color, clasp style, and financing support.", "triple-row-diamond-tennis-bracelet.jpeg", [ "diamond tennis bracelet", "diamond jewelry", "luxury jewelry" ], [ "diamond-tennis-chains", "jewelry-care", "jewelry-financing" ] ], [ "diamond-pendants", "Diamond Pendants", "Custom diamond pendants, initials, name pendants, religious pendants, anniversary jewelry, birthday jewelry, and custom diamond pendant design.", "saint-michael-diamond-angel-pendant.jpeg", [ "diamond pendant", "custom diamond pendant", "jewelry gifts" ], [ "diamond-crosses", "custom-cad-design", "custom-jewelry" ] ], [ "diamond-crosses", "Diamond Crosses", "Diamond cross pendants and crucifix pendants in yellow gold, white gold, rose gold, 14K gold, 18K gold, lab diamonds, and natural diamonds.", "large-round-diamond-cross-pendant.jpeg", [ "diamond cross", "cross pendants", "diamond pendant" ], [ "diamond-pendants", "custom-jewelry", "jewelry-financing" ] ], [ "custom-jewelry", "Custom Jewelry", "Custom jewelry by a private jeweler for rings, pendants, chains, bracelets, earrings, watches, grillz, CAD jewelry design, and diamond consultation.", "custom-dejaun-diamond-name-pendant.jpeg", [ "custom jewelry", "custom jeweler", "custom jewelry NYC", "custom grillz" ], [ "custom-cad-design", "private-jeweler", "appointment-only-jeweler" ] ], [ "jewelry-financing", "Jewelry Financing", "Jewelry financing support for engagement rings, diamond tennis chains, tennis bracelets, pendants, watches, and custom jewelry orders.", "don-logo.jpg", [ "jewelry financing", "engagement rings", "luxury jewelry" ], [ "custom-engagement-rings", "diamond-tennis-chains", "diamond-pendants" ] ], [ "diamond-education", "Diamond Education", "Learn diamond grading, the 4Cs, VVS vs VS clarity, lab grown diamonds, natural diamonds, diamond shapes, and buying strategy.", "round-diamond-studs.jpeg", [ "diamond education", "how diamonds are graded", "VVS diamonds" ], [ "lab-diamonds-vs-natural-diamonds", "lab-diamond-rings", "natural-diamond-rings" ] ], [ "lab-diamonds-vs-natural-diamonds", "Lab Diamonds vs Natural Diamonds", "Compare lab diamonds vs natural diamonds by origin, price, certification, appearance, resale considerations, and custom jewelry use.", "yellow-gold-oval-pave-engagement-ring.jpeg", [ "lab diamonds vs natural diamonds", "lab grown diamonds", "natural diamonds" ], [ "diamond-education", "lab-diamond-rings", "natural-diamond-rings" ] ], [ "jewelry-care", "Jewelry Care", "Jewelry care guidance for engagement rings, diamond chains, tennis bracelets, gold jewelry, watches, pendants, and custom pieces.", "yellow-gold-rope-chain-flat.jpeg", [ "how to clean jewelry", "jewelry repair", "fine jewelry" ], [ "diamond-tennis-bracelets", "diamond-pendants", "custom-jewelry" ] ], [ "custom-cad-design", "Custom CAD Design", "Custom CAD design for rings, pendants, initials, nameplates, grillz, chains, bracelets, and one-of-one diamond jewelry.", "custom-st-diamond-initial-pendant-front.jpeg", [ "CAD jewelry design", "custom jewelry", "custom jeweler" ], [ "custom-jewelry", "custom-engagement-rings", "diamond-pendants" ] ], [ "nyc-diamond-district-jeweler", "NYC Diamond District Jeweler", "A private jewelry experience for clients who want Diamond District access with a calmer, more personal way to design, source, and buy fine jewelry.", "queen-aurelia-oval-marquise-ring.jpeg", [ "NYC jeweler", "Manhattan jeweler", "Diamond District jeweler", "custom jewelry NYC" ], [ "private-jeweler", "appointment-only-jeweler", "custom-engagement-rings" ] ], [ "private-jeweler", "Private Jeweler", "Work one-on-one with a private jeweler for custom pieces, diamond sourcing, engagement rings, tennis chains, pendants, watches, and meaningful gifts.", "medusa-diamond-signet-ring.jpeg", [ "private jeweler", "luxury jewelry", "diamond consultation" ], [ "appointment-only-jeweler", "custom-jewelry", "nyc-diamond-district-jeweler" ] ], [ "appointment-only-jeweler", "Appointment Only Jeweler", "Book a relaxed private appointment where your questions, budget, style, timeline, and inspiration can be reviewed without pressure or a rushed showroom setting.", "two-tone-rolex-datejust-diamond-dial.jpeg", [ "appointment only jeweler", "private jeweler", "jewelry consultation" ], [ "private-jeweler", "custom-cad-design", "jewelry-financing" ] ], [ "engagement-rings-allentown-pa", "Engagement Rings Allentown PA", "Custom engagement rings for Allentown PA clients with lab grown diamonds, natural diamonds, CAD previews, private consultation, and nationwide shipping.", "engagement-ring-feature.jpg", [ "engagement rings Allentown PA", "custom engagement rings Allentown", "diamond rings Allentown" ], [ "custom-engagement-rings", "lab-diamond-rings", "jewelry-financing" ], "Allentown PA clients" ], [ "engagement-rings-lehigh-valley", "Engagement Rings Lehigh Valley", "Engagement rings for Lehigh Valley clients comparing custom settings, lab diamonds, natural diamonds, wedding bands, financing, and private jeweler guidance.", "queen-aurelia-oval-marquise-ring.jpeg", [ "engagement rings Lehigh Valley", "Lehigh Valley jeweler", "custom engagement rings PA" ], [ "engagement-rings-allentown-pa", "custom-engagement-rings", "natural-diamond-rings" ], "Lehigh Valley clients" ], [ "custom-jewelry-nyc", "Custom Jewelry NYC", "Custom jewelry in NYC for engagement rings, pendants, tennis chains, Cuban links, watches, CAD design, diamond sourcing, and private jeweler appointments.", "custom-dejaun-diamond-name-pendant.jpeg", [ "custom jewelry NYC", "custom jeweler NYC", "diamond jeweler NYC" ], [ "nyc-diamond-district-jeweler", "private-jeweler", "custom-cad-design" ], "NYC and Manhattan clients" ], [ "custom-jeweler-new-jersey", "Custom Jeweler New Jersey", "Custom jeweler serving New Jersey clients with engagement rings, diamond pendants, tennis bracelets, lab diamonds, natural diamonds, and shipped private orders.", "yellow-gold-diamond-cuban-link-bracelet.jpeg", [ "custom jeweler New Jersey", "engagement rings New Jersey", "diamond jeweler NJ" ], [ "custom-engagement-rings", "custom-jewelry", "diamond-tennis-bracelets" ], "New Jersey clients" ], [ "diamond-jeweler-connecticut", "Diamond Jeweler Connecticut", "Diamond jeweler serving Connecticut clients with custom engagement rings, diamond sourcing, tennis bracelets, pendants, CAD design, and insured shipping.", "triple-row-diamond-tennis-bracelet.jpeg", [ "diamond jeweler Connecticut", "engagement rings Connecticut", "custom jeweler CT" ], [ "custom-engagement-rings", "diamond-pendants", "lab-diamond-rings" ], "Connecticut clients" ], [ "tri-state-custom-jeweler", "Tri-State Custom Jeweler", "Tri-State custom jeweler serving New York, New Jersey, Connecticut, Pennsylvania, and nationwide clients with custom diamond jewelry and private consultation.", "diamond-banner.jpg", [ "Tri-State custom jeweler", "engagement rings Tri-State area", "diamond jeweler near me" ], [ "custom-jewelry-nyc", "custom-jeweler-new-jersey", "diamond-jeweler-connecticut" ], "Tri-State area clients" ], [ "diamond-jeweler-pennsylvania", "Diamond Jeweler Pennsylvania", "Diamond jeweler serving Pennsylvania clients with engagement rings, lab diamonds, natural diamonds, custom pendants, tennis bracelets, and private jewelry quotes.", "classic-marquise-engagement-ring.jpeg", [ "diamond jeweler Pennsylvania", "custom jeweler PA", "engagement rings Pennsylvania" ], [ "engagement-rings-allentown-pa", "engagement-rings-lehigh-valley", "custom-jewelry" ], "Pennsylvania clients" ], [ "free-engagement-ring-consultation", "Free Engagement Ring Consultation", "Free engagement ring consultation for clients comparing lab diamonds, natural diamonds, custom settings, budget, financing, CAD design, and private jeweler guidance.", "queen-aurelia-oval-marquise-ring.jpeg", [ "free engagement ring consultation", "engagement ring consultation", "custom engagement ring quote" ], [ "custom-engagement-rings", "lab-diamond-rings", "engagement-rings-allentown-pa" ], "serious engagement ring buyers" ], [ "lab-diamond-engagement-rings-allentown", "Lab Diamond Engagement Rings Allentown", "Lab diamond engagement rings for Allentown clients who want size, sparkle, certification, custom CAD settings, and private jeweler quote guidance.", "yellow-gold-oval-pave-engagement-ring.jpeg", [ "lab diamond engagement rings Allentown", "lab diamond rings Allentown PA", "engagement rings Allentown" ], [ "free-engagement-ring-consultation", "engagement-rings-allentown-pa", "lab-diamond-rings" ], "Allentown lab diamond clients" ], [ "private-jeweler-allentown", "Private Jeweler Allentown", "Private jeweler serving Allentown clients with engagement rings, diamond sourcing, custom pendants, tennis bracelets, CAD design, and appointment-based consultation.", "medusa-diamond-signet-ring.jpeg", [ "private jeweler Allentown", "custom jeweler Allentown", "diamond jeweler Allentown" ], [ "engagement-rings-allentown-pa", "diamond-jeweler-pennsylvania", "custom-jewelry" ], "Allentown private jewelry clients" ], [ "custom-engagement-rings-nyc", "Custom Engagement Rings NYC", "Custom engagement rings in NYC with lab grown diamonds, natural diamonds, CAD design, private diamond sourcing, and appointment-only jeweler guidance.", "engagement-ring-feature.jpg", [ "custom engagement rings NYC", "engagement rings NYC", "NYC engagement ring jeweler" ], [ "custom-jewelry-nyc", "nyc-diamond-district-jeweler", "free-engagement-ring-consultation" ], "NYC engagement ring clients" ], [ "lab-diamond-engagement-rings-nyc", "Lab Diamond Engagement Rings NYC", "Lab diamond engagement rings for NYC and Diamond District clients comparing certified CVD diamonds, custom settings, ring size, metal, CAD design, and private jeweler sourcing.", "yellow-gold-oval-pave-engagement-ring.jpeg", [ "lab diamond engagement rings NYC", "lab grown diamond rings NYC", "CVD engagement rings NYC" ], [ "custom-engagement-rings-nyc", "lab-diamond-rings", "select-diamond" ], "NYC lab diamond engagement ring clients" ], [ "custom-diamond-pendants-nyc", "Custom Diamond Pendants NYC", "Custom diamond pendants in NYC including name pendants, initials, crosses, religious pendants, CAD pendant design, and lab or natural diamond options.", "custom-dejaun-diamond-name-pendant.jpeg", [ "custom diamond pendants NYC", "diamond pendant NYC", "custom name pendant NYC" ], [ "diamond-pendants", "custom-jewelry-nyc", "custom-cad-design" ], "NYC custom pendant clients" ], [ "tennis-bracelets-allentown-pa", "Tennis Bracelets Allentown PA", "Diamond tennis bracelets for Allentown PA and Lehigh Valley clients with custom carat weight, lab-grown diamond options, gold color, bracelet length, and private quote support.", "triple-row-diamond-tennis-bracelet.jpeg", [ "tennis bracelets Allentown PA", "diamond tennis bracelet Allentown", "lab diamond bracelet Lehigh Valley" ], [ "diamond-tennis-bracelets", "diamond-jeweler-pennsylvania", "engagement-rings-allentown-pa" ], "Allentown tennis bracelet clients" ], [ "cvd-lab-grown-diamond-jewelry", "CVD Lab-Grown Diamond Jewelry", "Shop and request CVD lab-grown diamond jewelry including engagement rings, tennis bracelets, earrings, pendants, and rings from the live supplier catalog.", "live-diamond-selection.jpeg", [ "CVD lab grown diamond jewelry", "lab-grown diamond jewelry", "CVD diamond rings" ], [ "select-diamond", "lab-diamond-rings", "lab-diamonds-vs-natural-diamonds" ], "lab-grown diamond jewelry shoppers" ], [ "diamond-rings-near-me", "Diamond Rings Near Me", "Diamond rings near me search page for clients looking for engagement rings, lab diamonds, natural diamonds, custom settings, and private jeweler quotes.", "classic-marquise-engagement-ring.jpeg", [ "diamond rings near me", "engagement rings near me", "custom rings near me" ], [ "free-engagement-ring-consultation", "custom-engagement-rings", "lab-diamond-rings" ], "local diamond ring shoppers" ], [ "engagement-rings-new-jersey", "Engagement Rings New Jersey", "Engagement rings for New Jersey clients with custom settings, lab diamonds, natural diamonds, private consultation, financing options, and insured delivery.", "queen-aurelia-oval-marquise-ring.jpeg", [ "engagement rings New Jersey", "custom engagement rings NJ", "diamond rings New Jersey" ], [ "custom-jeweler-new-jersey", "free-engagement-ring-consultation", "lab-diamond-rings" ], "New Jersey engagement ring clients" ], [ "engagement-rings-connecticut", "Engagement Rings Connecticut", "Engagement rings for Connecticut clients comparing lab diamonds, natural diamonds, CAD settings, private jeweler consultation, and nationwide shipping.", "white-gold-marquise-pave-engagement-ring.jpeg", [ "engagement rings Connecticut", "custom engagement rings CT", "diamond rings Connecticut" ], [ "diamond-jeweler-connecticut", "free-engagement-ring-consultation", "natural-diamond-rings" ], "Connecticut engagement ring clients" ], [ "custom-jeweler-florida", "Custom Jeweler for Florida Clients", "Custom engagement rings, CVD lab-grown diamonds, diamond jewelry, CAD design, virtual private consultation, and insured shipping for Florida clients. The Don Jewelers serves Florida remotely and does not represent this page as a Florida storefront.", "queen-aurelia-oval-marquise-ring.jpeg", [ "custom jeweler Florida", "custom engagement rings Florida", "lab grown diamonds Florida" ], [ "custom-engagement-rings", "cvd-lab-grown-diamond-jewelry", "jewelry-financing" ], "Florida clients by virtual consultation and insured shipping" ], [ "engagement-ring-consultation-easton-bethlehem", "Engagement Ring Consultation Easton & Bethlehem", "Private engagement ring consultation for Easton and Bethlehem PA clients comparing diamonds, custom settings, CAD design, ring size, budget, and proposal timing.", "queen-aurelia-oval-marquise-ring.jpeg", [ "engagement rings Easton PA", "engagement rings Bethlehem PA", "private jeweler Easton Bethlehem" ], [ "engagement-rings-lehigh-valley", "free-engagement-ring-consultation", "custom-engagement-rings" ], "Easton and Bethlehem engagement ring clients" ], [ "custom-jewelry-project-gallery", "Custom Jewelry Project Gallery", "Explore original custom engagement rings, pendants, bracelets, initials, wedding sets, and one-of-one jewelry inspiration from The Don Jewelers.", "custom-dejaun-diamond-name-pendant.jpeg", [ "custom jewelry projects", "custom jewelry gallery", "custom jeweler portfolio" ], [ "custom-jewelry", "custom-cad-design", "custom-orders" ], "custom jewelry clients" ], [ "the-don-jewelers", "The Don Jewelers", "Official page for The Don Jewelers, a private custom jeweler for engagement rings, diamond jewelry, tennis chains, pendants, CAD design, and jewelry consultation.", "don-logo.jpg", [ "The Don Jewelers", "Don Jewelers", "The Don Jewelers jewelry" ], [ "the-don-jewelers-and-jewelry", "custom-engagement-rings", "free-engagement-ring-consultation" ], "clients searching The Don Jewelers" ], [ "the-don-jewelers-and-jewelry", "The Don Jewelers & Jewelry", "Official business page for The Don Jewelers & Jewelry with verified contact details, Google Business Profile, private jeweler service areas, and custom jewelry consultation.", "yellow-gold-diamond-cuban-link-bracelet.jpeg", [ "The Don Jewelers and Jewelry", "The Don Jewelers & Jewelry", "Don Jewelers and Jewelry" ], [ "the-don-jewelers", "tri-state-custom-jeweler", "custom-jewelry" ], "clients searching the official business name" ], [ "don-jewelers-nyc", "Don Jewelers NYC", "Don Jewelers NYC search page for clients looking for The Don Jewelers & Jewelry, custom engagement rings, diamond sourcing, and private jewelry consultation.", "diamond-banner.jpg", [ "Don Jewelers NYC", "The Don Jewelers NYC", "NYC Don Jewelers" ], [ "custom-jewelry-nyc", "nyc-diamond-district-jeweler", "custom-engagement-rings-nyc" ], "NYC brand search clients" ], [ "the-don-jewelers-engagement-rings", "The Don Jewelers Engagement Rings", "Engagement ring page for The Don Jewelers with lab diamonds, natural diamonds, custom settings, CAD design, private consultation, and proposal jewelry guidance.", "engagement-ring-feature.jpg", [ "The Don Jewelers engagement rings", "Don Jewelers engagement ring", "The Don Jewelers rings" ], [ "custom-engagement-rings", "free-engagement-ring-consultation", "diamond-rings-near-me" ], "engagement ring clients searching the brand" ], [ "custom-engagement-ring-process", "Custom Engagement Ring Process", "A step-by-step guide to choosing a center diamond, setting, metal, basket, prongs, band, ring size, CAD review, and private custom quote.", "queen-aurelia-oval-marquise-ring.jpeg", [ "custom engagement ring process", "how to design a custom engagement ring", "CAD engagement ring" ], [ "start-custom-ring-design", "free-engagement-ring-consultation", "engagement-ring-cost-guide" ], "custom engagement ring buyers" ], [ "engagement-ring-cost-guide", "Engagement Ring Cost Guide", "Compare diamond type, carat, shape, certification, metal, setting, side stones, labor, CAD, wedding band pairing, and custom quote factors.", "yellow-gold-oval-pave-engagement-ring.jpeg", [ "engagement ring cost", "custom engagement ring price", "lab diamond ring cost" ], [ "custom-engagement-ring-process", "lab-diamond-buying-guide", "jewelry-financing" ], "budget-focused engagement ring buyers" ], [ "lab-diamond-buying-guide", "Lab Diamond Buying Guide", "Guide to CVD lab diamond buying for engagement rings and jewelry, including certificate, carat, shape, color, clarity, cut, video, and setting fit.", "live-diamond-selection.jpeg", [ "lab diamond buying guide", "CVD lab diamond engagement ring", "lab grown diamond ring guide" ], [ "select-diamond", "lab-diamond-rings", "lab-diamonds-vs-natural-diamonds" ], "lab diamond buyers" ], [ "private-jeweler-vs-retail-store", "Private Jeweler vs Retail Store", "Compare private jeweler consultation with retail jewelry shopping for custom engagement rings, diamond sourcing, CAD design, and quote-first buying.", "medusa-diamond-signet-ring.jpeg", [ "private jeweler vs retail store", "private jeweler engagement ring", "custom jeweler consultation" ], [ "private-jeweler", "appointment-only-jeweler", "custom-engagement-rings" ], "buyers comparing jewelers" ], [ "service-areas", "Private Jeweler Service Areas", "Explore organized private jeweler service areas across New York, Pennsylvania, New Jersey, Connecticut, Ohio, Florida, the Tri-State region, and nationwide virtual consultation with insured shipping.", "diamond-banner.jpg", [ "private jeweler service areas", "custom jeweler near me", "nationwide custom jewelry" ], [ "tri-state-custom-jeweler", "diamond-jeweler-pennsylvania", "custom-jeweler-new-jersey" ], "regional and nationwide jewelry clients" ], [ "custom-jeweler-syracuse-ny", "Custom Jeweler Syracuse NY", "Private custom jewelry service for Syracuse and Central New York clients seeking engagement rings, certified diamonds, CAD design, pendants, earrings, and insured delivery.", "queen-aurelia-oval-marquise-ring.jpeg", [ "custom jeweler Syracuse NY", "engagement rings Syracuse", "diamond jeweler Central New York" ], [ "custom-jeweler-new-york-state", "custom-engagement-rings", "select-diamond" ], "Syracuse and Central New York clients" ], [ "custom-jeweler-floral-park-ny", "Custom Jeweler Floral Park NY", "Custom engagement rings and fine jewelry for Floral Park, Queens, Nassau County, and western Long Island clients with private consultation, CAD review, and diamond sourcing.", "engagement-ring-feature.jpg", [ "custom jeweler Floral Park NY", "engagement rings Floral Park", "diamond jeweler Nassau County" ], [ "custom-jeweler-long-island-ny", "custom-engagement-rings-nyc", "free-engagement-ring-consultation" ], "Floral Park and western Long Island clients" ], [ "custom-jeweler-long-island-ny", "Custom Jeweler Long Island NY", "Private jeweler service for Long Island clients comparing custom engagement rings, lab-grown or natural diamonds, wedding bands, pendants, earrings, and insured delivery.", "classic-marquise-engagement-ring.jpeg", [ "custom jeweler Long Island", "engagement rings Long Island", "diamond jeweler Nassau Suffolk" ], [ "custom-jeweler-floral-park-ny", "custom-jeweler-new-york-state", "lab-diamond-rings" ], "Nassau and Suffolk County clients" ], [ "custom-jeweler-new-york-state", "Custom Jeweler New York State", "Private custom jewelry and diamond sourcing for clients across New York State, including NYC, Long Island, Syracuse, Central New York, and nationwide remote consultation.", "diamond-banner.jpg", [ "custom jeweler New York State", "New York diamond jeweler", "custom engagement rings New York" ], [ "custom-jeweler-syracuse-ny", "custom-jeweler-long-island-ny", "nyc-diamond-district-jeweler" ], "New York State clients" ], [ "custom-jeweler-philadelphia-pa", "Custom Jeweler Philadelphia PA", "Custom engagement rings, certified diamonds, pendants, tennis bracelets, earrings, and CAD design for Philadelphia-area clients through private consultation and insured delivery.", "yellow-gold-oval-pave-engagement-ring.jpeg", [ "custom jeweler Philadelphia PA", "engagement rings Philadelphia", "diamond jeweler Philadelphia" ], [ "diamond-jeweler-pennsylvania", "custom-engagement-rings", "jewelry-financing" ], "Philadelphia and southeastern Pennsylvania clients" ], [ "custom-jeweler-pennsylvania", "Custom Jeweler Across Pennsylvania", "Statewide private jeweler service for Pennsylvania clients from Allentown and the Lehigh Valley to Philadelphia, Harrisburg, Scranton, Pittsburgh, and surrounding communities.", "diamond-banner.jpg", [ "custom jeweler Pennsylvania", "engagement rings PA", "diamond jeweler Pennsylvania" ], [ "engagement-rings-allentown-pa", "custom-jeweler-philadelphia-pa", "diamond-jeweler-pennsylvania" ], "clients across Pennsylvania" ], [ "custom-jewelry-pennsylvania", "Custom Jewelry Pennsylvania", "Design custom jewelry in Pennsylvania with private consultation, CAD planning, GIA or IGI certified diamonds, insured nationwide shipping, and clear quote support.", "medusa-diamond-signet-ring.jpeg", [ "custom jewelry Pennsylvania", "custom jeweler PA", "certified diamonds Pennsylvania" ], [ "custom-jeweler-pennsylvania", "diamond-jewelry-pennsylvania", "custom-orders" ], "Pennsylvania custom jewelry clients" ], [ "jewelry-store-easton-pa", "Jewelry Store Easton PA", "A private jewelry-store alternative for Easton PA clients seeking engagement rings, custom jewelry, certified diamonds, appointments, and insured delivery.", "engagement-ring-feature.jpg", [ "jewelry store Easton PA", "Easton jeweler", "diamond jewelry Easton" ], [ "engagement-rings-easton-pa", "engagement-ring-consultation-easton-bethlehem", "custom-jewelry-pennsylvania" ], "Easton PA jewelry clients" ], [ "engagement-rings-easton-pa", "Engagement Rings Easton PA", "Shop or design engagement rings for Easton PA with lab-grown or natural diamonds, CAD settings, ring-sizing guidance, financing options, and private consultation.", "queen-aurelia-oval-marquise-ring.jpeg", [ "engagement rings Easton PA", "custom engagement rings Easton", "diamond rings Easton" ], [ "jewelry-store-easton-pa", "start-custom-ring-design", "select-diamond" ], "Easton PA engagement ring clients" ], [ "diamond-jewelry-pennsylvania", "Diamond Jewelry Pennsylvania", "Diamond jewelry for Pennsylvania clients including engagement rings, pendants, earrings, tennis bracelets, certified stones, custom design, and insured shipping.", "diamond-banner.jpg", [ "diamond jewelry Pennsylvania", "diamond jeweler PA", "custom diamond jewelry" ], [ "custom-jewelry-pennsylvania", "diamond-jeweler-pennsylvania", "products" ], "Pennsylvania diamond jewelry clients" ], [ "diamond-district-custom-jewelry-nyc", "Diamond District Custom Jewelry NYC", "Create Diamond District custom jewelry in NYC with one-to-one design guidance, CAD approval, certified diamond sourcing, secure checkout, and nationwide service.", "custom-dejaun-diamond-name-pendant.jpeg", [ "Diamond District custom jewelry", "custom jewelry NYC", "private jeweler Manhattan" ], [ "nyc-diamond-district-jeweler", "custom-jewelry-nyc", "custom-orders" ], "NYC custom jewelry clients" ], [ "custom-jeweler-northern-new-jersey", "Custom Jeweler Northern New Jersey", "Private custom jewelry service for Northern New Jersey clients seeking engagement rings, certified diamonds, pendants, earrings, CAD design, and appointment guidance.", "custom-dejaun-diamond-name-pendant.jpeg", [ "custom jeweler Northern New Jersey", "engagement rings North Jersey", "diamond jeweler NJ" ], [ "custom-jeweler-new-jersey", "engagement-rings-new-jersey", "tri-state-custom-jeweler" ], "Northern New Jersey clients" ], [ "custom-jeweler-ohio", "Custom Jeweler Ohio", "Remote private jeweler service for Ohio clients seeking custom engagement rings, CVD lab-grown diamonds, natural diamonds, pendants, earrings, CAD design, and insured shipping.", "queen-aurelia-oval-marquise-ring.jpeg", [ "custom jeweler Ohio", "engagement rings Ohio", "diamond jeweler Ohio" ], [ "custom-engagement-rings", "cvd-lab-grown-diamond-jewelry", "jewelry-financing" ], "Ohio clients by virtual consultation and insured shipping" ] ];

const blogTopics = [ "How Much Does a Diamond Tennis Chain Cost?", "Lab Diamonds vs Natural Diamonds", "How to Buy an Engagement Ring", "Best Diamond Shapes", "How Diamonds Are Graded", "How to Clean Jewelry", "What Makes VVS Diamonds Better", "How to Finance Jewelry", "Custom Jewelry Process", "Best Engagement Ring Styles", "How to Choose a Diamond Tennis Bracelet", "14K Gold vs 18K Gold for Custom Jewelry", "White Gold vs Yellow Gold vs Rose Gold", "How to Buy a Diamond Pendant", "What to Know Before Buying a Diamond Cross", "How CAD Jewelry Design Works", "Natural Diamond Buying Guide", "Lab Diamond Ring Buying Guide", "How to Choose Wedding Bands", "Private Jeweler vs Retail Jewelry Store", "NYC Diamond District Jeweler Buying Tips", "Engagement Rings in NYC: What to Know", "Tennis Chains NYC Buying Guide", "Best Jewelry Gifts for Anniversaries", "Best Jewelry Gifts for Birthdays", "How to Design a Custom Diamond Pendant", "Rolex, Cartier, Audemars Piguet and Patek Philippe Watch Buying Notes", "How to Choose Gold Chains", "Cuban Chains Buying Guide", "Diamond Clarity Explained", "Diamond Color Explained", "Diamond Cut Explained", "Diamond Carat Weight Explained", "VVS vs VS Diamonds", "IGI vs GIA Diamond Certificates", "How to Source a Diamond", "Jewelry Repair: What Can Be Fixed?", "How Often Should Jewelry Be Inspected?", "How to Protect Diamond Jewelry", "How to Store Fine Jewelry", "Custom Grillz Buying Guide", "Easton PA Custom Jeweler Guide", "Lehigh Valley Jeweler Guide", "Bethlehem PA Engagement Ring Guide", "Allentown PA Jewelry Buying Guide", "Manhattan Private Jeweler Guide", "How to Plan a Custom Engagement Ring Budget", "Diamond Pendant Size Guide", "Tennis Bracelet Carat Size Guide", "Questions to Ask a Jeweler Before Buying" ];

const blogImagePool = [ "yellow-gold-cuban-chain-display.jpeg", "queen-aurelia-oval-marquise-ring.jpeg", "triple-row-diamond-tennis-bracelet.jpeg", "large-round-diamond-cross-pendant.jpeg", "custom-dejaun-diamond-name-pendant.jpeg", "two-tone-rolex-datejust-diamond-dial.jpeg", "round-diamond-studs.jpeg", "yellow-gold-rope-chain-triple.jpeg", "medusa-diamond-signet-ring.jpeg", "saint-michael-diamond-angel-pendant.jpeg", "yellow-gold-oval-pave-engagement-ring.jpeg", "custom-st-diamond-initial-pendant-front.jpeg" ];
...
const educationResources = [ {
    ...
    sections: [ [ "Learn the language before the purchase", "Diamonds are often described with grades, reports, abbreviations, and pricing language that can feel intimidating at first. Once you understand cut, color, clarity, carat, certification, and origin, the conversation becomes much more comfortable." ], [ "Look beyond the certificate", "A certificate is important, but it does not replace taste, proportion, setting style, and the way the diamond looks in real life. The best buying process combines paperwork with visual review." ], [ "Use education to narrow the choices", "The goal is not to compare every stone on the market. The goal is to narrow the field to diamonds and jewelry options that fit your budget, style, timeline, and comfort level." ] ],
    faqs: [ [ "Where should I start with diamond education?", "Start with the 4Cs, then learn the difference between lab grown and natural diamonds, certification, and how the stone will be used in the final piece." ], [ "Can a private jeweler explain diamonds before I buy?", "Yes. The Don Jewelers can walk through diamond options, certificates, videos, and custom design details before you commit." ], [ "Do you help beginners?", "Yes. The process is built to be clear for first-time buyers and detailed enough for clients comparing higher-end stones." ] ]
}, {
    ...
    sections: [ [ "A diamond, in plain English", "A diamond is crystallized carbon arranged under extreme pressure and heat. That sounds technical, but what matters to a buyer is simpler: a diamond is valued by how beautifully it handles light, how rare its characteristics are, and how well it fits the jewelry being made." ], [ "Natural diamonds and lab grown diamonds", "Natural diamonds form underground over long geological periods. Lab grown diamonds are grown in controlled environments and have the same optical and chemical identity as diamond. The choice is not about one being beautiful and the other not; it is about budget, origin preference, size goals, and the story you want behind the piece." ], [ "Why two diamonds with the same carat can look different", "Carat weight only tells you weight. Cut, measurements, depth, table, polish, symmetry, color, and clarity all influence what your eye sees. A smaller diamond with excellent proportions can look brighter than a heavier diamond that carries weight in the wrong places." ] ],
    faqs: [ [ "Is a lab grown diamond a real diamond?", "Yes. A lab grown diamond is a real diamond with the same basic optical and chemical properties as a mined diamond, but it has a different origin story." ], [ "What should beginners look at first?", "Start with shape, cut quality, budget, and the finished jewelry design. Certification matters, but the stone also has to look right in person or on video." ], [ "Can The Don Jewelers help source a diamond?", "Yes. The Don Jewelers can help compare certified stones, explain tradeoffs, and source diamonds for engagement rings, pendants, earrings, tennis chains, and custom jewelry." ] ]
}, {
    ...
    sections: [ [ "What is actually different?", "Lab grown and natural diamonds can look identical to the naked eye when quality is comparable. The difference is origin: one is grown in a laboratory, the other formed naturally underground. That origin affects price, availability, and personal preference." ], [ "Where lab diamonds shine", "Lab diamonds often let clients move up in size, color, or clarity without stretching the budget as far. They are especially popular for engagement rings, tennis bracelets, earrings, and statement pieces where visual presence matters." ], [ "Where natural diamonds still matter", "Natural diamonds appeal to clients who value rarity, tradition, and the natural origin of the stone. For some buyers, especially for bridal jewelry, that story is part of the emotional value." ] ],
    comparison: [ [ "Category", "Lab Grown Diamond", "Natural Diamond" ], [ "Origin", "Grown in a controlled environment", "Formed naturally underground" ], [ "Visual look", "Can be visually identical at comparable quality", "Can be visually identical at comparable quality" ], [ "Budget", "Usually more size for the money", "Usually higher cost at the same specs" ], [ "Best for", "Size, value, modern custom jewelry", "Rarity, tradition, natural origin" ] ],
    faqs: [ [ "Can people tell the difference by looking?", "Usually no. Proper testing equipment and certification identify origin, but comparable stones can look the same to the eye." ], [ "Are lab diamonds good for engagement rings?", "Yes. Many clients choose lab diamonds for engagement rings because they can prioritize size, color, and clarity within budget." ], [ "Do you source both?", "Yes. The Don Jewelers can source both lab grown and natural diamonds based on your goals." ] ]
}, {
    slug: "diamond-cut",
    title: "Diamond Cut",
    eyebrow: "The 4Cs",
    ...
    sections: [ [ "Cut is not the same as shape", "Shape is round, oval, emerald, pear, marquise, cushion, radiant, or princess. Cut is how well that shape has been proportioned and finished. A round diamond and an oval diamond are shapes; their brightness depends on cutting decisions." ], [ "Why sparkle changes from stone to stone", "A diamond has to return light back to your eye. If the stone is too deep, too shallow, or poorly proportioned, light leaks out instead of reflecting back. That is why two diamonds with similar paperwork can feel very different." ], [ "How to judge cut in real life", "Look at the diamond in motion. Watch the brightness, contrast, and pattern. A stone should not only look good under jewelry-store lighting; it should still have life in softer, everyday light." ] ],
    faqs: [ [ "Is cut the most important C?", "For many buyers, yes. Cut has a major effect on beauty because it controls light performance." ], [ "Does every shape receive the same cut grade?", "No. Round diamonds have the most standardized cut grading. Fancy shapes need a more hands-on review of measurements and appearance." ], [ "Can you help compare diamond cuts?", "Yes. The Don Jewelers can review stones, measurements, videos, and certificates before you commit." ] ]
}, {
    slug: "diamond-color",
    title: "Diamond Color",
    eyebrow: "The 4Cs",
    ...
    sections: [ [ "What color grades mean", "White diamonds are graded on a scale that usually runs from D, the most colorless, down through warmer grades. Most clients do not need to memorize the whole scale; they need to know what looks clean in the setting they want." ], [ "Metal color changes perception", "Yellow gold and rose gold can be forgiving because the setting already carries warmth. White gold and platinum make body color easier to notice, especially in larger stones." ], [ "Fancy color diamonds", "Yellow, pink, blue, and other fancy color diamonds are judged differently. With fancy colors, the color itself becomes the feature, not something to hide." ] ],
    faqs: [ [ "Is D color always best?", "D color is the highest colorless grade, but it is not always the smartest spend. Many designs look excellent below D when the stone is well chosen." ], [ "Does yellow gold hide diamond warmth?", "It can soften the look of warmer diamonds, especially in certain settings." ], [ "Can you source fancy color diamonds?", "Yes. Fancy color options can be discussed by budget, shape, intensity, and timing." ] ]
}, {
    ...
    sections: [ [ "What clarity measures", "Clarity describes internal inclusions and surface characteristics. Higher clarity means fewer or less visible characteristics under magnification, but the key question is whether anything distracts from the stone's beauty." ], [ "VVS, VS, and eye-clean stones", "VVS diamonds are very clean under magnification. VS diamonds can also look completely clean to the eye and often offer strong value. For many pieces, an eye-clean diamond is the sweet spot." ], [ "When clarity matters more", "Clarity becomes more important in step cuts like emerald and asscher shapes because their broad facets show the inside of the stone more clearly. Brilliant cuts can hide inclusions better." ] ],
    faqs: [ [ "Is VVS always worth it?", "VVS is beautiful, but it is not always necessary. The right choice depends on shape, size, budget, and how visible the inclusions are." ], [ "What does eye-clean mean?", "Eye-clean means no distracting inclusions are visible to the naked eye in normal viewing." ], [ "Can you help avoid bad inclusions?", "Yes. The Don Jewelers can review stone plots, videos, and photos before sourcing." ] ]
}, {
    slug: "diamond-carat",
    title: "Diamond Carat",
    eyebrow: "The 4Cs",
    ...
    sections: [ [ "Carat is weight", "Carat tells you how much a diamond weighs. It does not automatically tell you how large the diamond will look from the top, because shape and proportions affect spread." ], [ "Why measurements matter", "Two one-carat diamonds can face up differently. A well-proportioned stone can look balanced and bright, while another may hide weight in depth." ], [ "Total carat weight", "For tennis chains, bracelets, earrings, and multi-stone pieces, total carat weight describes all diamonds combined. Pointer size and layout affect the finished look just as much as the total number." ] ],
    faqs: [ [ "Does higher carat always look bigger?", "Not always. Shape and measurements affect how large a diamond appears." ], [ "What is total carat weight?", "Total carat weight is the combined weight of all diamonds in a piece." ], [ "Can you build around a target carat size?", "Yes. The Don Jewelers can source or design around a target size and budget." ] ]
}, {
    ...
    sections: [ [ "What a certificate tells you", "A diamond report records measurements, carat weight, color, clarity, proportions, polish, symmetry, fluorescence, and origin details when applicable. It gives you a common language for comparison." ], [ "IGI and GIA", "GIA is deeply respected for natural diamonds, while IGI is widely used for lab grown diamonds. Both can be useful, but the stone still has to be reviewed visually." ], [ "Why paperwork is not the whole story", "Certificates do not fully capture beauty, personality, or how a diamond looks in a setting. Videos, photos, measurements, and a jeweler's review help complete the picture." ] ],
    faqs: [ [ "Should I buy only certified diamonds?", "For important diamonds, certification is strongly recommended because it protects clarity around specs and origin." ], [ "Is IGI good for lab diamonds?", "IGI is widely used for lab grown diamonds and can be useful for comparing stones." ], [ "Can you review a certificate?", "Yes. You can send a certificate or stock number for review before a custom order." ] ]
}, {
    slug: "nyc-jewelers",
    title: "NYC Jewelers",
    ...
    sections: [ [ "What makes a good NYC jeweler", "A good jeweler listens first. Before discussing price, they should understand the piece, budget, timeline, stone preference, and how the jewelry will be worn." ], [ "Private jeweler vs showroom shopping", "Showrooms can be useful, but they can also feel fast and crowded. A private jeweler gives you room to compare options without pressure." ], [ "Working beyond New York", "The Don Jewelers primarily serves the tri-state area and works with clients nationwide through Zoom, FaceTime, video chat, insured shipping, and clear communication." ] ],
    faqs: [ [ "Do you work with NYC clients?", "Yes. NYC, Manhattan, Diamond District, New Jersey, Pennsylvania, and nationwide clients can work with The Don Jewelers." ], [ "Can appointments happen remotely?", "Yes. Zoom, FaceTime, and video chat are available for clients outside the area." ], [ "Can you help with custom jewelry?", "Yes. Custom jewelry, CAD design, diamond sourcing, and private consultations are available." ] ]
}, {
    ...
    sections: [ [ "Why the Diamond District matters", "The Diamond District is known for access to diamonds, setters, designers, manufacturers, and jewelry professionals. That access can be powerful when guided properly." ], [ "What buyers should avoid", "Avoid rushing into a stone because it sounds like a deal. Compare certificates, videos, measurements, return terms, production details, and the finished design plan." ], [ "How private sourcing helps", "Private sourcing narrows the field. Instead of sorting through everything, you review diamonds and designs that fit your budget and taste." ] ],
    faqs: [ [ "Do I need to visit the Diamond District in person?", "Not always. Many decisions can be handled through video, photos, certificates, and private consultation." ], [ "Can you source diamonds from NYC?", "Yes. Diamond sourcing can be arranged around shape, carat, color, clarity, certification, and budget." ], [ "Do you serve nationwide clients?", "Yes. Clients across the United States can work remotely with insured shipping." ] ]
}, {
    ...
    sections: [ [ "Start with style", "Before comparing certificates, look at the style: solitaire, halo, three-stone, hidden halo, pavé, vintage, bezel, or custom. The setting shapes the personality of the ring." ], [ "Choose the diamond thoughtfully", "Shape, cut, color, clarity, carat, and certification all matter. The best engagement ring balances the center stone with the setting and the hand that will wear it." ], [ "Think about the wedding band early", "A beautiful engagement ring should also make sense next to a wedding band. Some settings sit flush easily, while others need a custom curved or contoured band." ] ],
    faqs: [ [ "Can you build a custom engagement ring?", "Yes. The Don Jewelers can help with CAD design, diamond sourcing, metal choice, and production." ], [ "Do you offer lab and natural diamonds?", "Yes. Both lab grown and natural diamonds are available depending on preference and budget." ], [ "Can I start with inspiration photos?", "Yes. Photos are one of the best ways to begin a custom ring conversation." ] ]
}, {
    slug: "tennis-chains",
    ...
    sections: [ [ "Pointer size and total carat weight", "Pointer size describes the approximate size of each diamond. Total carat weight adds up every stone in the chain. Both affect price and visual presence." ], [ "Metal and length", "White gold, yellow gold, rose gold, 14K, and 18K all create a different look and feel. Length changes how the chain sits and how much diamond weight is needed." ], [ "Clasp and build quality", "A tennis chain needs a secure clasp and strong construction. Beauty matters, but security matters just as much on a high-value piece." ] ],
    faqs: [ [ "Can I build a custom tennis chain?", "Yes. You can choose pointer size, length, metal, diamond type, and clasp style." ], [ "Are lab diamonds available?", "Yes. Lab grown and natural diamond options can be discussed." ], [ "What affects tennis chain price?", "Diamond size, total carat weight, metal, length, clasp style, and labor all affect price." ] ]
}, {
    ...
    sections: [ [ "Fit and comfort", "A tennis bracelet should move comfortably without sliding too far down the hand. Fit affects both comfort and security." ], [ "Carat weight and layout", "Total carat weight matters, but stone size and spacing control the finished look. A bracelet can be delicate, bold, or somewhere in between." ], [ "Clasp security", "A secure clasp is essential. For daily wear, ask about safety features and have the bracelet inspected periodically." ] ],
    faqs: [ [ "Can tennis bracelets be made custom?", "Yes. Metal, diamond type, carat weight, length, and clasp style can be selected." ], [ "Can I wear a tennis bracelet daily?", "Many clients do, but it should be worn responsibly and inspected." ], [ "Do you offer financing?", "Financing may be available through third-party providers depending on approval." ] ]
}, {
    slug: "pendants",
    ...
    sections: [ [ "Start with meaning", "Initials, names, crosses, icons, numbers, and symbols all carry a story. The best pendant starts with what the piece is supposed to say." ], [ "Choose scale carefully", "Size affects cost, comfort, visibility, and how the pendant works with a chain. A bold piece needs enough structure; a daily piece needs balance." ], [ "CAD design helps", "For custom pendants, CAD previews help confirm proportions, stone layout, bail size, and the overall feel before production." ] ],
    faqs: [ [ "Can you design a custom pendant?", "Yes. Custom pendant design, CAD, diamond layout, and metal options are available." ], [ "Can I use initials or names?", "Yes. Initial pendants, name pendants, and symbolic designs can be created." ], [ "Can you help choose a chain?", "Yes. Chain style, length, and strength should match the pendant." ] ]
}, {
    slug: "gold-jewelry",
    title: "Gold Jewelry",
    ...
    sections: [ [ "14K vs 18K", "14K gold is durable and practical for many everyday pieces. 18K gold has a richer gold content and a deeper luxury feel, but it can be softer depending on the design." ], [ "Yellow, white, and rose gold", "Yellow gold feels classic and warm. White gold gives a crisp diamond-forward look. Rose gold adds softness and warmth with a distinct personality." ], [ "Match metal to lifestyle", "Rings and bracelets take more impact than pendants. If a piece will be worn daily, durability should be part of the conversation." ] ],
    faqs: [ [ "Is 14K or 18K better?", "Neither is automatically better. 14K is practical and durable; 18K has a richer gold feel." ], [ "Can custom jewelry be made in different gold colors?", "Yes. Yellow gold, white gold, rose gold, and platinum options can be discussed." ], [ "Does gold price change?", "Yes. Gold pricing can change with market conditions and piece weight." ] ]
}, {
    ...
    sections: [ [ "$500 first custom-order credit", "New customers can request a $500 credit on a first eligible custom jewelry order of $2,500 or more. Enter FIRST500 in checkout. The checkout total is not reduced automatically; someone from our team will contact you after purchase to verify eligibility. Promotions cannot stack." ], [ "15% off with THEDON15", "Enter THEDON15 in the checkout offer field to request 15% off eligible items. Your checkout total stays unchanged. Someone from our team will contact you after purchase to verify the purchase and first-time customer eligibility. Choose either THEDON15 or FIRST500; promotions cannot stack." ], [ "How Buy Now, Pay Later works", "Add an eligible item to cart and continue to secure Stripe Checkout. If an eligible provider is available, select it, review the payment schedule and disclosures, then apply. Approval is handled by the provider, not The Don Jewelers." ], [ "Affirm", "Affirm may offer pay-over-time plans for eligible purchases. Available terms, interest or APR, required down payment, and total cost are shown by Affirm before acceptance." ], [ "Klarna", "Klarna may offer installment or pay-later choices for eligible purchases. The schedule, any fees or interest, and first payment timing appear before acceptance." ], [ "Afterpay", "Afterpay may divide an eligible purchase into scheduled installments. The schedule, initial payment, spending limit, and late-fee rules are provided before acceptance." ], [ "Eligibility and approval", "Provider availability can vary by order amount, location, currency, device, customer history, and Stripe eligibility. Financing logos explain possible options; they do not promise approval." ], [ "Payments, returns, and custom orders", "Payments are managed through the selected provider. Refunds and cancellations follow the store return policy and provider timing. Custom work may require a deposit and have different cancellation limits." ], [ "Questions before applying", "Call (484) 761-2008 or book a private consultation. The Don Jewelers can explain the purchase process but does not make credit decisions or change provider terms." ] ],
    faqs: [ [ "Is financing guaranteed?", "No. Financing depends on third-party provider approval." ], [ "Can financing be used for custom jewelry?", "It may be available depending on the provider, purchase amount, and order details." ], [ "Can I ask questions before applying?", "Yes. The Don Jewelers can explain available purchase paths before you move forward." ] ]
}, {
    slug: "custom-jewelry",
    ...
    sections: [ [ "Bring the idea", "A custom project can start with a sketch, a photo, a name, a symbol, a stone, or a loose concept. The first step is understanding what the piece should mean and how it should be worn." ], [ "CAD and approvals", "CAD design helps translate the idea into structure. This is where proportions, stone placement, bail size, ring size, and design details can be reviewed before production." ], [ "Production and finishing", "After approval, the piece moves through production, setting, polishing, and quality review. Custom timelines vary by complexity and sourcing." ] ],
    faqs: [ [ "Can you make one-of-one jewelry?", "Yes. The Don Jewelers works on custom rings, pendants, chains, bracelets, earrings, and other personal pieces." ], [ "Do I need a finished design before contacting you?", "No. Inspiration photos and a rough direction are enough to start." ], [ "Can CAD be used before production?", "Yes. CAD is available when the design requires technical approval." ] ]
} ];
...
function buildBlogArticle(title, index) {
    ...
    return {
        ...
        sections: matched?.sections || [ [ `What ${focus.toLowerCase()} really means`, `The best way to approach ${focus.toLowerCase()} is to connect the technical details to the finished piece. A number, grade, or label only matters when it improves the way the jewelry looks, feels, wears, or holds meaning for the person receiving it.` ], [ "What affects price and quality", "Pricing usually depends on material, diamond quality, carat weight, labor, certification, design complexity, and timing. Two pieces can sound similar on paper but feel very different once stone quality, gold weight, setting work, and finishing are compared." ], [ "How a private jeweler helps", "A private jeweler can narrow the options, explain tradeoffs, and keep the process personal. That matters when you are buying an engagement ring, tennis chain, tennis bracelet, pendant, watch, or one-of-one custom piece." ] ],
        faqs: matched?.faqs || [ [ `Can The Don Jewelers help with ${focus.toLowerCase()}?`, `Yes. The Don Jewelers can explain options, compare quality, and help plan a purchase or custom project around ${focus.toLowerCase()}.` ], [ "Can I request a custom quote?", "Yes. Send photos, budget, metal preference, diamond preference, and timing so the project can be reviewed clearly." ], [ "Can this be handled remotely?", "Yes. Clients can work through phone, text, Zoom, FaceTime, or video chat, with insured shipping available nationwide." ] ]
    };
}

const blogArticles = blogTopics.map((title, index) => buildBlogArticle(title, index));

const serverSeoArticles = [ [ "custom-engagement-ring-timeline", "How Long Does a Custom Engagement Ring Take?", "A practical timeline from consultation and CAD approval through production, inspection, and delivery.", "queen-aurelia-oval-marquise-ring.jpeg" ], [ "oval-vs-radiant-engagement-ring", "Oval vs Radiant Diamond Engagement Rings", "Compare sparkle, proportions, finger coverage, and setting compatibility.", "yellow-gold-oval-pave-engagement-ring.jpeg" ], [ "hidden-halo-vs-halo-engagement-ring", "Hidden Halo vs Halo Engagement Rings", "Understand how each halo style changes the face-up view, profile, and wedding-band fit.", "gold-halo-engagement-ring.jpeg" ], [ "read-igi-lab-diamond-report", "How to Read an IGI Lab Diamond Report", "Review measurements, cut, color, clarity, polish, symmetry, fluorescence, and inscription.", "live-diamond-selection.jpeg" ], [ "custom-engagement-ring-cost-factors", "What Changes the Cost of a Custom Engagement Ring?", "Learn how diamond, metal, setting, labor, and customization choices affect a quote.", "engagement-ring-feature.jpg" ], [ "private-jeweler-lehigh-valley-appointment", "Planning a Private Jewelry Appointment in the Lehigh Valley", "Prepare for an engagement-ring, diamond-sourcing, or custom-jewelry consultation.", "don-logo.jpg" ] ].map(([slug, title, description, image]) => ({
    slug: slug,
    title: title,
...
function productSlug(productOrId) {
    const product = typeof productOrId === "object" && productOrId ? productOrId : allProducts().find(item => item.id === productOrId) || {
        id: productOrId,
        name: productOrId
    };
...
async function loadAnalyticsConfig() {
    try {
        ...
        installGa4(gaMeasurementId, {
            enabled: location.hostname === "www.thedonjewelersandjewelrynyc.com"
        });
    }
}
...
function navLinks() {
    const prioritySlugs = new Set([ "start-custom-ring-design", "select-diamond", "cvd-lab-grown-diamond-jewelry", "engagement-rings", "wedding-bands", "diamond-tennis-chains", "diamond-tennis-bracelets", "mens-earrings", "womens-earrings", "custom-jewelry" ]);
...
function desktopNavLinks() {
    return ` <a href="${internalLink("products")}">Fine Jewelry</a> <a href="${categoryUrl("engagement-rings")}">Engagement Rings</a> <a href="${internalLink("select-diamond")}">Live Diamonds</a> <a class="nav-highlight" href="${internalLink("start-custom-ring-design")}">Custom Design</a> `;
}

function globalSearchForm(context = "header") {
    return ` <form class="global-search global-search-${context}" role="search" aria-label="Search jewelry, diamonds, and pages"> <input name="q" type="search" autocomplete="off" placeholder="Search all jewelry & diamonds" aria-label="Search every product, diamond, category, and page"> <button type="submit">Search</button> </form> `;
}

function financingAnnouncement() {
    return ` <aside class="financing-announcement" aria-label="Jewelry financing options"> <span class="financing-pulse" aria-hidden="true"></span> <strong><span class="finance-desktop-copy">$500 first custom-order credit</span><span class="finance-mobile-copy">$500 custom-order credit</span></strong> <span class="finance-desktop-copy">Enter FIRST500 or THEDON15 at checkout. The total stays unchanged until our team verifies the purchase and first-time customer eligibility. Offers cannot stack.</span> <span class="finance-mobile-copy">Eligible $2,500+ orders · Financing available · Terms apply</span> <span class="bnpl-logos" aria-label="Eligible financing providers"><span class="bnpl-logo affirm-logo">affirm</span><span class="bnpl-logo klarna-logo">Klarna.</span><span class="bnpl-logo afterpay-logo">Afterpay</span></span> <a href="${internalLink("jewelry-financing")}">Explore financing</a> </aside> `;
}

function sidebarFinancingCard() {
    return `<div class="sidebar-financing-card"><strong>$500 first custom-order credit</strong><span>Enter FIRST500 or THEDON15 at checkout. No automatic deduction; our team contacts you after purchase to verify eligibility. Offers cannot stack.</span><div class="bnpl-logos" aria-label="Eligible financing providers"><span class="bnpl-logo affirm-logo">affirm</span><span class="bnpl-logo klarna-logo">Klarna.</span><span class="bnpl-logo afterpay-logo">Afterpay</span></div><a href="${internalLink("jewelry-financing")}">Offer & financing details</a></div>`;
}

function shell(main) {
    document.getElementById("app").innerHTML = ` <header class="site-header"> <button class="brand brand-menu-button" type="button" id="sidebar-open" aria-label="Open site menu" aria-controls="site-sidebar" aria-expanded="false"> <span class="brand-mark" aria-hidden="true">TD</span> <span class="brand-copy"><strong>The Don Jewelers & Jewelry</strong><small>Luxury custom jewelry</small></span> <span class="header-menu-cue"><strong>More options</strong><small>Click here</small></span> </button> <nav class="nav-links" aria-label="Primary navigation">${desktopNavLinks()}</nav> ${globalSearchForm("header")} </header> ${financingAnnouncement()} <div class="sidebar-backdrop" id="sidebar-backdrop" hidden></div> <aside class="site-sidebar" id="site-sidebar" aria-label="Site menu" aria-hidden="true"> <div class="sidebar-head"> <span class="sidebar-brand"><span class="brand-mark" aria-hidden="true">TD</span><span><strong>The Don Jewelers & Jewelry</strong><small>Luxury custom jewelry</small></span></span> <button class="sidebar-close" type="button" id="sidebar-close" aria-label="Close site menu">Close</button> </div> ${globalSearchForm("sidebar")} ${sidebarFinancingCard()} <nav class="sidebar-links" aria-label="Sidebar navigation">${navLinks()}</nav> </aside> ${main} ${stickyAppointmentCta()} ${footer()} `;
    wireSidebar();
    wireGlobalSearch();
...
function stickyAppointmentCta() {
    return ` <a class="sticky-appointment-cta" href="${appointmentUrl}" aria-label="Book a private jewelry appointment"> <span>Book Appointment</span> <small>Private jeweler consultation</small> </a> `;
}

function footer() {
    const policyLinks = [ [ "Refund & Return Policy", "refund-return-policy" ], [ "Payment Policy", "payment-policy" ], [ "Shipping Policy", "shipping-policy" ], [ "Custom Order Policy", "custom-order-policy" ], [ "Warranty Policy", "warranty-policy" ], [ "Terms & Conditions", "terms" ], [ "Privacy Policy", "privacy-policy" ], [ "Financing Policy", "financing-policy" ] ];
    return ` <footer class="site-footer"> <div> <strong>The Don Jewelers & Jewelry</strong> <p>Private jeweler for custom jewelry, engagement rings, diamond jewelry, and nationwide shipping.</p> </div> <div class="footer-contact"> <strong>Contact for quotes</strong> <a href="${phoneHref}">${phoneDisplay}</a> <a href="mailto:${contactEmail}">${contactEmail}</a> <span>Serving ${serviceArea}. Call, text, or email before returns, custom approvals, or order questions.</span> </div> <div class="footer-navigation"> <div class="footer-link-group"><strong>Shop & Design</strong> <a href="#/products">Shop Jewelry</a><a href="#/select-diamond">Select a Diamond</a><a href="#/start-custom-ring-design">Build an Engagement Ring</a><a href="${categoryUrl("custom-jewelry")}">Custom Jewelry &amp; Collections</a><a href="${appointmentUrl}">Book Appointment</a> </div> <div class="footer-link-group"><strong>Guidance</strong> <a href="#/ring-size-guide">Ring Size Guide</a><a href="#/diamond-shape-guide">Diamond Shape Guide</a><a href="#/lab-diamonds-vs-natural-diamonds">Lab vs Natural Diamonds</a><a href="#/blog">Jewelry Journal</a><a href="#/request/contact">Contact</a> </div> <div class="footer-link-group"><strong>Trust & Policies</strong> ${policyLinks.map(([label, path]) => `<a href="#/${path}">${label}</a>`).join("")} </div> <div class="footer-link-group"><strong>Follow & Review</strong> <a href="https://www.instagram.com/los_thejeweler/" target="_blank" rel="me noopener noreferrer" aria-label="Follow The Don Jewelers and Jewelry on Instagram at los_thejeweler">Instagram · @los_thejeweler</a><a href="https://www.facebook.com/profile.php?id=100089172553878" target="_blank" rel="me noopener noreferrer" aria-label="Visit The Don Jewelers and Jewelry on Facebook">Facebook · The Don Jewelers &amp; Jewelry</a><a href="${googleBusinessProfileUrl}" target="_blank" rel="noopener noreferrer">Google Business Profile</a><a href="${googleReviewUrl}" target="_blank" rel="noopener noreferrer">Google Reviews</a> </div> <span class="site-version">Private appointments · Secure checkout · Nationwide shipping</span> </div> </footer> `;
}

function trustBlockSection() {
    return ` <section class="trust-block-section" aria-label="Customer protection and buying trust"> <article> <strong>Warranty Review</strong> <p>Manufacturing-defect warranty review is available, with paid repair support when wear, impact, sizing, or outside work is involved.</p> <a href="#/warranty-policy">Warranty Policy</a> </article> <article> <strong>Insured Shipping</strong> <p>Orders ship only after details and payment are confirmed. Timing, carrier, and delivery needs are reviewed before fulfillment.</p> <a href="#/shipping-policy">Shipping Policy</a> </article> <article> <strong>Return Clarity</strong> <p>Ready-made and custom pieces have different rules. Review approval, sizing, and final-sale details before moving forward.</p> <a href="#/refund-return-policy">Return Policy</a> </article> <article> <strong>Secure Payment</strong> <p>Payments run through secure third-party processors with fraud checks, billing verification, and cleared-payment review.</p> <a href="#/payment-policy">Payment Policy</a> </article> <article> <strong>Private Jeweler Process</strong> <p>Consultation, diamond sourcing, CAD review, approval, production, final balance, and insured delivery are handled step by step.</p> <a href="#/custom-order-policy">Custom Order Policy</a> </article> </section> `;
}

function officialGoogleProfileSection() {
    return ` <section class="trust-block-section official-google-profile" aria-label="Official Google Business Profile"> <article> <strong>Official Google Business Profile</strong> <p>Use one verified profile for directions, business details, reviews, and Google search trust signals.</p> <a href="${googleBusinessProfileUrl}" target="_blank" rel="noopener noreferrer">Find us on Google</a> </article> <article> <strong>Reviews</strong> <p>Customer reviews and profile references are routed to the official The Don Jewelers & Jewelry Google profile.</p> <a href="${googleReviewUrl}" target="_blank" rel="noopener noreferrer">Open Google Reviews</a> </article> </section> `;
}
...
function productCard(product) {
    ...
    return ` <article class="product-card"> <a href="${href}" class="product-image-link" aria-label="Customize ${productName(product)}"> <img src="${productImageSrc(product)}" alt="${product.alt || productName(product)}" ${imageSafety}> </a> <div class="product-card-body"> <p class="eyebrow">${product.category}</p> <h3>${productName(product)}</h3> <p class="muted">${startingText(product)}</p> ${productBadges(product)} <div class="card-actions"> <a class="button button-dark" href="${href}">View Details</a> ${priced ? productCheckoutButton(product, numericPrice(product.price), "Buy Now") : requestPriceButton(product)} </div> </div> </article> `;
}

function pageHero(eyebrow, heading, body = "", action = "") {
    return ` <section class="page-hero compact"> <img class="page-hero-logo" src="${asset("don-logo.jpg")}" alt="The Don Jewelers and Jewelry logo"> <p class="eyebrow">${eyebrow}</p> <h1>${heading}</h1> ${body ? `<p class="product-description">${body}</p>` : ""} ${action} </section> `;
}
...
function localBusinessSchema() {
    return {
        ...
        areaServed: locationTargets.map(name => ({
            "@type": "Place",
            name: name
        })),
        contactPoint: [ {
        ...
        makesOffer: primaryKeywords.slice(0, 35).map(name => ({
            "@type": "Offer",
            itemOffered: {
                "@type": "Service",
                name: name
...
function serviceSchema({id: id, title: title, description: description, image: image, keywords: keywords}) {
    return {
        "@context": "https://schema.org",
        "@type": "Service",
...
function policyLinksHtml() {
    return ` <div class="policy-link-grid"> <a href="#/refund-return-policy">Refund & Return Policy</a> <a href="#/payment-policy">Payment Policy</a> <a href="#/shipping-policy">Shipping Policy</a> <a href="#/custom-order-policy">Custom Order Policy</a> <a href="#/warranty-policy">Warranty Policy</a> <a href="#/terms">Terms & Conditions</a> <a href="#/privacy-policy">Privacy Policy</a> <a href="#/financing-policy">Financing Policy</a> </div> `;
}

function aboutUs() {
    return ` <section class="about-us"> <p class="eyebrow">About Us</p> <h2>Made for a better jewelry search</h2> <p> At The Don Jewelers & Jewelry, we are striving to give every client the best experience possible while searching for a piece that feels personal, memorable, and true to them. We work hard to make sure you feel supported from first look to final selection, whether your new jewelry marks a special moment, completes a style, or becomes part of your identity. </p> </section> `;
}

function faqSection(faqs = globalFaqs) {
    return ` <section class="seo-section faq-section"> <div class="section-heading"> <p class="eyebrow">FAQ</p> <h2>Frequently asked questions</h2> </div> <div class="faq-grid"> ${faqs.map(([question, answer]) => ` <article class="faq-item"> <h3><a href="${internalLink(faqPath(slugify(question)))}">${question}</a></h3> <p>${answer}</p> </article> `).join("")} </div> </section> `;
}
...
function relatedProductGrid(keyword = "") {
    ...
    return ` <section class="seo-section"> <div class="section-heading"> <p class="eyebrow">Related Products</p> <h2>Shop related jewelry</h2> </div> <div class="product-grid compact-grid">${list.map(productCard).join("")}</div> </section> `;
}

function categoryRelatedGrid(products = [], title = "Related Jewelry") {
    const list = products.filter(Boolean).slice(0, 4);
    if (!list.length) return "";
    return ` <section class="seo-section"> <div class="section-heading"> <p class="eyebrow">Related Products</p> <h2>${title}</h2> </div> <div class="product-grid compact-grid">${list.map(productCard).join("")}</div> </section> `;
}
...
function relatedCategoryLinks(slugs = [], options = {}) {
    ...
    return ` <section class="seo-section related-links-section"> <div class="section-heading"> <p class="eyebrow">${options.eyebrow || "Related Categories"}</p> <h2>${options.heading || "Continue your jewelry research"}</h2> ${options.body ? `<p>${options.body}</p>` : ""} </div> <div class="policy-link-grid"> ${items.map(([slug, title, description]) => `<a href="${internalLink(slug)}"><strong>${title}</strong><span>${description}</span></a>`).join("")} </div> </section> `;
}
...
function relatedArticleCards(slugs = [], currentSlug = "") {
    const resolve = slug => {
        ...
        if (education) return {
            ...education,
            href: educationPath(education.slug)
        };
    ...
    const picked = slugs.map(resolve).filter(item => item && item.slug !== currentSlug).slice(0, 4);
    const items = picked.length ? picked : educationResources.filter(item => item.slug !== currentSlug).slice(0, 4).map(item => ({
        ...item,
        href: educationPath(item.slug)
    }));
    return ` <section class="seo-section related-article-section"> <div class="section-heading"> <p class="eyebrow">Related Articles</p> <h2>You May Also Like</h2> </div> <div class="article-card-grid"> ${items.map(item => ` <a class="article-resource-card" href="${internalLink(item.href)}"> <img src="${asset(item.image || defaultSeoImage)}" alt="${item.title} jewelry education" ${imageSafety}> <span>${item.eyebrow || item.keyword || "Jewelry Guide"}</span> <strong>${item.title}</strong> <em>${item.description}</em> </a> `).join("")} </div> </section> `;
}

function comparisonTable(rows = []) {
    if (!rows.length) return "";
    const [head, ...body] = rows;
    return ` <div class="resource-table-wrap"> <table class="resource-table"> <thead><tr>${head.map(cell => `<th>${cell}</th>`).join("")}</tr></thead> <tbody>${body.map(row => `<tr>${row.map(cell => `<td>${cell}</td>`).join("")}</tr>`).join("")}</tbody> </table> </div> `;
}

function articleBody(article) {
    return ` <article class="resource-article"> <img class="resource-feature-image" src="${asset(article.image || defaultSeoImage)}" alt="${article.title} by The Don Jewelers & Jewelry" ${imageSafety}> <blockquote>${article.quote}</blockquote> <p class="resource-lede">${article.description}</p> <div class="resource-callout"> <strong>Did you know?</strong> <span>Fine jewelry decisions become easier when you compare the finished look, the material quality, the paperwork, and how the piece will actually be worn.</span> </div> ${article.sections.map(([heading, body]) => ` <section> <h2>${heading}</h2> <p>${body}</p> </section> `).join("")} ${comparisonTable(article.comparison || [])} <section class="tip-grid" aria-label="Jewelry buying tips"> <article> <h3>Buying tip</h3> <p>Ask to compare more than one option. A good decision usually comes from seeing the tradeoffs clearly, not from being pushed toward the first piece.</p> </article> <article> <h3>Expert recommendation</h3> <p>Send inspiration photos, budget, timing, metal preference, and any diamond requirements before the consultation. Better context leads to better sourcing.</p> </article> </section> <div class="article-cta-band"> <div> <p class="eyebrow">Ready for private guidance?</p> <h2>Talk through the piece before you buy.</h2> <p>Whether you are comparing diamonds or planning custom jewelry, The Don Jewelers can help you move from idea to finished piece with a clear plan.</p> </div> <div class="hero-actions"> <a class="button button-gold" href="${internalLink("select-diamond")}">Shop Diamonds</a> <a class="button button-dark" href="${categoryUrl("custom-jewelry")}">Browse Jewelry</a> <a class="button button-light" href="${internalLink("custom-orders")}">Start Custom Project</a> </div> </div> </article> `;
}
...
function resourceArticlePage(article, options = {}) {
    ...
    shell(` <main> ${pageHero(article.eyebrow || "Jewelry Education", article.title, article.description, `<div class="hero-actions"><a class="button button-gold" href="${internalLink("select-diamond")}">Shop Diamonds</a><a class="button button-light" href="${internalLink("custom-orders")}">Schedule an Appointment</a></div>`)} ${articleBody(article)} ${relatedProductGrid(article.productKeyword || article.keyword || article.title)} ${relatedArticleCards(article.related || [], article.slug)} ${faqSection(faqs)} </main> `);
}
...
function faqDetailPage(slug) {
    ...
    const article = {
        ...
        sections: [ [ "The short answer", answer ], [ "What to do next", "If the question affects budget, timing, diamond quality, metal choice, sizing, shipping, or a custom design approval, it is worth discussing before you buy. Clear communication protects both the client and the finished piece." ], [ "How The Don Jewelers handles it", "The process is private and practical: review the goal, compare the realistic options, explain the tradeoffs, and then decide whether a finished piece, sourced diamond, or custom design is the right move." ] ],
...
function nycJewelerStorySection() {
    return ` <section class="seo-section service-story"> <div class="section-heading"> <p class="eyebrow">Private Jewelry Guidance</p> <h2>A calmer way to buy in the Diamond District</h2> <p>Buying fine jewelry should feel thoughtful, not rushed. Bring an idea, a photo, a budget, a diamond question, or even just the feeling you want the piece to carry. From there, each option is organized clearly so you can make a confident decision.</p> </div> <div class="story-grid"> <article> <h3>Start with the idea</h3> <p>We begin with the person, the occasion, the timeline, and the way the jewelry will be worn. Then we refine the important details: diamond size, metal color, setting style, CAD design, or a fully custom concept.</p> </article> <article> <h3>Review real options</h3> <p>You can compare lab grown diamonds, natural diamonds, 14K gold, 18K gold, platinum, and design directions side by side. The goal is to understand the tradeoffs before you spend.</p> </article> <article> <h3>Work locally or nationwide</h3> <p>Clients in New York, New Jersey, Pennsylvania, and the tri-state area can work locally. Nationwide clients can use Zoom, FaceTime, or video chat, with insured shipping available across the United States.</p> </article> </div> </section> `;
}

function buyingGuide(page) {
    const [slug, title, description, image, keywords] = page;
    return ` <section class="seo-section guide-section"> <div class="section-heading"> <p class="eyebrow">Buying Guide</p> <h2>${title} buying guide</h2> </div> <div class="guide-grid"> <article> <h3>Start with purpose and budget</h3> <p>Decide whether the piece is for daily wear, bridal jewelry, a milestone gift, or a statement custom jewelry project. The best budget considers diamond size, gold weight, labor, certification, and whether the piece uses lab grown diamonds or natural diamonds.</p> </article> <article> <h3>Choose diamond and metal details</h3> <p>Compare VVS, VS, color, cut, carat weight, 14K gold, 18K gold, white gold, yellow gold, rose gold, and platinum. For ${title.toLowerCase()}, small changes in stone layout and gold weight can change the final quote.</p> </article> <article> <h3>Use private consultation</h3> <p>A private jeweler can source diamonds, build CAD previews, explain tradeoffs, and make the piece match your style instead of forcing a mass-market design.</p> </article> </div> <p class="seo-copy">${description} Relevant searches include ${keywords.join(", ")} plus ${locationTargets.join(", ")}.</p> </section> `;
}

function customProjectGallerySection() {
    const projects = [ [ "queen-aurelia-oval-marquise-ring.jpeg", "Oval and marquise custom engagement ring" ], [ "custom-dejaun-diamond-name-pendant.jpeg", "Custom diamond name pendant" ], [ "custom-st-diamond-initial-pendant-front.jpeg", "Custom diamond initial pendant" ], [ "yellow-gold-diamond-cuban-link-bracelet.jpeg", "Yellow gold diamond Cuban link bracelet" ], [ "gemstone-leaf-wedding-band-set.jpeg", "Gemstone leaf wedding band set" ], [ "medusa-diamond-signet-ring.jpeg", "Custom diamond signet ring" ] ];
    return ` <section class="seo-section" aria-label="Original custom jewelry projects"> <div class="section-heading"> <p class="eyebrow">Owned Work & Design Inspiration</p> <h2>Custom pieces built around personal specifications</h2> </div> <div class="project-gallery-grid"> ${projects.map(([image, alt]) => `<figure><img src="${asset(image)}" alt="${alt} by The Don Jewelers & Jewelry" ${imageSafety}><figcaption>${alt}</figcaption></figure>`).join("")} </div> <div class="builder-actions"> <a class="button button-gold" href="${internalLink("custom-orders")}">Request a Custom Project</a> <a class="button button-dark" href="${internalLink("request/appointment")}">Book Appointment</a> </div> </section> `;
}
...
function servicePage(slug) {
    ...
    const defaultFaqs = [ [ `Can The Don Jewelers & Jewelry help with ${title.toLowerCase()}?`, `Yes. The Don Jewelers & Jewelry helps clients with ${title.toLowerCase()}, private jeweler consultation, diamond sourcing, custom CAD design, and quote guidance.` ], [ `Do you offer lab grown and natural diamond options?`, "Yes. Lab grown diamonds and natural diamonds can be sourced by shape, carat weight, color, clarity, certification, and budget." ], [ `Do you serve ${regionLabel}?`, `Yes. The service area includes ${locationTargets.join(", ")}.` ], [ `Can I request financing?`, "Jewelry financing may be available through third-party providers, subject to approval and provider terms." ] ];
    const nycFaqs = [ [ "Can The Don Jewelers & Jewelry help with New York's NYC Diamond District jewelry?", "Yes. The Don Jewelers & Jewelry helps clients who want access to NYC Diamond District jewelry, custom engagement rings, diamond sourcing, CAD design, and private jeweler guidance in a more personal setting." ], [ "Do you offer lab grown and natural diamond options?", "Yes. Lab grown diamonds and natural diamonds can be sourced by shape, carat weight, color, clarity, certification, and budget." ], [ "Do you serve New York, Pennsylvania, and nationwide clients?", "Yes. The Don Jewelers & Jewelry primarily serves the tri-state area, including New York, New Jersey, and Pennsylvania, and also works with clients across the United States. Clients outside the area can use Zoom, FaceTime, or video chat, with insured nationwide shipping available." ], [ "Can I request financing?", "Jewelry financing may be available through third-party providers, subject to approval and provider terms." ] ];
    ...
    shell(` <main> ${pageHero("Luxury Private Jeweler", title, description, `<div class="hero-actions"><a class="button button-gold" href="${internalLink("custom-orders")}">Request a Quote</a><a class="button button-light" href="${internalLink("select-diamond")}">Browse Diamonds</a></div>`)} ${id === "free-engagement-ring-consultation" ? consultationOfferSection() : ""} <section class="seo-section split-seo"> <img src="${asset(image)}" alt="${title} by The Don Jewelers & Jewelry for ${regionLabel}" ${imageSafety}> <div> <p class="eyebrow">Private Jewelry Service</p> <h2>${title} for ${regionLabel}</h2> <p>${description}</p> <ul class="service-bullets"> <li>Private consultation before design or sourcing starts.</li> <li>Lab grown and natural diamond options when the piece calls for them.</li> <li>14K, 18K, white gold, yellow gold, rose gold, and platinum options by quote.</li> </ul> </div> </section> ${id === "jewelry-financing" ? financingGuideSection() : ""} ${id === "custom-jewelry-project-gallery" ? customProjectGallerySection() : ""} ${id === "nyc-diamond-district-jeweler" ? nycJewelerStorySection() : ""} ${id === "nyc-diamond-district-jeweler" ? "" : relatedProductGrid(keywords.join(" "))} ${relatedCategoryLinks(related, relatedOptions)} ${faqSection(faqs)} </main> `);
}

function financingGuideSection() {
    const guide = educationResources.find(item => item.slug === "jewelry-financing");
    return ` <section class="seo-section financing-guide-section" aria-labelledby="financing-guide-title"> <div class="financing-provider-panel"> <span class="promo-code-chip">15% OFF · THEDON15</span> <div class="bnpl-logos" aria-label="Eligible Buy Now, Pay Later providers"><span class="bnpl-logo affirm-logo">affirm</span><span class="bnpl-logo klarna-logo">Klarna.</span><span class="bnpl-logo afterpay-logo">Afterpay</span></div> <p>Subject to provider eligibility and approval. Terms are displayed before acceptance in secure Stripe Checkout.</p> </div> <div class="section-heading"> <p class="eyebrow">Financing Guide</p> <h2 id="financing-guide-title">Understand every step before you apply</h2> <p>Compare the possible providers, read the approval disclosures, and know how payments, returns, discounts, and custom orders work.</p> </div> <div class="trust-block-section"> ${(guide?.sections || []).map(([heading, body]) => `<article><strong>${htmlSafe(heading)}</strong><p>${htmlSafe(body)}</p></article>`).join("")} </div> <div class="builder-actions"><a class="button button-gold" href="${internalLink("products")}">Shop Eligible Jewelry</a><a class="button button-dark" href="${internalLink("request/appointment")}">Ask About Financing</a><a class="button button-light" href="${phoneHref}">Call ${phoneDisplay}</a></div> </section> `;
}

function firstCustomOrderCreditSection() {
    return ` <section class="seo-section first-custom-credit" aria-labelledby="first-custom-credit-title"> <div><p class="eyebrow">New Client Custom Design Perk</p><h2 id="first-custom-credit-title">Receive a $500 credit on your first eligible custom order</h2><p>Available to first-time customers on an eligible custom jewelry order totaling $2,500 or more. Mention the offer in your design request; enter FIRST500 at checkout. The total is not reduced automatically; someone from our team will contact you after purchase to verify the purchase and first-time customer eligibility.</p></div> <dl class="credit-terms"><div><dt>Credit</dt><dd>$500</dd></div><div><dt>Minimum order</dt><dd>$2,500</dd></div><div><dt>Who qualifies</dt><dd>New customers · first eligible custom order</dd></div><div><dt>Combining offers</dt><dd>Promotions cannot stack; choose this credit or THEDON15</dd></div></dl> <div class="builder-actions"><a class="button button-gold" href="${internalLink("custom-orders?offer=first-custom-500")}">Claim in Custom Design Request</a><a class="button button-light" href="${phoneHref}">Call ${phoneDisplay}</a></div> </section>`;
}

function consultationOfferSection() {
    return ` <section class="seo-section"> <p class="eyebrow">Free Buyer Help</p> <h2>Get clear on diamond size, budget, setting style, and next steps before you spend.</h2> <div class="guide-grid"> <article> <h3>Compare lab vs natural diamonds</h3> <p>Review size, certification, color, clarity, cut, and price tradeoffs before choosing a center stone.</p> </article> <article> <h3>Plan a realistic ring budget</h3> <p>Talk through metal, carat size, diamond quality, financing, and timeline so the quote matches the goal.</p> </article> <article> <h3>Start a custom CAD direction</h3> <p>Bring inspiration photos and get guidance on what can be built, changed, upgraded, or simplified.</p> </article> </div> <div class="hero-actions"> <a class="button button-gold" href="${internalLink("request/contact?intent=free-engagement-ring-consultation")}">Request Free Consultation</a> <a class="button button-light" href="${phoneHref}">Call or Text ${phoneDisplay}</a> </div> </section> `;
}
...
function blogIndex() {
    ...
    shell(` <main> ${pageHero("Jewelry Knowledge Center", "Diamond education and buying guides", "Learn how to buy engagement rings, diamond tennis chains, tennis bracelets, gold jewelry, custom pendants, lab grown diamonds, natural diamonds, watches, and custom jewelry.")} <section class="seo-section related-article-section"> <div class="section-heading"> <p class="eyebrow">Start Here</p> <h2>Core jewelry and diamond guides</h2> <p>These pages are written to help you understand the language of diamonds and fine jewelry before you request a quote, schedule an appointment, or start a custom project.</p> </div> <div class="article-card-grid"> ${educationResources.map(article => ` <a class="article-resource-card" href="${internalLink(educationPath(article.slug))}"> <img src="${asset(article.image || defaultSeoImage)}" alt="${article.title} education guide" ${imageSafety}> <span>${article.eyebrow}</span> <strong>${article.title}</strong> <em>${article.description}</em> </a> `).join("")} </div> </section> <section class="blog-grid"> ${serverSeoArticles.map(article => ` <article class="blog-card"> <img src="${asset(article.image)}" alt="${article.title}" ${imageSafety}> <div><p class="eyebrow">Original Buying Guide</p><h2><a href="/blog/${article.slug}" data-hard-navigation="true">${article.title}</a></h2><p>${article.description}</p></div> </article> `).join("")} ${blogArticles.map(article => ` <article class="blog-card"> <img src="${asset(article.image)}" alt="${article.title} jewelry guide" ${imageSafety}> <div> <p class="eyebrow">${article.keyword}</p> <h2><a href="${internalLink(`blog/${article.slug}`)}">${article.title}</a></h2> <p>${article.description}</p> </div> </article> `).join("")} </section> </main> `);
}
...
function customOrderBand() {
    return ` <section class="custom-order-band"> <div> <p class="eyebrow">Custom Orders</p> <h2>Looking for something 1-of-1?</h2> <p>Message us for custom designs, custom stone sizes, custom shapes, and full custom jewelry projects. For quotes or additional questions, call or text ${phoneDisplay} or email ${contactEmail}.</p> </div> <div class="custom-order-actions"> <a class="button button-gold" href="#/custom-orders">Start Custom Order</a> <a class="button button-light" href="#/custom-orders">Message Us for Custom Design</a> <a class="button button-dark" href="#/request/contact">General Contact</a> </div> </section> `;
}
...
function googleReviewsSection() {
    ...
    const card = review => ` <article class="google-review-card"> <p class="review-stars" aria-label="${review.rating} out of 5 stars">★★★★★</p> <blockquote>“${htmlSafe(review.text)}”</blockquote> <p><strong>${htmlSafe(review.name)}</strong><span>${htmlSafe(review.profile)} · Verified on Google</span></p> </article>`;
    return ` <section class="section google-reviews-section" aria-labelledby="google-reviews-title"> <div class="section-heading review-summary-heading"> <div> <p class="eyebrow">Verified Google Reviews</p> <h2 id="google-reviews-title">Rated 5.0 by clients</h2> <p>All nine public reviews currently displayed across both verified Google Business Profile links.</p> </div> <div class="google-profile-actions"> <a class="button button-light" href="${googleReviewUrl}" target="_blank" rel="noopener noreferrer">Google profile · 5 reviews</a> <a class="button button-light" href="${googleBusinessProfileUrlSecondary}" target="_blank" rel="noopener noreferrer">Google profile · 4 reviews</a> <a class="button button-dark" href="${phoneHref}">Call ${phoneDisplay}</a> </div> </div> <article class="google-review-feature"> <div class="review-feature-media"> <p class="review-featured-label">Featured client story</p> <div class="review-photo-gallery" aria-label="Photos shared with ${htmlSafe(featured.name)}'s Google review">${featured.photos.map(photo => `<a href="${htmlSafe(photo.src)}" target="_blank" rel="noopener" aria-label="View full-size review photo"><img src="${htmlSafe(photo.src)}" alt="${htmlSafe(photo.alt)}" width="320" height="320" loading="lazy" decoding="async"></a>`).join("")}</div> </div> <div class="review-feature-copy"> <p class="review-stars" aria-label="${featured.rating} out of 5 stars">★★★★★</p> <blockquote>“${htmlSafe(featured.text)}”</blockquote> <p><strong>${htmlSafe(featured.name)}</strong><span>${htmlSafe(featured.profile)} · Verified on Google</span></p> </div> </article> <div class="review-carousel-controls" aria-label="Review carousel controls"> <button type="button" aria-label="Previous reviews" onclick="this.parentElement.nextElementSibling.scrollBy({left:-420,behavior:'smooth'})">&#8592;</button> <span>Swipe or use the arrows to read all 9</span> <button type="button" aria-label="Next reviews" onclick="this.parentElement.nextElementSibling.scrollBy({left:420,behavior:'smooth'})">&#8594;</button> </div> <div class="google-review-carousel" aria-label="Google client reviews"> ${remaining.map(card).join("")} </div> </section> `;
}
...
function home() {
    ...
    shell(` <main> <section class="hero"> <a class="hero-media" href="${productUrl(heroProduct)}" aria-label="View ${productName(heroProduct)}"> <picture><source type="image/webp" srcset="/queen-aurelia-hero-480.webp 480w, /queen-aurelia-hero-768.webp 768w, /queen-aurelia-hero-1200.webp 1200w" sizes="100vw"><img src="${productImageSrc(heroProduct)}" loading="eager" fetchpriority="high" decoding="sync" width="899" height="1600" alt="${heroProduct.alt || productName(heroProduct)}" onerror="this.onerror=null;this.src='${asset(fallbackImage)}';"></picture> </a> <div class="hero-content"> <p class="eyebrow">Private jeweler · NYC Diamond District access</p> <h1>Luxury custom jewelry. Made personal.</h1> <p>Designed for you. Built to last. Custom engagement rings, GIA and IGI certified diamond options, and one-to-one guidance from design through delivery.</p> <div class="hero-actions"> <a class="button button-gold" href="${internalLink("start-custom-ring-design")}">Start Your Custom Design</a> <a class="button button-ghost" href="${internalLink("select-diamond")}">View Live Diamonds</a> </div> <div class="hero-trust-strip" aria-label="Why clients choose The Don Jewelers"> <span><strong>GIA & IGI</strong> certified options</span> <span><strong>Insured</strong> nationwide shipping</span> <span><strong>Financing</strong> for eligible buyers</span> <span><strong>Lifetime</strong> craftsmanship support</span> </div> <a class="hero-review-preview" href="#google-reviews-title" aria-label="Read verified Google reviews"> <span class="review-stars" aria-hidden="true">★★★★★</span> <span><strong>“Carlos is a 10/10 guy.”</strong><small>Matthew Haddad · Verified on Google</small></span> <em>Read all 9 reviews →</em> </a> <div class="hero-assurance-links"><a href="${internalLink("shipping-policy")}">Insured shipping</a><a href="${internalLink("warranty-policy")}">Craftsmanship support</a><a href="${internalLink("refund-return-policy")}">Return policy</a><span>Secure Stripe checkout</span></div> </div> </section> <section class="section engagement-feature"> <div> <p class="eyebrow">Engagement Rings</p> <h2>Start with the ring</h2> <p>Select diamond size, stone shape, color, clarity, metal, and exact ring size. Built for serious buyers who want a clear luxury quote before moving forward.</p> <div class="hero-actions"> <a class="button button-gold" href="${internalLink("start-custom-ring-design")}">Start Your Custom Ring Design</a> <a class="button button-light" href="${categoryUrl("engagement-rings")}">View Engagement Rings</a> </div> </div> <div class="ring-showcase desktop-ring-showcase" aria-label="Featured engagement rings"> ${[ "queen-aurelia-oval-marquise-ring", "pink-oval-engagement-ring" ].map(id => productCard(allProducts().find(product => product.id === id))).join("")} </div> <div class="ring-showcase ring-preview-showcase mobile-ring-showcase" aria-label="Featured engagement ring designs"> ${[ [ "queen-aurelia-oval-marquise-ring", "Queen Aurelia", "Oval & marquise signature", false ], [ "pink-oval-engagement-ring", "Monarch Pink", "Pink oval design", false ], [ "yellow-oval-diamond-ring", "Monarch Canary", "Yellow oval design", false ], [ "marquise-crown-diamond-engagement-ring", "Marquise Crown", "Sculptural marquise design", true ], [ "k24b-marquise-diamond-engagement-ring", "La Marquesa K24B", "Marquise with graduated accents", true ], [ "radiant-pave-diamond-engagement-ring", "Reina Luz", "Radiant center & pavé band", true ] ].map(([id, name, detail, desktopOnly]) => {
    ...
    }).join("")} </div> </section> ${customCollectionHomeSection()} <section class="home-category-section"> <div class="home-category-heading"> <p class="eyebrow">Shop the Collection</p> <h2>Find Your Piece</h2> </div> <div class="collection-grid home-category-image-carousel"> ${categories.slice(0, 6).map(([slug, name, image]) => {
        const mobileFriendlyName = slug === "start-custom-ring-design" ? "Custom Ring Design" : slug === "select-diamond" ? "Live Diamonds" : name;
        return ` <a class="collection-tile" href="${[ "custom-orders", "select-diamond", "start-custom-ring-design" ].includes(slug) ? internalLink(slug) : categoryUrl(slug)}"> <img src="${mediaSrc(image)}" alt="${name}" ${imageSafety}> <span>${mobileFriendlyName}</span> </a> `;
    }).join("")} </div> <div class="hero-actions collection-more-action"><a class="button button-light" href="${internalLink("products")}">Browse All Jewelry Categories</a></div> </section> ${customOrderBand()} <section class="section authority-proof" aria-labelledby="authority-proof-title"> <div class="section-heading"><p class="eyebrow">Experience you can verify</p><h2 id="authority-proof-title">Real projects, clear guidance, documented buyer protection</h2><p>Review completed custom work, learn how diamonds and custom orders are evaluated, and confirm the policies that apply before payment.</p></div> <div class="trust-block-section"> <article><strong>Original project gallery</strong><p>See custom jewelry examples and the design details behind one-of-one client work.</p><a href="${internalLink("custom-jewelry-project-gallery")}">View custom projects</a></article> <article><strong>Diamond education</strong><p>Compare certification, cut, color, clarity, lab-grown and natural diamond options before choosing a stone.</p><a href="${internalLink("diamond-education")}">Read diamond guides</a></article> <article><strong>Transparent policies</strong><p>Review shipping, warranty, returns, financing and custom-order approval terms before moving forward.</p><a href="${internalLink("custom-order-policy")}">Review buyer protections</a></article> </div> </section> ${trustBlockSection()} ${googleReviewsSection()} ${relatedCategoryLinks([ "custom-engagement-rings", "diamond-tennis-chains", "custom-jewelry" ])} ${faqSection(globalFaqs.slice(0, 4))} <section class="trust-band" aria-label="Trust badges"> <div><strong>Secure browsing</strong><span>Checkout handoff ready</span></div> <div><strong>Curated luxury pieces</strong><span>Custom options on every item</span></div> <div><strong>Custom sizing</strong><span>Sizes tailored by item type</span></div> </section> ${aboutUs()} </main> `);
}
...
function productGrid(list, title, body = "", action = "", afterGrid = "", gridId = "", seoOptions = {}) {
    ...
    shell(` <main> ${pageHero("Jewelry Marketplace", title, body, action)} ${productFilterPanel()} <section class="product-grid" ${gridId ? `id="${gridId}"` : ""}>${list.map(productCard).join("")}</section> ${trustBlockSection()} ${afterGrid} </main> `);
    wireProductFilterPanel();
}

function productFilterPanel() {
    return ` <section class="product-filter-panel" aria-label="Product filters"> <label>Search <input id="product-filter-search" type="search" placeholder="Oval ring, Cuban chain, pendant"> </label> <label>Max price <select id="product-filter-price"> <option value="">Any price</option> <option value="1000">Under $1,000</option> <option value="2500">Under $2,500</option> <option value="5000">Under $5,000</option> <option value="10000">Under $10,000</option> </select> </label> <label>Metal / color <select id="product-filter-metal"> <option value="">Any metal</option> <option>Yellow Gold</option> <option>White Gold</option> <option>Rose Gold</option> <option>Platinum</option> <option>Silver</option> </select> </label> <label>Diamond type <select id="product-filter-diamond"> <option value="">Any diamond</option> <option>Lab</option> <option>Natural</option> <option>VVS</option> <option>VS</option> </select> </label> <button class="button button-light" type="button" id="product-filter-reset">Reset</button> </section> `;
}
...
function productSearchHaystack(product) {
    return [ productName(product), product.category, product.priceLabel, product.description, product.lede, product.alt, product.badges, product.fields, product.specs ].map(searchText).join(" ").toLowerCase();
}
...
function searchPage(params = new URLSearchParams) {
    ...
    const productMatches = normalized ? allProducts().filter(product => productSearchHaystack(product).includes(normalized)).slice(0, 36) : [];
    const categoryMatches = normalized ? categories.filter(item => categorySearchHaystack(item).includes(normalized)).slice(0, 12) : [];
    const serviceMatches = normalized ? servicePages.filter(item => serviceSearchHaystack(item).includes(normalized)).slice(0, 12) : [];
    ...
    shell(` <main> ${pageHero("Search", q ? `Search results for "${htmlSafe(q)}"` : "Search the website", "Find engagement rings, loose diamonds, custom jewelry, product pages, guides, and quote request options.", ` <form class="search-page-form global-search" role="search" aria-label="Search the website"> <input name="q" type="search" value="${htmlSafe(q)}" placeholder="Search engagement rings, diamond pendants, chains..." aria-label="Search the website"> <button class="button button-gold" type="submit">Search</button> </form> `)} <section class="search-results-section"> <div class="section-heading"> <p class="eyebrow">Product Results</p> <h2>${productMatches.length ? `${productMatches.length} product matches` : "No direct product matches yet"}</h2> </div> <div class="product-grid">${productMatches.length ? productMatches.map(productCard).join("") : `<div class="empty-state">Try a broader term like "oval", "engagement ring", "pendant", "Cuban", or submit a request and we will source it.</div>`}</div> </section> <section class="search-results-section"> <div class="section-heading"> <p class="eyebrow">Marketplace & Supplier Results</p> <h2>Matching jewelry from the full catalog</h2> </div> <div class="product-grid" id="search-api-results"> ${q ? Array.from({
        length: 4
    }, () => `<div class="product-card product-skeleton" aria-hidden="true"></div>`).join("") : `<div class="empty-state">Search by item type, diamond shape, metal, stock number, or style.</div>`} </div> </section> <section class="search-results-section"> <div class="section-heading"> <p class="eyebrow">Live Diamond Results</p> <h2>Matching CVD diamond inventory</h2> </div> <div class="diamond-inventory-grid" id="search-diamond-results"> ${q ? Array.from({
        length: 3
    }, () => `<div class="product-card product-skeleton" aria-hidden="true"></div>`).join("") : `<div class="empty-state">Search by diamond shape, carat, color, clarity, stock number, or IGI report.</div>`} </div> </section> <section class="search-results-section"> <div class="section-heading"> <p class="eyebrow">Pages & Categories</p> <h2>Related places to continue</h2> </div> <div class="search-link-grid"> ${categoryMatches.map(([slug, name, image]) => `<a href="${[ "custom-orders", "select-diamond", "start-custom-ring-design" ].includes(slug) ? internalLink(slug) : categoryUrl(slug)}"><img src="${mediaSrc(image)}" alt="${htmlSafe(name)}" ${imageSafety}><span>${htmlSafe(name)}</span></a>`).join("")} ${serviceMatches.map(([slug, title, description]) => `<a href="${internalLink(slug)}"><strong>${htmlSafe(title)}</strong><small>${htmlSafe(description)}</small></a>`).join("")} <a href="${internalLink("select-diamond")}"><strong>Live Diamond Selection</strong><small>Search certified diamonds and request sourcing.</small></a> <a href="${internalLink("start-custom-ring-design")}"><strong>Start Custom Ring Design</strong><small>Send engagement ring options, budget, and inspiration.</small></a> <a href="${internalLink("request/contact?intent=website-search-help")}"><strong>Request Help Finding It</strong><small>Send us what you are looking for and we will reply.</small></a> </div> </section> </main> `);
...
async function wireSearchApiResults(query, localMatchIds = []) {
    ...
    try {
        ...
        grid.innerHTML = items.length ? items.map((item, index) => savedProductCard(item, index)).join("") : `<div class="empty-state">No additional catalog items matched. Try "lab diamond", "bracelet", "pendant", "ring", "gold", or request help finding it.</div>`;
    } catch {
...
function diamondSearchHaystack(diamond) {
    return [ diamond.id, diamond.stockNumber, diamond.reportNumber, diamond.shape, diamond.carat, diamond.color, diamond.clarity, diamond.cut, diamond.polish, diamond.symmetry, diamond.certificate, diamond.lab, diamond.growthMethod, diamond.diamondType ].map(searchText).join(" ").toLowerCase();
}
...
function searchDiamondResultCard(diamond) {
    ...
    return ` <article class="diamond-inventory-card"> ${imageUrl ? `<a href="${href}" aria-label="View ${htmlSafe(label)}"><img class="diamond-inventory-image" src="${htmlSafe(imageUrl)}" alt="${htmlSafe(label)}" loading="lazy"></a>` : ""} <div> <p class="eyebrow">${htmlSafe(diamond.diamondType || "Live CVD Diamond")}</p> <h3><a href="${href}">${htmlSafe(label)}</a></h3> <p class="muted">${htmlSafe(diamondSpecs(diamond))}</p> ${diamond.stockNumber ? `<p class="diamond-report-pill">Stock # ${htmlSafe(diamond.stockNumber)}</p>` : ""} ${diamond.reportNumber ? `<p class="diamond-report-pill">IGI Report # ${htmlSafe(diamond.reportNumber)}</p>` : ""} ${price ? `<p class="product-price">${htmlSafe(money.format(price))}</p>` : ""} </div> <div class="builder-actions"> <a class="button button-light" href="${href}">View Details</a> <a class="button button-gold" href="#/request/product?product=${encodeURIComponent(label)}&category=Live%20Diamond%20Selection&intent=search-result">Request This Diamond</a> </div> </article> `;
}
...
async function wireSearchDiamondResults(query) {
    ...
    try {
        ...
        const results = await Promise.allSettled(endpoints.map(async endpoint => {
            const response = await fetchWithTimeout(endpoint, {}, 2e4);
            const payload = await response.json();
        ...
        const diamonds = results.flatMap(result => result.status === "fulfilled" ? result.value : []).filter(diamond => diamondSearchHaystack(diamond).includes(normalized)).slice(0, 12);
        grid.innerHTML = diamonds.length ? diamonds.map(searchDiamondResultCard).join("") : `<div class="empty-state">No live diamonds matched that search. Try a shape like "oval" or "round", or request help sourcing a diamond.</div>`;
    } catch {
...
function wireProductFilterPanel() {
    ...
    const apply = () => {
        ...
        cards.forEach(card => {
            ...
            const visible = (!q || text.includes(q)) && (!max || !cardPrice || cardPrice <= max) && (!metalValue || text.includes(metalValue)) && (!diamondValue || text.includes(diamondValue));
            card.hidden = !visible;
        });
    };
...
const braceletFeaturedIds = [ "ever-band", "lgd-jewelry-TJ6417TBC", "lgd-jewelry-LGD3645BFC", "lgd-jewelry-LGD3624BFC", "lgd-jewelry-LGD3602BFC" ];

const chainDisplayImagePool = [ "yellow-gold-cuban-chain-display.jpeg", "yellow-gold-cuban-link-chain.jpeg", "yellow-gold-rope-chain-triple.jpeg", "yellow-gold-layered-figaro-chain.jpeg", "yellow-gold-rope-chain-flat.jpeg", "silver-cross-chain.png", "triple-row-diamond-tennis-bracelet.jpeg" ];
...
function databaseCategoryPage(slug, label) {
    ...
    const fallbackProducts = slug === "all" ? allProducts() : slug === "cvd-lab-grown-diamond-jewelry" ? allProducts().filter(product => !/^Custom Jewelry/i.test(product.category || "") && (product.source === "lgd-jewelry" || /lab|cvd|grown/i.test(productSearchHaystack(product)))) : allProducts().filter(product => !label || productMatchesCategory(product, label));
    ...
    shell(` <main> ${pageHero("Jewelry Marketplace", `Shop ${htmlSafe(label || "Jewelry")} with The Don`)} <section class="catalog-toolbar"> <label>Sort products <select id="category-sort"> <option value="price-asc">Price: Low to High</option> <option value="price-desc">Price: High to Low</option> </select> </label> </section> <section class="product-grid" id="database-product-grid"> ${Array.from({
        length: 8
    }, () => `<div class="product-card product-skeleton" aria-hidden="true"></div>`).join("")} </section> <div class="inventory-pagination" id="database-product-pagination"></div> </main> `);
...
function wireDatabaseCategory({category: category, source: source, featured: featured, fallbackProducts: fallbackProducts = []}) {
    ...
    const load = async () => {
        try {
            ...
            if (source) items = items.filter(item => item.source === source && !/^Custom Jewelry/i.test(item.category || ""));
            ...
            grid.innerHTML = items.length ? items.map((item, index) => savedProductCard(item, index)).join("") : `<div class="empty-state">Products are temporarily unavailable. Please refresh or contact us for assistance.</div>`;
...
function category(slug) {
    ...
    const categoryLabels = {
        ...
        grillz: "Grillz",
        watches: "Watches",
        "custom-jewelry": "Custom Jewelry & Collections",
    ...
    const catalogControls = liveCategory ? ` <div class="catalog-feed-controls"> <div class="diamond-api-note" id="catalog-feed-note" hidden></div> <div class="inventory-pagination" id="catalog-feed-pagination"></div> </div> ` : "";
    productGrid(slug === "engagement-rings" ? engagementFirst(list) : list, names[slug] || `Shop ${label || "All Luxury Jewelry"} with The Don`, body, action, `${catalogControls}${categoryRelatedGrid(relatedProducts, "More jewelry you may like")}`, liveCategory ? "category-product-grid" : "", {
        path: categoryUrl(slug),
        related: [ "custom-jewelry", "jewelry-financing", "diamond-education" ]
    });
...
function catalogFeedProductCard(product) {
    ...
    const href = catalogProductUrl({
        ...product,
        id: `lgd-jewelry-${product.stockNumber}`,
        externalId: product.stockNumber
    });
    return ` <article class="product-card" data-catalog-feed-product> <a href="${href}" class="product-image-link" aria-label="View ${htmlSafe(product.name)}"> ${imageUrl ? `<img src="${htmlSafe(imageUrl)}" alt="${htmlSafe(product.name)}" loading="lazy">` : `<div class="product-image-placeholder">Diamond Jewelry</div>`} </a> <div class="product-card-body"> <p class="eyebrow">${htmlSafe(product.category)}</p> <h3>${htmlSafe(product.name)}</h3> <p class="muted">${htmlSafe(product.metal || "")}${product.diamondWeight ? ` · ${htmlSafe(product.diamondWeight)} ct total diamond weight` : ""}</p> <p class="muted">${price > 0 ? money.format(price) : "Request Pricing"}</p> <div class="card-actions"> <a class="button button-dark" href="${href}">View Details</a> <a class="button button-gold" href="#/request/product?product=${encodeURIComponent(product.name)}&category=${encodeURIComponent(product.category)}&intent=product-inquiry">Request Purchase</a> </div> </div> </article> `;
}
...
async function loadCatalogFeed(categoryName, page = 1) {
    ...
    try {
        ...
        note.hidden = true;
        pagination.innerHTML = ` <button class="button button-light" type="button" data-catalog-page="${Math.max(1, payload.page - 1)}" ${payload.page <= 1 ? "disabled" : ""}>Previous</button> <span>Page ${payload.page} of ${payload.totalPages}</span> <button class="button button-light" type="button" data-catalog-page="${Math.min(payload.totalPages, payload.page + 1)}" ${payload.page >= payload.totalPages ? "disabled" : ""}>Next</button> `;
    } catch {
        note.hidden = true;
        pagination.innerHTML = "";
    }
...
function wireCatalogFeed(categoryName) {
    document.getElementById("catalog-feed-pagination")?.addEventListener("click", event => {
        ...
        document.getElementById("category-product-grid")?.scrollIntoView({
            behavior: "smooth",
            block: "start"
        });
    });
...
function productSpecRows(product) {
    ...
    const rows = [ [ "Metal", specs.metal ], [ "Diamond Type", specs.diamondType || "CVD Lab-Grown Diamond" ], [ "Carat Weight", specs.caratWeight ? `${specs.caratWeight} CTW` : "" ], [ "Color", specs.color ], [ "Clarity", specs.clarity ], [ "Size / Length", specs.size ], [ "Diamond Shape", specs.shape ], [ "Availability", product.availability || specs.availability ] ].filter(([, value]) => value !== undefined && value !== null && String(value).trim() !== "");
...
function supplierLuxuryDescription(product) {
    ...
    const diamondDetails = [ metadata.diamondPieces ? `${metadata.diamondPieces} diamond${Number(metadata.diamondPieces) === 1 ? "" : "s"}` : "", specs.caratWeight ? `approximately ${specs.caratWeight} total carat weight` : "", specs.shape ? `${specs.shape} shape` : "", specs.color ? `${specs.color} color` : "", specs.clarity ? `${specs.clarity} clarity` : "" ].filter(Boolean);
...
async function catalogJewelryDetail(productId) {
    shell(` <main> ${pageHero("Diamond Jewelry", "Loading product details")} <section class="catalog-detail-shell" id="catalog-jewelry-detail"><div class="diamond-api-note">Loading product...</div></section> ${aboutUs()} </main> `);
    ...
    try {
        ...
        container.innerHTML = ` <section class="product-detail-hero catalog-jewelry-detail supplier-product-hero"> <div class="product-media-stack"> ${imageUrl ? `<img src="${htmlSafe(imageUrl)}" alt="${htmlSafe(product.name)}">` : `<div class="product-image-placeholder">Diamond Jewelry</div>`} ${gallery.map(url => `<img src="${htmlSafe(url)}" alt="${htmlSafe(product.name)} alternate view" loading="lazy">`).join("")} </div> <div> <p class="eyebrow">${htmlSafe(product.category)}</p> <h1>${htmlSafe(product.name)}</h1> <p class="product-detail-price">${price ? money.format(price) : "Request Pricing"}</p> <p class="supplier-product-intro">CVD lab-grown diamond jewelry with complete specifications and secure purchase support.</p> <div class="builder-actions"> ${price && product.available !== false ? productCheckoutButton(product, price) : `<button class="button button-light" type="button" disabled>Unavailable or pricing required</button>`} <a class="button button-dark" href="#/request/product?product=${encodeURIComponent(product.name)}&category=${encodeURIComponent(product.category)}&intent=product-${encodeURIComponent(product.id)}">Ask a Question</a> ${videoUrl ? `<a class="button button-light" href="${htmlSafe(videoUrl)}" target="_blank" rel="noopener noreferrer">View Product Video</a>` : ""} </div> </div> </section> <section class="supplier-product-information"> <article class="supplier-description-card"> <p class="eyebrow">Product Description</p> <h2>${htmlSafe(product.name)}</h2> <p>${htmlSafe(supplierLuxuryDescription(product))}</p> </article> <article class="supplier-specification-card"> <p class="eyebrow">Complete Details</p> <h2>Product Specifications</h2> <dl class="summary-list product-spec-list">${productSpecRows(product)}</dl> </article> <p class="shipping-note supplier-shipping-note">${product.madeToOrder ? "Made to order. Production and insured shipping timing are confirmed after purchase." : "Availability and insured shipping timing are confirmed before fulfillment."}</p> </section> `;
    } catch {
...
function diamondSpecs(diamond) {
    return [ diamond.stockNumber ? `Stock ${diamond.stockNumber}` : "", diamond.shape, diamond.carat ? `${diamond.carat} ct` : "", diamond.color ? `${diamond.color} color` : "", diamond.clarity, diamond.cut, diamond.polish ? `Polish ${diamond.polish}` : "", diamond.symmetry ? `Symmetry ${diamond.symmetry}` : "", diamond.certificate ? `${diamond.certificate} certified` : "", diamond.reportNumber ? `Report ${diamond.reportNumber}` : "", diamond.growthMethod || "CVD", diamond.price ? `Price ${diamond.price}` : "", diamond.diamondType ].filter(Boolean).join(" | ");
}
...
function diamondMediaLinks(diamond) {
    ...
    const directLinks = [ [ "View Diamond Photo", diamond.imageUrl || diamond.mediaUrl, "image" ], [ "View IGI Report", diamond.reportUrl, "report" ] ];
    const seen = new Set;
    ...
    return links.length ? `<div class="diamond-media-links">${links.map(([label, url, type]) => `<a class="button button-light" href="${htmlSafe(url)}" target="_blank" rel="noopener noreferrer" data-diamond-media-link="${htmlSafe(url)}" data-media-type="${htmlSafe(type || "media")}">${htmlSafe(label)}</a>`).join("")}</div>` : `<p class="quote-note">Vendor image and grading report links will show here when provided by the live API feed.</p>`;
}

function showDiamondMediaModal({url: url, type: type = "media", label: label = "Diamond media"}) {
    const safeUrl = safeExternalUrl(url);
    if (!safeUrl) return;
    ...
    const media = isImage ? `<img class="diamond-media-preview-image" src="${htmlSafe(safeUrl)}" alt="${htmlSafe(label)}">` : `<iframe class="diamond-media-preview-frame" src="${htmlSafe(safeUrl)}" title="${htmlSafe(label)}"></iframe>`;
    modal.innerHTML = ` <div class="diamond-media-dialog" role="dialog" aria-modal="true" aria-label="${htmlSafe(label)}"> <button class="natural-diamond-close" type="button" aria-label="Close media preview">Close</button> <p class="eyebrow">Live Diamond Media</p> <h2>${htmlSafe(label)}</h2> ${type === "report" && reportNumber ? `<p class="diamond-report-number">IGI Report Number: <strong>${htmlSafe(reportNumber)}</strong></p>` : ""} <div class="diamond-media-preview">${media}</div> <p class="quote-note">If the vendor blocks the preview, open the original vendor link below.</p> <div class="builder-actions"> <a class="button button-gold" href="${htmlSafe(safeUrl)}" target="_blank" rel="noopener">Open Original Link</a> <a class="button button-light" href="${htmlSafe(safeUrl)}" target="_blank" rel="noopener noreferrer">Open in New Tab</a> </div> </div> `;
...
function diamondInventoryCard(diamond) {
    const imageUrl = safeExternalUrl(diamond.imageUrl || diamond.mediaUrl);
    const href = liveDiamondUrl(diamond);
    return ` <article class="diamond-inventory-card" data-diamond-id="${htmlSafe(diamond.id)}" data-stock-number="${htmlSafe(diamond.stockNumber || diamond.id || "")}" data-shape="${htmlSafe(diamond.shape)}" data-carat="${htmlSafe(diamond.carat || "")}" data-color="${htmlSafe(diamond.color)}" data-clarity="${htmlSafe(diamond.clarity)}" data-certificate="${htmlSafe(diamond.certificate)}" data-report-number="${htmlSafe(diamond.reportNumber || "")}" data-price="${htmlSafe(diamond.price || "")}" data-diamond-type="${htmlSafe(diamond.diamondType || "")}" data-growth-method="${htmlSafe(diamond.growthMethod || "CVD")}"> ${imageUrl ? `<a href="${href}" aria-label="View ${htmlSafe(`${diamond.shape || "Lab-grown"} diamond ${diamond.reportNumber || diamond.stockNumber || ""}`)}"><img class="diamond-inventory-image" src="${htmlSafe(imageUrl)}" alt="${htmlSafe(`${diamond.shape || "Lab-grown"} diamond ${diamond.carat ? `${diamond.carat} carat` : ""} ${diamond.color || ""} ${diamond.clarity || ""}`)}"></a>` : ""} <div> <p class="eyebrow">${htmlSafe(diamond.diamondType || "Lab-Grown Diamond")}</p> <h3><a href="${href}">${htmlSafe(diamond.shape)} ${diamond.carat ? `${diamond.carat}ct` : ""} Diamond</a></h3> <p class="muted">${htmlSafe(diamondSpecs(diamond))}</p> ${diamond.stockNumber ? `<p class="diamond-report-pill">Stock # ${htmlSafe(diamond.stockNumber)}</p>` : ""} ${diamond.reportNumber ? `<p class="diamond-report-pill">IGI Report # ${htmlSafe(diamond.reportNumber)}</p>` : ""} </div> ${diamondMediaLinks(diamond)} <div class="builder-actions"> <a class="button button-light" href="${href}">View Details</a> <button class="button button-gold" type="button" data-select-diamond="${diamond.id}">Select Diamond</button> ${numericPrice(String(diamond.price || "").replace(/[^0-9.]/g, "")) > 0 ? `<button class="button button-dark" type="button" data-buy-live-diamond="${htmlSafe(diamond.id)}" data-stock-number="${htmlSafe(diamond.stockNumber)}" data-diamond-type="${htmlSafe(diamond.diamondType)}" data-live-page="${htmlSafe(diamond._page || 1)}">Buy Now / Stripe Checkout</button>` : `<a class="button button-light" href="#/request/product?product=${encodeURIComponent(`${diamond.shape || "CVD"} diamond ${diamond.stockNumber || ""}`)}&category=Live%20Diamond%20Selection&intent=current-price">Request Current Price</a>`} </div> </article> `;
}

function matchingPairCard(pair) {
    const imageUrl = safeExternalUrl(pair.imageUrl);
    return ` <article class="diamond-inventory-card matching-pair-card" data-pair-id="${htmlSafe(pair.id)}" data-stock-number="${htmlSafe(pair.stockNumber)}" data-shape="${htmlSafe(pair.shape)}" data-carat="${htmlSafe(pair.carat || "")}" data-color="${htmlSafe(pair.color)}" data-clarity="${htmlSafe(pair.clarity)}" data-certificate="${htmlSafe(pair.certificate)}" data-pair-type="${htmlSafe(pair.pairType)}"> ${imageUrl ? `<img class="diamond-inventory-image" src="${htmlSafe(imageUrl)}" alt="${htmlSafe(`${pair.shape || "CVD"} matching diamond pair`)}" loading="lazy">` : ""} <div> <p class="eyebrow">${pair.pairType === "color" ? "Colored CVD Pair" : "White CVD Pair"}</p> <h3>${htmlSafe(pair.shape || "Matched")} Diamond Pair ${pair.carat ? `· ${htmlSafe(pair.carat)} ct` : ""}</h3> <p class="muted">${htmlSafe([ pair.color && `${pair.color} color`, pair.clarity, pair.measurements, pair.lab, pair.certificate && `Certificate ${pair.certificate}`, "CVD only" ].filter(Boolean).join(" | "))}</p> <p class="diamond-report-pill">${htmlSafe(pair.availability || "Check availability")} · Stock # ${htmlSafe(pair.stockNumber)}</p> </div> ${diamondMediaLinks(pair)} <div class="builder-actions"> <button class="button button-gold" type="button" data-select-pair="${htmlSafe(pair.id)}">Request This Pair</button> </div> </article> `;
}

function matchingPairsPage(initialParams = new URLSearchParams) {
    const selectedPairType = initialParams.get("pairType") || "white";
    shell(` <main> ${pageHero("Custom Earrings & Studs", "Source a professionally matched CVD diamond pair", "Browse white or colored CVD matching pairs for custom studs and earrings. Every HPHT record is excluded from this experience.", `<a class="button button-light" href="#/select-diamond">Browse Single Certified Diamonds</a>`)} <section class="diamond-inventory-section"> <div class="sourcing-choice-grid"> <button class="sourcing-choice ${selectedPairType === "white" ? "is-active" : ""}" type="button" data-pair-type-choice="white"> <span class="eyebrow">Classic Studs</span> <strong>White Diamond Pairs</strong> <span>Matched CVD stones for timeless earrings.</span> </button> <button class="sourcing-choice ${selectedPairType === "color" ? "is-active" : ""}" type="button" data-pair-type-choice="color"> <span class="eyebrow">Statement Earrings</span> <strong>Colored Diamond Pairs</strong> <span>Matched fancy-color CVD stones for custom designs.</span> </button> </div> <form class="diamond-filter-bar matching-pair-filter" id="matching-pair-filter-form"> <input type="hidden" name="pairType" value="${htmlSafe(selectedPairType)}"> <label>Shape <select name="shape"> <option value="">All shapes</option> ${[ "Round", "Oval", "Marquise", "Radiant", "Emerald", "Pear", "Cushion", "Princess", "Asscher" ].map(shape => `<option value="${shape}">${shape}</option>`).join("")} </select> </label> <label>Minimum pair weight<input name="minCarat" type="number" min="0" step="0.1" placeholder="Any"></label> <label>Maximum pair weight<input name="maxCarat" type="number" min="0" step="0.1" placeholder="Any"></label> <label>Search color, clarity, stock #<input name="search" placeholder="Example: D VVS or stock number"></label> <button class="button button-dark" type="submit">Search Matching Pairs</button> </form> <div class="diamond-api-note" id="matching-pair-note">Loading matching pairs...</div> <div class="diamond-inventory-grid" id="matching-pair-grid"></div> <div class="inventory-pagination" id="matching-pair-pagination"></div> </section> <section class="custom-form-section"> <div class="section-heading"> <p class="eyebrow">Custom Earring Request</p> <h2>Build your earrings around the selected pair</h2> </div> ${customRequestForm({
        formId: "matching-pair-request-form",
        requestType: "Product Inquiry Form",
        productCategory: "CVD Matching Diamond Pairs",
        productName: "Selected matching diamond pair"
...
async function loadMatchingPairs(params = new URLSearchParams) {
    ...
    try {
        ...
        grid.innerHTML = payload.items.length ? payload.items.map(matchingPairCard).join("") : `<div class="empty-state">No matching pairs fit that search. Submit the request below and we will source one.</div>`;
        ...
        pagination.innerHTML = ` <button class="button button-light" type="button" data-pair-page="${Math.max(1, payload.page - 1)}" ${payload.page <= 1 ? "disabled" : ""}>Previous</button> <span>Page ${payload.page} of ${payload.totalPages}</span> <button class="button button-light" type="button" data-pair-page="${Math.min(payload.totalPages, payload.page + 1)}" ${payload.page >= payload.totalPages ? "disabled" : ""}>Next</button> `;
    } catch {
...
function wireMatchingPairs(initialParams = new URLSearchParams) {
    ...
    document.getElementById("matching-pair-grid")?.addEventListener("click", event => {
        ...
        if (mediaLink) {
            event.preventDefault();
            showDiamondMediaModal({
                url: mediaLink.dataset.diamondMediaLink || mediaLink.href,
                type: mediaLink.dataset.mediaType,
                label: mediaLink.textContent.trim()
            });
            return;
        }
...
function diamondInventoryPage(initialParams = new URLSearchParams) {
    ...
    const selectedDiamondType = initialParams.get("diamondType") || (selectedTypeParam === "certified_color" || selectedTypeParam === "certified-color" ? "Certified Color Diamond" : selectedTypeParam === "matching_pair" || selectedTypeParam === "matching-pair" ? "CVD White Matching Pair" : selectedTypeParam === "matching_pair_color" || selectedTypeParam === "matching-pair-color" ? "CVD Color Matching Pair" : selectedTypeParam === "certified" ? "Certified Diamond" : "all");
    ...
    shell(` <main> ${pageHero("Live Diamond Selection", "Choose your CVD lab-grown diamonds", "Shop certified white diamonds, certified colored diamonds, white matching pairs, and colored matching pairs for engagement rings, custom jewelry, studs, and earrings—all from one streamlined selection page.")} <section class="diamond-inventory-section"> <form class="diamond-filter-bar" id="diamond-filter-form"> <label>Diamond type <select name="diamondType"> <option value="all" ${selectedDiamondType === "all" ? "selected" : ""}>All certified diamonds</option> <option value="Certified Diamond" ${selectedDiamondType === "Certified Diamond" ? "selected" : ""}>Certified White Diamonds</option> <option value="Certified Color Diamond" ${selectedDiamondType === "Certified Color Diamond" ? "selected" : ""}>Certified Colored Diamonds</option> <option value="CVD White Matching Pair" ${selectedDiamondType === "CVD White Matching Pair" ? "selected" : ""}>White Matching Pairs</option> <option value="CVD Color Matching Pair" ${selectedDiamondType === "CVD Color Matching Pair" ? "selected" : ""}>Colored Matching Pairs</option> </select> </label> <label>Shape <select name="shape"> ${[ "all", "Round", "Oval", "Marquise", "Radiant", "Emerald", "Pear", "Cushion", "Princess", "Asscher" ].map(shape => option(shape, selectedShape)).join("")} </select> </label> <label>Minimum carat<input name="minCarat" type="number" min="0" step="0.1" placeholder="Any" value="${htmlSafe(initialParams.get("minCarat") || "")}"></label> <label>Maximum carat<input name="maxCarat" type="number" min="0" step="0.1" placeholder="Any" value="${htmlSafe(initialParams.get("maxCarat") || "")}"></label> <label>Color <select name="color"> <option value="all" ${selectedColor === "all" ? "selected" : ""}>All colors</option> ${[ "D", "E", "F", "Light Yellow", "Fancy Yellow", "Pink", "Blue", "Green", "Champagne" ].map(color => option(color, selectedColor)).join("")} </select> </label> <label>Clarity <select name="clarity"> <option value="all" ${selectedClarity === "all" ? "selected" : ""}>All VVS/VS</option> ${[ "VVS1", "VVS2", "VS1", "VS2" ].map(clarity => option(clarity, selectedClarity)).join("")} </select> </label> <label>Max price<input name="maxPrice" type="number" min="0" step="1" placeholder="Any" value="${htmlSafe(initialParams.get("maxPrice") || "")}"></label> <label>Certificate #<input name="certificateNumber" placeholder="IGI report #" value="${htmlSafe(initialParams.get("certificateNumber") || "")}"></label> <label>Page<input name="page" type="number" min="1" step="1" value="${htmlSafe(initialParams.get("page") || "1")}"></label> <button class="button button-dark" type="submit">Search Diamonds</button> </form> <div class="diamond-api-note" id="diamond-api-note">Loading diamond inventory...</div> <div class="diamond-inventory-grid" id="diamond-inventory-grid"></div> </section> <section class="custom-form-section"> <div class="section-heading"> <p class="eyebrow">Diamond Request</p> <h2>Request this diamond or a custom match</h2> </div> ${customRequestForm({
        formId: "diamond-inventory-form",
        requestType: "Product Inquiry Form",
        productCategory: "Lab-Grown Diamond Inventory",
        productName: "Selected lab-grown diamond"
    })} </section> ${aboutUs()} </main> `);
...
async function loadDiamondInventory(params = new URLSearchParams) {
    ...
    let payload = {};
    try {
        const endpoints = diamondType === "Certified Diamond" ? [ "/api/diamonds/certified" ] : diamondType === "Certified Color Diamond" ? [ "/api/diamonds/certified-color" ] : diamondType === "CVD White Matching Pair" ? [ "/api/diamonds/matching-pair" ] : diamondType === "CVD Color Matching Pair" ? [ "/api/diamonds/matching-pair-color" ] : [ "/api/diamonds/certified", "/api/diamonds/certified-color" ];
    ...
    grid.innerHTML = diamonds.length ? diamonds.map(diamond => {
        diamond._page = page;
        return matchingPairMode ? matchingPairCard(diamond) : diamondInventoryCard(diamond);
    }).join("") : `<div class="empty-state">${payload.message || "No diamonds matched that search. Submit a request for a custom diamond match."}</div>`;
}
...
function manualProductInformation(product) {
    return ` <section class="product-information-section"> <div class="product-detail-copy"> <p class="eyebrow">Product Description</p> <h2>${htmlSafe(productName(product))}</h2> <p>${htmlSafe(product.lede || "Made-to-order fine jewelry by The Don Jewelers & Jewelry.")}</p> </div> <p class="shipping-note">${product.category === "Watches" ? "Availability and insured shipping timing are confirmed before fulfillment." : "Made to order. Production timing and insured shipping are confirmed after the final specifications are approved."}</p> </section> `;
}
...
function optionGroup(label, values, product) {
    ...
    return ` <fieldset class="option-group" data-group="${label}"> <legend>${label}</legend> <div class="option-grid"> ${values.map((value, index) => {
...
function showNaturalDiamondModal() {
    ...
    modal.innerHTML = ` <div class="natural-diamond-dialog" role="dialog" aria-modal="true" aria-label="Natural diamond pricing request"> <button class="natural-diamond-close" type="button" aria-label="Close natural diamond message">Close</button> <p class="eyebrow">Natural Diamond Pricing</p> <h2>Request a custom quote</h2> <p>Please request natural diamond pricing through direct messaging, custom design, custom stone size, or Request Quote so we can price your natural diamond selection accurately.</p> <div class="hero-actions"> <a class="button button-gold" href="#/request/product?intent=natural-diamond-quote">Request Quote</a> <a class="button button-dark" href="#/custom-orders">Custom Design / Stone Size</a> </div> </div> `;
    document.body.appendChild(modal);
    const close = () => modal.remove();
    modal.addEventListener("click", event => {
        if (event.target === modal) close();
...
function selectedTennisChainQuote(product) {
    ...
    let price = pointer.base + (length - 16) * (pointer.base * .085);
...
function renderSummary(product) {
    ...
    document.getElementById("summary").innerHTML = ` <p class="eyebrow">Live Selection</p> <h2>${productName(product)}</h2> <dl class="summary-list"> ${Object.entries(selections).map(([key, value]) => `<div><dt>${key}</dt><dd>${value}</dd></div>`).join("")} ${tennisQuote ? `<div><dt>Estimated CTW</dt><dd>${tennisQuote.caratWeight}</dd></div><div><dt>Estimated gold weight</dt><dd>${tennisQuote.goldWeight}</dd></div>` : ""} <div><dt>Live Diamond</dt><dd>${htmlSafe(liveDiamondLabel(liveDiamond))}</dd></div> </dl> <a class="button button-gold" href="${requestHref(product, "quote-message")}">Request Quote / Message Us</a> <a class="button button-light" href="${liveDiamondHref}">Select Live Diamond</a> <div class="price-row"><span>${naturalDiamond ? "Final selected price" : "Final selected price"}</span><strong>${naturalDiamond ? "Request pricing" : money.format(price)}</strong></div> ${naturalDiamond ? requestPriceButton(product, "button button-gold") : productCheckoutButton(product, price)} ${naturalDiamond ? `<p class="quote-note">Please message us or submit a request for special pricing on natural diamonds.</p>` : ""} ${productNotice(product)} <button class="button button-dark" id="add-cart" type="button">Add Build Order to Cart</button> <p class="quote-note" id="cart-note" hidden>Added to build order.</p> `;
    document.getElementById("add-cart").addEventListener("click", () => {
        cart.push({
            ...
            price: price || 0,
            quantity: 1,
            pricingNote: naturalDiamond ? "Request pricing" : "",
            selections: {
                ...selections,
                "Live Diamond": liveDiamondLabel(liveDiamond)
            }
        });
...
function importedProductFields(product) {
    ...
    if (product.id === "import-img-7970-mpnlzebr") {
        return [ [ "Diamond Type", [ "Natural Diamond", "Lab-Grown Diamond", "Not sure yet" ] ], [ "Metal Type", quoteMetals ], [ "Ring Size", ringSizes ], [ "Center Stone Shape", [ "Marquise" ] ], [ "Side Stone Shape", [ "Marquise" ] ], [ "Carat Size", [ [ "2 carats", 2450 ], [ "2.5 carats", 2775 ], [ "3 carats", 3100 ], [ "3.5 carats", 3425 ], [ "4 carats", 3750 ], [ "4.5 carats", 4075 ], [ "5 carats", 4400 ], [ "5.5 carats", 4725 ], [ "6 carats", 5050 ] ] ], [ "Diamond Quality", importedDiamondQualityOptions ] ];
    }
    if (product.id === "import-img-4816-mpnlzebr") {
        return [ [ "Metal Type", quoteMetals ], [ "Stone Type", [ "Amethyst with lab diamonds" ] ], [ "Diamond Quality", importedDiamondQualityOptions ], [ "Backing Type", [ "Screw back" ] ] ];
    }
    if (product.id === "import-img-2352-mpnlzebr") {
        return [ [ "Metal Type", quoteMetals ], [ "Stone Type", [ "Diamond" ] ], [ "Stone Size", [ [ "1 carat", 750 ], [ "1.5 carat", 950 ], [ "2 carat", 1150 ], [ "2.5 carat", 1350 ], [ "3 carat", 1550 ], [ "3.5 carat", 1750 ], [ "4 carat", 1950 ], [ "4.5 carat", 2150 ], [ "5 carat", 2350 ], [ "5.5 carat", 2550 ], [ "6 carat", 2750 ] ] ], [ "Diamond Quality", importedDiamondQualityOptions ], [ "Backing Type", [ "Screw back" ] ] ];
    }
    if ([ "Engagement Rings", "Men's Rings", "Women's Rings" ].includes(category)) {
        return [ [ "Diamond Type", [ "Natural Diamond", "Lab-Grown Diamond", "Not sure yet" ] ], [ "Metal Type", quoteMetals ], [ "Ring Size", ringSizes ], [ "Center Stone Shape", [ "Round", "Oval", "Emerald", "Radiant", "Marquise", "Pear", "Cushion", "Asscher", "Princess", "Custom Shape" ] ], [ "Carat Size", [ "1 carat", "1.5 carat", "2 carat", "2.5 carat", "3 carat", "4 carat", "5 carat", "Custom carat size" ] ], [ "Diamond Quality", importedDiamondQualityOptions ], [ "Engraving Option", [ "No engraving", "Inside engraving", "Custom engraving request" ] ], [ "Hidden Halo Option", [ "No hidden halo", "Add hidden halo", "Discuss with jeweler" ] ], [ "Hidden Birthstone Option", [ "No hidden birthstone", "Add hidden birthstone", "Discuss with jeweler" ] ] ];
    }
    if ([ "Men's Earrings", "Women's Earrings" ].includes(category)) {
        return [ [ "Metal Type", quoteMetals ], [ "Stone Size", [ "0.5 carat", "1 carat", "1.5 carat", "2 carat", "3 carat", "Custom stone size" ] ], [ "Diamond Quality", importedDiamondQualityOptions ], [ "Backing Type", [ "Screw back" ] ], [ "Stone Type", [ "Diamond", "Pink gemstone", "Blue gemstone", "Yellow gemstone", "Ruby", "Sapphire", "Emerald", "Custom gemstone" ] ] ];
    }
    if ([ "Pendants / Charms", "Pendants", "Custom Jewelry / Request Pricing" ].includes(category)) {
        return [ [ "Metal Type", quoteMetals ], [ "Stone Option", [ "Diamond", "Ruby", "Sapphire", "Emerald", "Colored gemstone", "No stones", "Custom stone request" ] ], [ "Custom Engraving", [ "No engraving", "Back engraving", "Name engraving", "Custom engraving request" ] ], [ "Diamond Quality", importedDiamondQualityOptions ] ];
    }
    if (category === "Chains") {
        return [ [ "Chain Style", [ "Nameplate", "Rope", "Cuban", "Tennis", "Box", "Figaro", "Mooncut", "Franco", "Custom style" ] ], [ "Metal Type", quoteMetals ], [ "Length", [ "16 in", "18 in", "20 in", "22 in", "24 in", "26 in", "30 in", "Custom length" ] ], [ "Width", [ "Thin", "Medium", "Wide", "Custom width" ] ], [ "Gram Weight Estimate", [ "Lightweight", "Medium weight", "Heavy", "Request gram quote" ] ], [ "Stone Option", [ "Diamond", "Gemstone", "No stones", "Custom stone request" ] ] ];
    }
    if ([ "Bracelets", "Tennis Bracelets", "Anklets" ].includes(category)) {
        return [ [ "Length", [ "Starting at 7 inches", "7.5 inches", "8 inches", "Custom length" ] ], [ "Metal Type", quoteMetals ], [ "Total Carat Weight", [ "5 carats", "6 carats", "7 carats", "8 carats", "10 carats", "Custom carat weight" ] ], [ "Stone Size", [ "10 pointers", "15 pointers", "20 pointers", "25 pointers", "30 pointers", "Custom stone size" ] ], [ "Diamond Quality", importedDiamondQualityOptions ], [ "Approximate Gram Weight", [ "Request gram quote", "Lightweight", "Medium weight", "Heavy" ] ] ];
    }
    if (category === "Watches") {
        return [ [ "Brand / Model", [ "Rolex", "Cartier", "Audemars Piguet", "Patek Philippe", "Custom model" ] ], [ "Custom Diamond Setting", [ "Bezel only", "Dial", "Case", "Bracelet", "Fully iced", "Custom setting" ] ], [ "Metal / Finish", [ "Yellow gold", "White gold", "Rose gold", "Steel", "Two-tone", "Custom finish" ] ], [ "Diamond Quality", importedDiamondQualityOptions ] ];
    }
    if (category === "Grillz") {
        return [ [ "Grillz Style", [ "Top", "Bottom", "Top and bottom", "Open face", "Iced out", "Custom design" ] ], [ "Metal Type", quoteMetals ], [ "Stone Option", [ "No stones", "Diamond", "Gemstone", "Custom stone request" ] ], [ "Diamond Quality", importedDiamondQualityOptions ] ];
    }
    return [ [ "Metal Type", quoteMetals ], [ "Stone Option", [ "Diamond", "Gemstone", "No stones", "Custom stone request" ] ], [ "Diamond Quality", importedDiamondQualityOptions ] ];
}
...
function renderImportedSummary(product) {
    ...
    host.innerHTML = ` <p class="eyebrow">Selected Options</p> <h2>${productName(product)}</h2> <dl class="summary-list"> ${Object.entries(selections).map(([key, value]) => `<div><dt>${key}</dt><dd>${value}</dd></div>`).join("")} </dl> <div class="price-row"><span>Pricing</span><strong>${price === null ? "Request Pricing" : money.format(price)}</strong></div> <p class="quote-note">Pricing varies depending on metal, diamond quality, stone size, and market availability. Submit a request for final pricing.</p> <button class="button button-dark" id="imported-add-inquiry" type="button">Add to Inquiry</button> <p class="quote-note" id="imported-cart-note" hidden>Added to inquiry.</p> `;
...
function importedProductDetail(product) {
    ...
    shell(` <main> <section class="product-detail-hero"> <div class="product-media-stack"> <img src="${productImageSrc(product)}" alt="${product.alt || productName(product)}" ${imageSafety}> ${productGallery(product)} </div> <div> <p class="eyebrow">${product.category}</p> <h1>${productName(product)}</h1> <p class="product-description">${product.shortDescription || "A luxury custom jewelry piece from The Don Jewelers & Jewelry, available for quote review."}</p> <p class="diamond-origin-note">Pricing varies depending on metal, diamond quality, stone size, and market availability. Submit a request for final pricing.</p> </div> </section> <section class="customizer-layout"> <div class="customizer-panel"> <p class="eyebrow">Custom Product Builder</p> <h2>${productName(product)}</h2> <p class="lede">${product.specs || "Request Pricing"}</p> ${fields.map(([label, values]) => optionGroup(label, values, product)).join("")} <dl class="summary-list"> <div><dt>Category</dt><dd>${product.category}</dd></div> <div><dt>Tags</dt><dd>${(product.tags || []).join(", ") || "Custom Jewelry"}</dd></div> <div><dt>Price</dt><dd>${product.priceLabel || "Request Pricing"}</dd></div> </dl> <div class="builder-actions"> <a class="button button-gold" href="${requestHref(product, "custom-quote")}">Request Custom Quote</a> <a class="button button-dark" href="#/custom-orders">Message Us for Custom Design</a> <a class="button button-light" href="#/request/contact">Contact The Don Jewelers & Jewelry</a> </div> </div> <aside class="summary-panel" id="imported-summary"></aside> </section> <section class="custom-form-section"> <div class="section-heading"> <p class="eyebrow">Product Inquiry</p> <h2>Submit a request for ${productName(product)}</h2> </div> ${customRequestForm({
        formId: "imported-product-inquiry-form",
        requestType: "Product Inquiry Form",
        productCategory: product.category,
        productName: productName(product)
    })} </section> ${aboutUs()} </main> `);
...
function parseCsvRows(text) {
    const rows = text.split(/\r?\n/).filter(Boolean).map(line => {
        ...
        for (const char of line) {
            if (char === '"') quoted = !quoted; else if (char === "," && !quoted) {
...
function makeImportDraft({caption: caption = "", postLink: postLink = "", mediaUrl: mediaUrl = "", mediaName: mediaName = "Instagram product", source: source = instagramHandle}) {
...
function renderImportDrafts(drafts) {
    ...
    host.innerHTML = drafts.length ? drafts.map((draft, index) => ` <article class="import-draft" data-index="${index}"> ${draft.imageUrl ? `<img src="${draft.imageUrl}" alt="">` : `<div class="import-media-empty">No media yet</div>`} <div class="import-fields"> <label>Product title<input data-field="name" value="${escapeField(draft.name)}"></label> <label>Category<select data-field="category">${importCategories.map(category => `<option ${category === draft.category ? "selected" : ""}>${category}</option>`).join("")}</select></label> <label>Short description<textarea data-field="shortDescription" rows="3">${escapeField(draft.shortDescription)}</textarea></label> <label>Specs section<textarea data-field="specs" rows="4">${escapeField(draft.specs)}</textarea></label> <label>Tags<input data-field="tags" value="${escapeField((draft.tags || []).join(", "))}"></label> <label>Price<input data-field="priceLabel" value="${escapeField(draft.priceLabel || "Request Pricing")}"></label> <label>Instagram post link<input data-field="postLink" value="${escapeField(draft.postLink || "")}"></label> <div class="builder-actions"> <button class="button button-gold" type="button" data-approve="${index}">Approve Listing</button> <button class="button button-light" type="button" data-remove-draft="${index}">Remove Draft</button> <a class="button button-dark" href="#/request/product?product=${encodeURIComponent(draft.name)}&category=${encodeURIComponent(draft.category || "Product Inquiry")}&intent=custom-quote">Request Custom Quote</a> </div> </div> </article> `).join("") : `<div class="empty-state">Upload images or paste CSV rows to create draft listings for review.</div>`;
}
...
async function imageFileAttachment(file) {
    ...
    const image = "createImageBitmap" in window ? await createImageBitmap(file) : await new Promise((resolve, reject) => {
...
async function requestAttachments(form) {
    ...
    for (const file of selected) {
        ...
        if (totalBytes > 25e5) throw new Error("The uploaded images are too large together. Please use fewer or smaller images.");
...
function savePendingRequest(payload) {
    ...
    pending.unshift({
        ...payload,
        files: (payload.files || []).map(({name: name, type: type, size: size}) => ({
            name: name,
            type: type,
            size: size
        })),
...
async function sendWebsiteRequest(payload) {
    ...
    const eventName = /appointment|consult/.test(leadType) ? "appointment_request" : /contact/.test(leadType) ? "contact_form_submit" : /engagement|ring builder/.test(leadType) ? "ring_design_submit" : /custom/.test(leadType) ? "custom_jewelry_submit" : /product/.test(leadType) ? "product_inquiry_submit" : /financ/.test(leadType) ? "financing_request" : "quote_form_submit";
...
function sendStripeStartAlert(link) {
    ...
    const payload = {
        ...
        jewelry: {
            ...
            notes: cart.length ? cart.map(item => `${item.name} - ${item.pricingNote || money.format(item.price)} - ${Object.entries(item.selections || {}).map(([key, value]) => `${key}: ${value}`).join(" | ")}`).join("\n") : "Customer clicked Stripe checkout from the website."
        },
        checkout: {
    ...
    if (navigator.sendBeacon) {
        navigator.sendBeacon("/api/send-request", new Blob([ body ], {
...
async function startProductCheckout(button) {
    ...
    try {
        await loadStripeJs();
        const configResponse = await fetchWithTimeout("/api/stripe-config", {
            headers: {
                Accept: "application/json"
            }
        }, 1e4);
        ...
        const requestBody = button.dataset.buyLiveDiamond ? {
            ...
            selections: location.hash.startsWith(`#/product/${button.dataset.buyProduct}`) ? {
                ...selections
            } : {}
        };
        ...
        overlay.innerHTML = `<section class="stripe-checkout-dialog" role="dialog" aria-modal="true" aria-label="Secure checkout"><header><div><p class="eyebrow">Secure Payment</p><h2>Complete your purchase</h2></div><button class="stripe-checkout-close" type="button" aria-label="Close checkout">Close</button></header><p class="stripe-checkout-status" role="status">Loading cards, wallets, and eligible financing options…</p><p class="checkout-financing-note">Stripe will display any eligible Affirm, Klarna, or Afterpay options enabled for this purchase. Availability and approval depend on the provider, order amount, and customer location.</p><p class="checkout-offer-note"><strong>Promo code or first-purchase offer:</strong> Enter THEDON15 or FIRST500 in checkout. Your total will not change automatically. Someone from our team will contact you after purchase to verify the purchase and first-time customer eligibility.</p><p class="checkout-offer-note"><strong>Promo code or first-purchase offer:</strong> Enter THEDON15 or FIRST500 in checkout. Your total will not change automatically. Someone from our team will contact you after purchase to verify the purchase and first-time customer eligibility.</p><div id="stripe-embedded-checkout"></div></section>`;
        document.body.appendChild(overlay);
        document.body.classList.add("checkout-open");
        overlay.querySelector(".stripe-checkout-close").addEventListener("click", closeEmbeddedCheckout);
        overlay.addEventListener("click", event => {
            if (event.target === overlay) closeEmbeddedCheckout();
        });
        ...
        embeddedCheckout = await stripe.initEmbeddedCheckout({
            fetchClientSecret: async () => {
                ...
                const checkoutItems = button.dataset.buyCart ? commerceItems(payableCartItems()) : [ {
                    item_id: button.dataset.buyProduct || button.dataset.buyLiveDiamond || "",
                    item_name: button.dataset.stockNumber || "Jewelry purchase",
                    item_category: button.dataset.buyLiveDiamond ? "Loose Diamond" : "Jewelry",
                    quantity: 1
                } ];
                trackEvent("begin_checkout", {
...
function choiceGroup(label, name, options, wide = false) {
    return ` <fieldset class="request-choice-group ${wide ? "form-wide" : ""}"> <legend>${label}</legend> <div class="request-choice-grid"> ${options.map((option, index) => ` <label class="request-choice-pill"> <input type="radio" name="${name}" value="${option}" ${index === 0 ? "checked" : ""}> <span>${option}</span> </label> `).join("")} </div> </fieldset> `;
}
...
const ringOption = ({id: id, name: name, category: category, description: description, internalPriceAdjustment: internalPriceAdjustment = 0, compatibleDiamondShapes: compatibleDiamondShapes = allRingShapes, compatibleMetals: compatibleMetals = allRingMetals, previewImagePath: previewImagePath = ""}) => ({
    id: id,
    name: name,
    label: name,
    category: category,
    description: description,
    internalPriceAdjustment: internalPriceAdjustment,
    priceModifier: internalPriceAdjustment,
    compatibleDiamondShapes: compatibleDiamondShapes,
    compatibleMetals: compatibleMetals,
    previewImagePath: previewImagePath || ringThumbnailSlot(category, id)
});

const ringBuilderOptions = {
    startPath: [ ringOption({
        id: "setting-first",
        name: "Start With Setting",
        category: "start-path",
        description: "Design the ring first, then attach a diamond or request sourcing."
    }), ringOption({
        id: "diamond-first",
        name: "Start With Diamond",
        category: "start-path",
        description: "Choose your diamond direction first, then build the setting around it."
    }) ],
    diamondType: [ ringOption({
        id: "lab-grown",
        name: "Lab-Grown Diamond",
        category: "diamond-type",
        description: "Premium lab-grown options with strong size and value."
    }), ringOption({
        id: "natural",
        name: "Natural Diamond",
        category: "diamond-type",
        description: "Natural diamonds sourced for certification, beauty, and rarity.",
        internalPriceAdjustment: 1800
    }) ],
    centerStoneShape: [ ringOption({
        id: "round",
        name: "Round",
        category: "diamond-shape",
        description: "Classic brilliance and balanced sparkle."
    }), ringOption({
        id: "oval",
        name: "Oval",
        category: "diamond-shape",
        description: "Elongated coverage with soft brilliance."
    }), ringOption({
        id: "emerald",
        name: "Emerald",
        category: "diamond-shape",
        description: "Step-cut flashes with a clean architectural face."
    }), ringOption({
        id: "radiant",
        name: "Radiant",
        category: "diamond-shape",
        description: "Bright rectangular faceting with modern structure."
    }), ringOption({
        id: "cushion",
        name: "Cushion",
        category: "diamond-shape",
        description: "Soft square outline with romantic sparkle."
    }), ringOption({
        id: "pear",
        name: "Pear",
        category: "diamond-shape",
        description: "A graceful teardrop silhouette."
    }), ringOption({
        id: "marquise",
        name: "Marquise",
        category: "diamond-shape",
        description: "Dramatic pointed shape with major finger coverage."
    }), ringOption({
        id: "princess",
        name: "Princess",
        category: "diamond-shape",
        description: "Sharp square brilliance with clean geometry."
    }), ringOption({
        id: "asscher",
        name: "Asscher",
        category: "diamond-shape",
        description: "Square step-cut depth with vintage presence."
    }), ringOption({
        id: "heart",
        name: "Heart",
        category: "diamond-shape",
        description: "Romantic statement shape for a personal build."
    }) ],
    settingStyle: [ ringOption({
        id: "solitaire",
        name: "Solitaire",
        category: "setting-style",
        description: "A focused setting that keeps attention on the center diamond."
    }), ringOption({
        id: "hidden-halo",
        name: "Hidden Halo",
        category: "setting-style",
        description: "Sparkle tucked beneath the crown for side-view detail.",
        internalPriceAdjustment: 650
    }), ringOption({
        id: "halo",
        name: "Halo",
        category: "setting-style",
        description: "A diamond frame that increases face-up presence.",
        internalPriceAdjustment: 950
    }), ringOption({
        id: "three-stone",
        name: "Three-Stone",
        category: "setting-style",
        description: "Two side stones balance the center diamond.",
        internalPriceAdjustment: 1400,
        compatibleDiamondShapes: [ "round", "oval", "emerald", "radiant", "cushion", "pear", "marquise", "princess", "asscher" ]
    }), ringOption({
        id: "pave",
        name: "Pave",
        category: "setting-style",
        description: "Fine diamonds along the shoulders for extra fire.",
        internalPriceAdjustment: 850
    }), ringOption({
        id: "cathedral",
        name: "Cathedral",
        category: "setting-style",
        description: "Raised shoulders lift the diamond with an architectural profile.",
        internalPriceAdjustment: 550
    }), ringOption({
        id: "vintage",
        name: "Vintage",
        category: "setting-style",
        description: "Milgrain, engraving, and old-world detail.",
        internalPriceAdjustment: 900
    }), ringOption({
        id: "custom",
        name: "Custom",
        category: "setting-style",
        description: "A private custom concept built with CAD review.",
        internalPriceAdjustment: 1200
    }) ],
    metal: [ ringOption({
        id: "14k-white",
        name: "14K White Gold",
        category: "metal",
        description: "Bright white bridal finish."
    }), ringOption({
        id: "14k-yellow",
        name: "14K Yellow Gold",
        category: "metal",
        description: "Warm classic gold."
    }), ringOption({
        id: "14k-rose",
        name: "14K Rose Gold",
        category: "metal",
        description: "Soft rose tone with romantic warmth."
    }), ringOption({
        id: "18k-white",
        name: "18K White Gold",
        category: "metal",
        description: "Premium white gold with richer weight.",
        internalPriceAdjustment: 475
    }), ringOption({
        id: "18k-yellow",
        name: "18K Yellow Gold",
        category: "metal",
        description: "Richer yellow gold color and feel.",
        internalPriceAdjustment: 475
    }), ringOption({
        id: "platinum",
        name: "Platinum",
        category: "metal",
        description: "Dense heirloom-grade platinum.",
        internalPriceAdjustment: 950
    }) ],
    headStyle: [ ringOption({
        id: "four-prong",
        name: "4-Prong",
        category: "head-basket",
        description: "Open head with a clean view of the stone."
    }), ringOption({
        id: "six-prong",
        name: "6-Prong",
        category: "head-basket",
        description: "Classic secure crown with a rounder look."
    }), ringOption({
        id: "eagle-claw",
        name: "Eagle Claw",
        category: "head-basket",
        description: "Fine pointed tips for a couture finish.",
        internalPriceAdjustment: 180
    }), ringOption({
        id: "bezel",
        name: "Bezel",
        category: "head-basket",
        description: "Smooth rim around the center stone.",
        internalPriceAdjustment: 500,
        compatibleDiamondShapes: [ "round", "oval", "emerald", "radiant", "cushion", "pear", "marquise", "princess", "asscher" ]
    }), ringOption({
        id: "hidden-halo-basket",
        name: "Hidden Halo Basket",
        category: "head-basket",
        description: "Diamond detail under the center stone.",
        internalPriceAdjustment: 700
    }) ],
    bandStyle: [ ringOption({
        id: "plain",
        name: "Plain",
        category: "band-style",
        description: "Clean polished shank with timeless focus."
    }), ringOption({
        id: "pave",
        name: "Pave",
        category: "band-style",
        description: "Fine diamond line across the shank.",
        internalPriceAdjustment: 650
    }), ringOption({
        id: "cathedral",
        name: "Cathedral",
        category: "band-style",
        description: "Lifted shoulders leading into the head.",
        internalPriceAdjustment: 500
    }), ringOption({
        id: "split-shank",
        name: "Split Shank",
        category: "band-style",
        description: "Two rails open toward the center stone.",
        internalPriceAdjustment: 850
    }), ringOption({
        id: "twisted",
        name: "Twisted",
        category: "band-style",
        description: "Interwoven movement with a custom feel.",
        internalPriceAdjustment: 750
    }), ringOption({
        id: "floral-inspired",
        name: "Floral-Inspired",
        category: "band-style",
        description: "Original floral detail inspired by hand engraving.",
        internalPriceAdjustment: 950,
        compatibleMetals: [ "14k-white", "14k-yellow", "14k-rose", "18k-yellow", "platinum" ]
    }), ringOption({
        id: "three-stone-side-accents",
        name: "Three-Stone Side Accents",
        category: "band-style",
        description: "Side accent stones framing the center diamond.",
        internalPriceAdjustment: 1250,
        compatibleDiamondShapes: [ "round", "oval", "emerald", "radiant", "cushion", "princess", "asscher" ]
    }) ],
    ringSize: [ "4", "4.5", "5", "5.5", "6", "6.5", "7", "7.5", "8", "8.5", "9", "9.5", "10" ].map(size => ringOption({
        id: size,
        name: `Size ${size}`,
        category: "ring-size",
        description: "Final sizing can be confirmed before production."
    }))
};
...
function ringPreviewSvg(selection = {}, mode = "large") {
    ...
    const sideDiamonds = side === "none" ? "" : [ accentDiamond(centerX - 58 * scale, centerY + 13 * scale, side === "tapered-baguette" ? 8 * scale : 6 * scale), accentDiamond(centerX + 58 * scale, centerY + 13 * scale, side === "tapered-baguette" ? 8 * scale : 6 * scale), side !== "none" ? `<ellipse cx="${centerX - 83 * scale}" cy="${centerY + 28 * scale}" rx="${12 * scale}" ry="${5 * scale}" fill="url(#diamond-${svgKey})" transform="rotate(-24 ${centerX - 83 * scale} ${centerY + 28 * scale})" /><ellipse cx="${centerX + 83 * scale}" cy="${centerY + 28 * scale}" rx="${12 * scale}" ry="${5 * scale}" fill="url(#diamond-${svgKey})" transform="rotate(24 ${centerX + 83 * scale} ${centerY + 28 * scale})" />` : "" ].join("");
    const pave = /pave|floral|twisted|three-stone/.test(`${band} ${setting}`) ? Array.from({
        length: mode === "thumb" ? 14 : 24
    }, (_, index) => {
    ...
    const weddingBand = wedding === "none" ? "" : `<path d="M${centerX - 178 * scale} ${centerY + 122 * scale} C${centerX - 64 * scale} ${centerY + 164 * scale} ${centerX + 64 * scale} ${centerY + 164 * scale} ${centerX + 178 * scale} ${centerY + 122 * scale}" fill="none" stroke="url(#metal-${svgKey})" stroke-width="${bandStroke * .78}" stroke-linecap="round" />${wedding === "pave-contour" ? Array.from({
        length: 18
    }, (_, i) => accentDiamond(centerX - 105 * scale + i * 12 * scale, centerY + 137 * scale, 2.8 * scale)).join("") : ""}`;
    const bandPath = band === "split-shank" ? `<path d="M${centerX - 224 * scale} ${centerY + 96 * scale} C${centerX - 116 * scale} ${centerY + 52 * scale} ${centerX - 54 * scale} ${centerY + 50 * scale} ${centerX - 21 * scale} ${centerY + 34 * scale}" fill="none" stroke="url(#metal-${svgKey})" stroke-width="${bandStroke * .68}" stroke-linecap="round" /><path d="M${centerX + 224 * scale} ${centerY + 96 * scale} C${centerX + 116 * scale} ${centerY + 52 * scale} ${centerX + 54 * scale} ${centerY + 50 * scale} ${centerX + 21 * scale} ${centerY + 34 * scale}" fill="none" stroke="url(#metal-${svgKey})" stroke-width="${bandStroke * .68}" stroke-linecap="round" />` : band === "twisted" ? `<path d="M${centerX - 224 * scale} ${centerY + 97 * scale} C${centerX - 98 * scale} ${centerY + 42 * scale} ${centerX + 98 * scale} ${centerY + 150 * scale} ${centerX + 224 * scale} ${centerY + 97 * scale}" fill="none" stroke="url(#metal-${svgKey})" stroke-width="${bandStroke * .75}" stroke-linecap="round" /><path d="M${centerX - 224 * scale} ${centerY + 118 * scale} C${centerX - 98 * scale} ${centerY + 166 * scale} ${centerX + 98 * scale} ${centerY + 46 * scale} ${centerX + 224 * scale} ${centerY + 118 * scale}" fill="none" stroke="url(#metal-${svgKey})" stroke-width="${bandStroke * .58}" stroke-linecap="round" />` : `<path d="M${centerX - 232 * scale} ${centerY + 106 * scale} C${centerX - 116 * scale} ${centerY + 144 * scale} ${centerX + 116 * scale} ${centerY + 144 * scale} ${centerX + 232 * scale} ${centerY + 106 * scale}" fill="none" stroke="url(#metal-${svgKey})" stroke-width="${bandStroke}" stroke-linecap="round" />`;
    const halo = setting === "halo" ? Array.from({
        length: 18
    }, (_, index) => {
        const angle = index / 18 * Math.PI * 2;
        return accentDiamond(centerX + Math.cos(angle) * 42 * scale, centerY - lift + Math.sin(angle) * 39 * scale, 3.4 * scale);
    }).join("") : "";
    const hiddenHalo = /hidden-halo/.test(`${setting} ${head}`) ? Array.from({
        length: 11
    }, (_, i) => accentDiamond(centerX - 34 * scale + i * 6.8 * scale, centerY + 43 * scale, 2.6 * scale)).join("") : "";
    const prongCount = /six/.test(head) ? 6 : 4;
    const prongMarks = Array.from({
        length: prongCount
    }, (_, index) => {
    ...
    return ` <svg class="ring-render-svg" viewBox="0 0 ${width} ${height}" role="img" aria-label="Custom engagement ring preview" xmlns="http://www.w3.org/2000/svg"> <defs> <linearGradient id="metal-${svgKey}" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="${light}"/><stop offset=".45" stop-color="${mid}"/><stop offset=".72" stop-color="${light}"/><stop offset="1" stop-color="${dark}"/></linearGradient> <radialGradient id="diamond-${svgKey}" cx=".35" cy=".25" r=".78"><stop offset="0" stop-color="#ffffff"/><stop offset=".35" stop-color="#f4fbff"/><stop offset=".72" stop-color="#b9d1e5"/><stop offset="1" stop-color="#7893aa"/></radialGradient> <filter id="soft-shadow-${svgKey}" x="-20%" y="-20%" width="140%" height="150%"><feDropShadow dx="0" dy="${8 * scale}" stdDeviation="${8 * scale}" flood-color="#000" flood-opacity=".28"/></filter> </defs> <g filter="url(#soft-shadow-${svgKey})"> ${weddingBand} ${bandPath} ${pave} ${sideDiamonds} ${detail} <path d="M${centerX - 32 * scale} ${centerY + 45 * scale} C${centerX - 22 * scale} ${centerY + 18 * scale} ${centerX + 22 * scale} ${centerY + 18 * scale} ${centerX + 32 * scale} ${centerY + 45 * scale}" fill="none" stroke="url(#metal-${svgKey})" stroke-width="${8 * scale}" stroke-linecap="round" /> ${hiddenHalo} <g fill="url(#diamond-${svgKey})" stroke="#edf7ff" stroke-width="${2 * scale}">${ringDiamondShape(shape, centerX, centerY - lift, scale)}</g> <path d="M${centerX - 20 * scale} ${centerY - lift - 18 * scale} L${centerX} ${centerY - lift + 26 * scale} L${centerX + 21 * scale} ${centerY - lift - 18 * scale}" fill="none" stroke="rgba(255,255,255,.62)" stroke-width="${1.5 * scale}" /> ${prongMarks} ${birth} </g> </svg> `;
}
...
function ringPreviewCandidatePaths(selection = {}) {
    ...
    const head = selection.headStyle || "four-prong";
    const band = selection.bandStyle || "plain";
    return [ ringPreviewSlot(shape, setting, metal, head, band), ringPreviewSlot(shape, setting, metal), ringPreviewSlot(shape, setting), ringPreviewSlot(shape), "/assets/ring-builder/previews/luxury-preview-sheet.png", "/assets/ring-builder/previews/default-luxury-ring.svg" ];
}
...
function ringImagePreview(selection = {}, mode = "large", fallbackId = "") {
    ...
    return ` <div class="ring-image-preview-shell"> <img class="ring-preview-photo" src="${candidates[0]}" alt="Custom engagement ring render" data-ring-preview-candidates="${htmlSafe(JSON.stringify(candidates.slice(1)))}" ${ringImageFallbackAttrs(fallback)}> <div class="ring-preview-svg-fallback" id="${fallback}" hidden>${ringPreviewSvg(selection, mode)}</div> </div> `;
}
...
function ringOptionThumbnail(option, name) {
    ...
    return ` <span class="ring-option-media"> <img src="${htmlSafe(option.previewImagePath)}" alt="${htmlSafe(option.name)}" data-ring-preview-candidates="[]" ${ringImageFallbackAttrs(fallbackId)}> <span class="ring-preview-svg-fallback" id="${fallbackId}" hidden>${ringPreviewSvg(fallbackSelection, "thumb")}</span> </span> `;
}
...
const ringBuilderSteps = [ {
    ...
    helper: "Begin with the setting or diamond direction. You can still change everything before submission."
}, {
    id: "diamond-type",
    title: "Diamond",
    name: "diamondType",
    kicker: "Diamond type",
    helper: "Choose lab-grown or natural. Final sourcing and quote are handled personally."
}, {
    id: "shape",
    title: "Shape",
    name: "centerStoneShape",
    kicker: "Center diamond",
    helper: "Every shape updates the live preview immediately."
}, {
    id: "setting",
    title: "Setting",
    name: "settingStyle",
    kicker: "Setting style",
    helper: "Pick the overall ring architecture and visual direction."
}, {
    id: "metal",
    title: "Metal",
    name: "metal",
    kicker: "Precious metal",
    helper: "Choose the metal color and grade for the final build."
}, {
    id: "head",
    title: "Head",
    name: "headStyle",
    kicker: "Head / basket",
    helper: "Select how the diamond is held and shown from the side."
}, {
    id: "band",
    title: "Band",
    name: "bandStyle",
    kicker: "Shank / band",
    helper: "Choose the ring's band structure and accent style."
}, {
    id: "size",
    title: "Size",
    name: "ringSize",
    kicker: "Ring size",
    helper: "Choose the closest size now. Exact sizing can be confirmed before production."
}, {
    id: "review",
    title: "Review",
    name: "",
    kicker: "Final review",
    helper: "Review the finished build and submit it for a personalized quote."
} ];

function RingPreview() {
    return ` <section class="ring-preview-panel" aria-label="Live engagement ring preview"> <div class="ring-preview-heading"> <p class="eyebrow">Live Luxury Preview</p> <h3 id="ring-preview-title">Your custom engagement ring</h3> </div> <div class="ring-preview-stage" id="ring-preview-stage"> <div id="ring-preview-render">${ringImagePreview({}, "large", "ring-main-preview-fallback")}</div> </div> <p class="ring-builder-save-note" id="ring-builder-save-note" hidden></p> </section> `;
}

function OptionSelector({label: label, name: name, options: options, compact: compact = false, stepIndex: stepIndex = 0}) {
    return ` <fieldset class="ring-option-group ${compact ? "compact" : ""}" data-option-group="${name}"> <legend><span>${label}</span></legend> <div class="ring-option-grid"> ${options.map((option, index) => ` <label class="ring-option-card" data-option-card="${name}" data-option-id="${htmlSafe(option.id)}"> <input type="radio" name="${name}" value="${htmlSafe(option.id)}" ${index === 0 ? "checked" : ""}> ${ringOptionThumbnail(option, name)} <span class="ring-option-copy"> <strong>${htmlSafe(option.name)}</strong> <small>${htmlSafe(option.description)}</small> <em>${htmlSafe(option.category.replace(/-/g, " "))}</em> </span> </label> `).join("")} </div> </fieldset> `;
}

function RingBuilderStepper() {
    return `<nav class="ring-builder-stepper" aria-label="Engagement ring builder steps"> ${ringBuilderSteps.map((step, index) => `<button type="button" data-step-jump="${index}" class="${index === 0 ? "is-active" : ""}"><span>${index + 1}</span><strong>${htmlSafe(step.title)}</strong></button>`).join("")} </nav>`;
}

function RingBuilderStepPanels() {
    return ringBuilderSteps.map((step, index) => {
        if (step.id === "review") {
            return `<section class="ring-builder-review" data-builder-step="${index}" hidden> <p class="eyebrow">${htmlSafe(step.kicker)}</p> <h3>Submit your finished design</h3> <p>${htmlSafe(step.helper)}</p> ${CustomQuoteForm()} </section>`;
        }
        return `<section class="ring-builder-step-panel" data-builder-step="${index}" ${index === 0 ? "" : "hidden"}> <p class="eyebrow">${htmlSafe(step.kicker)}</p> <h3>${htmlSafe(step.title === "Start" ? "How would you like to begin?" : step.kicker)}</h3> <p>${htmlSafe(step.helper)}</p> ${OptionSelector({
            label: step.kicker,
            name: step.name,
            options: ringBuilderOptions[step.name],
            compact: step.name === "diamondType" || step.name === "metal" || step.name === "ringSize",
            stepIndex: index
        })} </section>`;
    }).join("");
}
...
function CustomQuoteForm() {
    return ` <section class="custom-quote-panel"> <h3>Submit Design Request</h3> <label>Timeline needed<input name="timeline" placeholder="Example: 2 weeks, 30 days, proposal date"></label> <label>Ideal budget<input name="idealBudget" placeholder="Example: $3,500"></label> <label>Maximum budget<input name="maximumBudget" placeholder="Example: $5,000 max"></label> <label class="form-wide">Anything custom?<textarea name="customDesignRequest" rows="4" placeholder="Tell us about engraving text, hidden details, inspiration links, custom flower/leaf ideas, or special stones."></textarea></label> <label class="form-wide">Upload Inspiration Photos<input type="file" name="inspiration" multiple accept="image/*"></label> <label>Full Name<input name="fullName" autocomplete="name" required></label> <label>Email<input name="email" type="email" autocomplete="email" required></label> <label>Phone number<input name="phone" type="tel" autocomplete="tel" required></label> <div class="deposit-note form-wide"> <strong>Quote-first custom review</strong> <span>Your completed build goes directly to The Don Jewelers & Jewelry for a personalized quote, stone review, and next-step consultation.</span> </div> <div class="ring-submit-actions form-wide"> <button class="button button-gold" type="submit" name="requestIntent" value="quote">Submit Design Request</button> <button class="button button-dark" type="submit" name="requestIntent" value="custom-design">Submit Custom Design Request</button> </div> <p class="form-success" hidden></p> <p class="form-error" hidden></p> </section> `;
}
...
function RingBuilderPage() {
    setSeo("Start Your Custom Ring Design | The Don Jewelers", "Request a custom engagement ring with The Don Jewelers & Jewelry. Share diamond direction, metal, ring size, budget, timeline, and inspiration photos for a private quote.", {
        ...
        faqs: [ [ "Can I choose my own diamond?", "Yes. You can start with the live diamond selection, choose a lab-grown or natural diamond direction, or submit the exact stone specifications you want sourced." ], [ "Can The Don Jewelers make a custom setting?", "Yes. The process can include a private consultation, CAD design, stone sourcing, approval, production, and insured delivery." ], [ "Do I need my ring size before starting?", "No. You can submit an estimated size and confirm exact sizing before final approval." ] ]
    });
    shell(` <main> ${pageHero("Engagement Ring Builder", "Build your own engagement ring", "Start with a diamond or setting, customize every detail, then submit the finished design for a personalized quote from The Don Jewelers & Jewelry.", ` <div class="hero-actions"> <a class="button button-gold" href="#engagement-build-form">Start Building</a> <a class="button button-light" href="#/select-diamond?return=engagement-ring-builder">Choose Live Diamond</a> </div> `)} <section class="engagement-builder-section"> <form class="custom-order-form engagement-build-form" id="engagement-build-form" data-request-type="Custom Engagement Ring Request" data-product-category="Engagement Rings"> <input type="hidden" name="selectedLiveDiamond"> <input type="hidden" name="selectedLiveDiamondStock"> <textarea name="buildSummary" hidden></textarea> <input type="hidden" name="builderUrl"> <input type="hidden" name="internalAdjustmentTotal"> <input type="hidden" name="priceEstimate" value="Personal quote requested"> <input type="hidden" name="renderReference"> <div class="ring-builder-shell form-wide"> <div class="ring-builder-left"> ${RingPreview()} </div> <div class="ring-builder-controls"> ${RingBuilderStepper()} <div class="ring-builder-step-card"> ${RingBuilderStepPanels()} <div class="ring-builder-nav"> <button class="button button-light" type="button" data-builder-prev disabled>Back</button> <button class="button button-gold" type="button" data-builder-next>Continue</button> </div> </div> </div> </div> <div class="ring-builder-bottom form-wide"> ${BuilderSummary()} <div class="ring-preview-actions"> <button class="button button-gold" type="button" data-save-ring-design>Save Design</button> <a class="button button-light" href="#/select-diamond?return=engagement-ring-builder">Start With Live Diamond</a> </div> </div> </form> </section> ${trustBlockSection()} ${officialGoogleProfileSection()} ${aboutUs()} </main> `);
...
function selectedDiamondSummary(diamond) {
    if (!diamond) return "";
    return [ diamond.shape && `${diamond.shape} shape`, diamond.carat && `${diamond.carat}ct`, diamond.color && `${diamond.color} color`, diamond.clarity, diamond.certificate && `${diamond.certificate} certified`, diamond.reportNumber && `Report ${diamond.reportNumber}`, diamond.stockNumber && `Stock ${diamond.stockNumber}` ].filter(Boolean).join(" | ");
}
...
function wireEngagementRingBuilder() {
    ...
    const optionFields = [ [ "startPath", "Builder path" ], [ "diamondType", "Diamond type" ], [ "centerStoneShape", "Center stone" ], [ "settingStyle", "Setting" ], [ "headStyle", "Basket/head" ], [ "metal", "Metal" ], [ "bandStyle", "Band" ], [ "ringSize", "Ring size" ] ];
    const watchedFields = [ ...optionFields, [ "timeline", "Timeline" ], [ "idealBudget", "Ideal budget" ], [ "maximumBudget", "Max budget" ], [ "selectedLiveDiamond", "Live diamond" ] ];
    ...
    const updatePreview = () => {
        ...
        if (form.elements.renderReference) form.elements.renderReference.value = JSON.stringify({
            selection: selection,
    ...
    const updateSummary = () => {
        ...
        updateUrl();
        const rows = watchedFields.map(([name, label]) => {
    ...
    form.querySelector("[data-save-ring-design]")?.addEventListener("click", () => {
        const design = {
            savedAt: (new Date).toISOString(),
            url: form.elements.builderUrl?.value || location.href,
            summary: form.elements.buildSummary?.value || ""
        };
...
function customRequestForm({formId: formId, requestType: requestType = "Request Custom Design Form", productCategory: productCategory = "", productName: productName = ""}) {
    const category = productCategory || requestTypeToCategory(requestType);
    return ` <form class="custom-order-form engagement-build-form" id="${formId}" data-request-type="${htmlSafe(requestType)}" data-product-category="${htmlSafe(category)}" data-product-name="${htmlSafe(productName)}"> <label>Full Name<input name="fullName" autocomplete="name" required></label> <label>Email Address<input name="email" type="email" autocomplete="email" required></label> <label>Phone Number<input name="phone" type="tel" autocomplete="tel" required></label> <input type="hidden" name="selectedLiveDiamond"> <input type="hidden" name="selectedLiveDiamondStock"> ${productName ? `<label class="form-wide">Product<input name="productName" value="${htmlSafe(productName)}" readonly></label>` : ""} <label>Product Category <select name="productCategory"> ${quoteCategories.map(item => `<option ${item === requestType ? "selected" : ""}>${item}</option>`).join("")} </select> </label> <label>Metal Type <select name="metalType"> ${quoteMetals.map(item => `<option>${item}</option>`).join("")} </select> </label> <label>Diamond Shape<input name="diamondShape" placeholder="Round, oval, emerald, radiant, custom"></label> <label>Stone Type<input name="stoneType" placeholder="Diamond, ruby, sapphire, emerald, gemstone"></label> <label>Carat Weight<input name="caratWeight" placeholder="Example: 1 carat, 2.5 carat, custom"></label> <label>Ring Size<input name="ringSize" placeholder="For rings or grillz notes"></label> <label>Bracelet Size<input name="braceletSize" placeholder="Example: 7 in, 7.5 in"></label> <label>Chain Length<input name="chainLength" placeholder="Example: 18 in, 20 in, 24 in"></label> <label>Diamond Quality Selection <select name="diamondQuality"> ${quoteQualityOptions.map(item => `<option>${item}</option>`).join("")} </select> </label> <label>Budget<input name="budget" placeholder="Example: $1,500 - $5,000"></label> <label>Timeline Needed<input name="timeline" placeholder="Example: 2 weeks, 30 days, event date"></label> <label class="form-wide">Notes / Custom Details<textarea name="notes" rows="6" placeholder="Describe the piece, design details, sizing, stones, inspiration, and any custom CAD direction."></textarea></label> <label class="form-wide">Unique custom design request<textarea name="customDesignRequest" rows="5" placeholder="Use this if the normal options do not cover the design. Add links, sketches, inspiration, engraving, special stones, or exact custom details."></textarea></label> <label class="form-wide">Upload Inspiration Photos<input type="file" name="inspiration" multiple accept="image/*"></label> <button class="button button-gold form-wide" type="submit">Submit Custom Request</button> <p class="form-success" hidden></p> <p class="form-error" hidden></p> </form> `;
}
...
function selectField(name, label, options, {required: required = false} = {}) {
    return ` <label>${label} <select name="${name}" ${required ? "required" : ""}> ${options.map(item => `<option>${item}</option>`).join("")} </select> </label> `;
}

function customRingRequestForm(formId = "custom-ring-request-form") {
    return ` <form class="custom-order-form engagement-build-form ring-request-form" id="${formId}" data-request-type="Custom Engagement Ring Request" data-product-category="Engagement Rings" data-product-name="Custom engagement ring design request"> <input type="hidden" name="productName" value="Custom engagement ring design request"> <input type="hidden" name="selectedLiveDiamond"> <input type="hidden" name="selectedLiveDiamondStock"> <div class="form-wide ring-request-heading"> <p class="eyebrow">Custom engagement ring request</p> <h2>Tell us the ring direction</h2> <p>Pick what you know. Leave the rest as "not sure yet" and The Don Jewelers & Jewelry will help refine the design.</p> </div> <label>Full Name<input name="fullName" autocomplete="name" required></label> <label>Email Address<input name="email" type="email" autocomplete="email" required></label> <label>Phone Number<input name="phone" type="tel" autocomplete="tel" required></label> ${selectField("diamondType", "Diamond Type", customRingSelects.diamondType, {
        required: true
    })} ${selectField("diamondShape", "Center Diamond Shape", customRingSelects.diamondShape, {
        required: true
    })} ${selectField("caratWeight", "Diamond Size", customRingSelects.caratWeight)} ${selectField("metalType", "Metal", customRingSelects.metalType, {
        required: true
    })} ${selectField("settingStyle", "Setting Style", customRingSelects.settingStyle, {
        required: true
    })} ${selectField("headStyle", "Basket / Head / Prongs", customRingSelects.headStyle)} ${selectField("bandStyle", "Band / Shank Style", customRingSelects.bandStyle, {
        required: true
    })} ${selectField("bandProfile", "Band Profile", customRingSelects.bandProfile)} ${selectField("ringSize", "Ring Size", customRingSelects.ringSize)} ${selectField("matchingWeddingBand", "Matching Wedding Band", customRingSelects.matchingWeddingBand)} <label>Budget Range<input name="budget" placeholder="Example: $3,000 - $7,000"></label> <label>Timeline Needed<input name="timeline" placeholder="Example: 4-6 weeks, proposal date, not urgent"></label> <label class="form-wide">Design Notes<textarea name="notes" rows="5" placeholder="Example: oval lab diamond, hidden halo, thin yellow gold pave band, low basket, elegant and simple. Add any inspiration links or special details."></textarea></label> <label class="form-wide">Upload Inspiration Photos<input type="file" name="inspiration" multiple accept="image/*"></label> <button class="button button-gold form-wide" type="submit">Submit Engagement Ring Request</button> <p class="form-success" hidden></p> <p class="form-error" hidden></p> </form> `;
}

function customOrders() {
    shell(` <main> ${pageHero("Custom Design", "Message us for a custom design", `Send your name, phone number, email, and a clear description of what you are looking for. We will contact you to discuss the design, budget, timeline, and next steps.`)} ${firstCustomOrderCreditSection()} <section class="custom-form-section"> ${customRequestForm({
        formId: "custom-form",
        requestType: "Request Custom Design Form"
    })} </section> ${trustBlockSection()} ${aboutUs()} </main> `);
...
function customRingDesignPage() {
    setSeo("Start Your Custom Engagement Ring Design | The Don Jewelers", "Request a custom diamond engagement ring with The Don Jewelers & Jewelry. Choose diamond shape, diamond size, setting, basket, prongs, metal, band, shank, ring size, budget, and inspiration photos.", {
        ...
        image: "engagement-ring-feature.jpg",
        breadcrumbs: [ [ "Engagement Rings", "category/engagement-rings" ], [ "Start Your Custom Ring Design", "start-custom-ring-design" ] ],
        faqs: [ [ "Can I request a custom engagement ring without using the builder?", "Yes. Select the diamond shape, size, setting, basket, metal, band, shank, ring size, and budget, then submit the request for personal follow-up." ], [ "Can I still start with a live diamond?", "Yes. You can browse live diamonds separately and include the stock number or diamond details in your engagement ring request." ], [ "Will I receive a quote immediately?", "The Don Jewelers & Jewelry reviews the engagement ring details personally and follows up with a custom quote, sourcing options, and next steps." ] ]
    });
    shell(` <main> ${pageHero("Start Your Custom Ring Design", "Design a diamond engagement ring", "Choose the diamond shape, size, setting, basket, prongs, metal, band, shank, ring size, budget, and inspiration. Your request goes directly to The Don Jewelers & Jewelry for a personal quote.", ` <div class="hero-actions"> <a class="button button-gold" href="#custom-ring-request-form">Start Engagement Ring Request</a> <a class="button button-light" href="${internalLink("select-diamond")}">Start With Live Diamond</a> </div> `)} ${firstCustomOrderCreditSection()} <section class="builder-choice-section"> <div class="builder-choice-grid"> <article class="builder-choice-card"><strong>Diamond</strong><p>Choose lab-grown or natural, shape, size, and any live diamond stock number you already like.</p></article> <article class="builder-choice-card"><strong>Ring design</strong><p>Select setting, basket, prongs, metal, band style, shank profile, ring size, and matching band direction.</p></article> <article class="builder-choice-card"><strong>Quote details</strong><p>Add budget, timeline, notes, and inspiration photos so the quote can match the ring you want.</p></article> </div> </section> <section class="custom-form-section"> ${customRingRequestForm("custom-ring-request-form")} </section> ${trustBlockSection()} ${officialGoogleProfileSection()} </main> `);
...
function ringSizeGuidePage() {
    ...
    shell(` <main> ${pageHero("Ring Size Guide", "Measure before you build", "Use this as a planning guide before your final consultation. Exact ring size should be confirmed before CAD approval, casting, setting, or shipment.", ` <div class="hero-actions"> <a class="button button-gold" href="#/start-custom-ring-design">Start Custom Ring Design</a> <a class="button button-light" href="${appointmentUrl}">Book Appointment</a> </div> `)} <section class="guide-table-section"> <div class="section-heading"> <p class="eyebrow">Quick Sizing</p> <h2>Common US ring size reference</h2> </div> <div class="guide-table"> ${[ [ "US 4", "46.8 mm", "Small finger / pinky range" ], [ "US 5", "49.3 mm", "Common smaller engagement size" ], [ "US 6", "51.9 mm", "Common engagement ring range" ], [ "US 7", "54.4 mm", "Common engagement ring range" ], [ "US 8", "57.0 mm", "Larger engagement / smaller men's range" ], [ "US 9", "59.5 mm", "Common men's ring range" ], [ "US 10", "62.1 mm", "Common men's ring range" ], [ "US 11", "64.6 mm", "Larger men's ring range" ] ].map(([size, circumference, note]) => `<div><strong>${size}</strong><span>${circumference}</span><p>${note}</p></div>`).join("")} </div> </section> <section class="builder-choice-section"> <div class="builder-choice-grid"> <article class="builder-choice-card"><strong>Best method</strong><p>Have the finger sized professionally, especially for engagement rings, wide bands, eternity bands, and expensive custom settings.</p></article> <article class="builder-choice-card"><strong>Measure at the right time</strong><p>Finger size changes with heat, cold, salt, and time of day. Measure when hands are normal, not swollen or cold.</p></article> <article class="builder-choice-card"><strong>Account for width</strong><p>Wider bands often feel tighter. Thin solitaire bands and wide men's bands may not fit the same at the same size.</p></article> <article class="builder-choice-card"><strong>Confirm before production</strong><p>Custom work should not move to final approval until spelling, stone, metal, and ring size are confirmed.</p></article> </div> </section> ${trustBlockSection()} </main> `);
}
...
function diamondShapeGuidePage() {
    ...
    const shapes = [ [ "Round", "Maximum classic sparkle; easiest shape for strict cut-grade comparison.", "Best for timeless solitaires, pave bands, and buyers who want the brightest traditional look." ], [ "Oval", "Elongated shape that looks large for its carat weight.", "Best for finger coverage, modern bridal looks, hidden halos, and yellow gold settings." ], [ "Emerald", "Step-cut shape with clean flashes instead of crushed sparkle.", "Best for elegant, quiet luxury settings; clarity should be higher because inclusions show more." ], [ "Radiant", "Brilliant faceting with rectangular or square outline.", "Best for buyers who like emerald shape but want more sparkle." ], [ "Marquise", "Long pointed shape with dramatic finger presence.", "Best for statement rings, vintage influence, and maximum visual size." ], [ "Pear", "Teardrop shape that can face up large and feel romantic.", "Best for solitaire, halo, and east-west custom designs." ], [ "Cushion", "Soft square/rectangular shape with romantic corners.", "Best for vintage, halo, and soft modern settings." ], [ "Princess", "Square brilliant style with sharp corners.", "Best for clean geometric settings and modern solitaire designs." ], [ "Asscher", "Square step-cut with a hall-of-mirrors look.", "Best for Art Deco, vintage, and high-clarity stones." ] ];
    shell(` <main> ${pageHero("Diamond Shape Guide", "Choose the shape before the setting", "Shape controls the personality of the ring. Use this guide to narrow the look, then choose from live diamonds or request sourcing.", ` <div class="hero-actions"> <a class="button button-gold" href="#/select-diamond?return=shape-guide">Choose Live Diamond</a> <a class="button button-light" href="#/start-custom-ring-design">Start Custom Ring Design</a> </div> `)} <section class="shape-guide-grid"> ${shapes.map(([shape, summary, best]) => ` <article> <strong>${shape}</strong> <p>${summary}</p> <span>${best}</span> <a href="#/select-diamond?shape=${encodeURIComponent(shape)}&return=shape-guide">Shop ${shape} Diamonds</a> </article> `).join("")} </section> ${trustBlockSection()} </main> `);
}
...
function labNaturalComparisonPage() {
    ...
    shell(` <main> ${pageHero("Diamond Comparison", "Lab diamonds vs natural diamonds", "Both can look beautiful in an engagement ring. The right choice depends on budget, origin preference, size goals, certification, and the story you want behind the piece.", ` <div class="hero-actions"> <a class="button button-gold" href="#/select-diamond?type=lab&return=lab-natural-guide">Shop Lab Diamonds</a> <a class="button button-light" href="#/request/contact?intent=natural-diamond-search">Request Natural Diamond Search</a> </div> `)} <section class="comparison-table-section"> <div class="comparison-table"> ${[ [ "Origin", "Grown in a controlled lab environment", "Formed naturally underground" ], [ "Appearance", "Can look identical to natural at comparable quality", "Can look identical to lab at comparable quality" ], [ "Budget", "Usually allows larger size, color, or clarity for the money", "Usually costs more at the same specs" ], [ "Certification", "Often IGI; some GIA options available", "Often GIA or IGI" ], [ "Best For", "Maximum size, modern value, visual impact", "Natural rarity, tradition, origin story" ], [ "Resale", "Typically weaker resale market", "Typically stronger but still not guaranteed" ] ].map(([factor, lab, natural]) => ` <div class="comparison-row"> <strong>${factor}</strong> <p><b>Lab:</b> ${lab}</p> <p><b>Natural:</b> ${natural}</p> </div> `).join("")} </div> </section> ${trustBlockSection()} </main> `);
}
...
function appointmentRequestForm(formId = "appointment-request-form") {
    return ` <form class="custom-order-form engagement-build-form ring-request-form" id="${formId}" data-request-type="Appointment Request" data-product-category="Appointment" data-product-name="Private jewelry appointment"> <input type="hidden" name="productName" value="Private jewelry appointment"> <div class="form-wide ring-request-heading"> <p class="eyebrow">Private appointment</p> <h2>Book a jewelry consultation</h2> <p>Send your contact information, what you want to discuss, and the best time to reach you.</p> </div> <label>Full Name<input name="fullName" autocomplete="name" required></label> <label>Email Address<input name="email" type="email" autocomplete="email" required></label> <label>Phone Number<input name="phone" type="tel" autocomplete="tel" required></label> <label>Appointment Type <select name="settingStyle" required> <option>Engagement ring consultation</option> <option>Live diamond sourcing</option> <option>Custom jewelry consultation</option> <option>Product or checkout help</option> <option>Repair / sizing question</option> </select> </label> <label>Preferred Day / Time<input name="timeline" placeholder="Example: Saturday afternoon, weekday evening, ASAP"></label> <label>Budget Range<input name="budget" placeholder="Optional: $3,000 - $7,000"></label> <label class="form-wide">Appointment Notes<textarea name="notes" rows="5" placeholder="Tell us what you want to look at or discuss. Add ring style, diamond shape, product names, order questions, or any urgent timing."></textarea></label> <label class="form-wide">Upload Inspiration Photos<input type="file" name="inspiration" multiple accept="image/*"></label> <button class="button button-gold form-wide" type="submit">Submit Appointment Request</button> <p class="form-success" hidden></p> <p class="form-error" hidden></p> </form> `;
}
...
function customRequestPage(slug, params = new URLSearchParams) {
    ...
    })} </section> ${officialGoogleProfileSection()} ${aboutUs()} </main> `);
...
function adminDashboard() {
    shell(` <main> ${pageHero("Admin Dashboard", "Customer request notifications", "New quote requests, customer names, categories, and submission dates appear here after customers submit forms.")} <section class="admin-dashboard-section"> <div class="admin-toolbar"> <strong>Website request system</strong> <button class="button button-dark" id="refresh-admin-requests" type="button">Refresh</button> </div> <div id="admin-request-list" class="admin-request-list"> <div class="empty-state">Loading requests...</div> </div> </section> <section class="admin-dashboard-section"> <div class="admin-toolbar"> <strong>Official profile and conversion settings</strong> <button class="button button-dark" id="refresh-site-system-status" type="button">Check Status</button> </div> <div class="admin-request-list"> <article class="admin-request-card"> <div> <p class="eyebrow">Google Business Profile</p> <h2>One official profile link</h2> <p class="lede">${googleBusinessProfileUrl}</p> </div> <div class="builder-actions"> <a class="button button-gold" href="${googleBusinessProfileUrl}" target="_blank" rel="noopener noreferrer">Find us on Google</a> <a class="button button-light" href="${googleReviewUrl}" target="_blank" rel="noopener noreferrer">Open Reviews</a> <a class="button button-dark" href="/api/merchant-feed" target="_blank" rel="noopener noreferrer">Merchant Feed</a> </div> </article> </div> <div id="site-system-status" class="admin-request-list"> <div class="empty-state">Checking email, checkout, database, and sync readiness...</div> </div> </section> <section class="admin-dashboard-section"> <div class="admin-toolbar"> <strong>Lead Recovery</strong> <div class="builder-actions"> <button class="button button-dark" id="refresh-lead-recovery" type="button">Refresh Leads</button> </div> </div> <label class="admin-secret-field">Admin recovery key <input id="admin-lead-key" type="password" autocomplete="current-password" placeholder="Enter ADMIN_SYNC_SECRET or CRON_SECRET"> </label> <div id="admin-lead-recovery-list" class="admin-request-list"> <div class="empty-state">Enter admin key, then refresh lead recovery.</div> </div> </section> <section class="admin-dashboard-section"> <div class="admin-toolbar"> <strong>SEO & Analytics</strong> <button class="button button-dark" id="refresh-seo-dashboard" type="button">Refresh SEO Status</button> </div> <div id="admin-seo-dashboard" class="admin-request-list"> <div class="empty-state">Enter the admin recovery key to load secure SEO and conversion status.</div> </div> </section> <section class="admin-dashboard-section"> <div class="admin-toolbar"> <strong>Diamond API readiness</strong> <button class="button button-dark" id="refresh-diamond-api-status" type="button">Check Diamond API</button> </div> <div id="diamond-api-status" class="admin-request-list"> <div class="empty-state">Checking diamond API status...</div> </div> </section> <section class="admin-dashboard-section"> <div class="admin-toolbar"> <strong>Saved jewelry database sync</strong> <button class="button button-gold" id="run-jewelry-sync" type="button">Refresh API Products Now</button> </div> <label class="admin-secret-field">Admin sync key <input id="admin-sync-key" type="password" autocomplete="current-password" placeholder="Enter the configured admin sync key"> </label> <div id="jewelry-sync-status" class="admin-request-list"> <div class="empty-state">Loading latest sync status...</div> </div> </section> <section class="admin-dashboard-section"> <div class="admin-toolbar"> <strong>Product photo import drafts</strong> <div class="builder-actions"> <button class="button button-gold" id="scan-product-photos" type="button">Scan Product Photos</button> <button class="button button-dark" id="refresh-product-drafts" type="button">Refresh Drafts</button> </div> </div> <p class="lede admin-helper">Add product photos to the project root, then scan. Drafts stay private until approved.</p> <div id="admin-product-drafts" class="admin-product-grid"> <div class="empty-state">Loading product drafts...</div> </div> </section> <section class="admin-dashboard-section"> <div class="admin-toolbar"> <strong>Approved imported products</strong> <button class="button button-dark" id="refresh-approved-products" type="button">Refresh Products</button> </div> <div id="admin-approved-products" class="admin-product-grid"> <div class="empty-state">Loading approved products...</div> </div> </section> ${aboutUs()} </main> `);
    const escapeField = value => String(value || "").replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
    const productEditor = (product, action, label) => ` <article class="admin-product-card" data-id="${product.id}"> <img src="${productImageSrc(product)}" alt="${product.alt || product.name}"> <div class="admin-product-fields"> <label>Product title<input data-field="name" value="${escapeField(product.name)}"></label> <label>Category<select data-field="category">${importCategories.map(category => `<option ${category === product.category ? "selected" : ""}>${category}</option>`).join("")}</select></label> <label>Short luxury description<textarea data-field="shortDescription" rows="3">${escapeField(product.shortDescription)}</textarea></label> <label>Specs / options<textarea data-field="specs" rows="4">${escapeField(product.specs)}</textarea></label> <label>Tags<input data-field="tags" value="${escapeField((product.tags || []).join(", "))}"></label> <label>Price table or Request Pricing<input data-field="priceLabel" value="${escapeField(product.priceLabel || "Request Pricing")}"></label> <div class="builder-actions"> <button class="button button-gold" type="button" data-action="${action}">${label}</button> <button class="button button-light" type="button" data-action="${action === "approve" ? "delete-draft" : "delete-product"}">Delete</button> </div> </div> </article> `;
    const render = async () => {
        ...
        host.innerHTML = requests.length ? requests.map(request => ` <article class="admin-request-card"> <div> <p class="eyebrow">New request alert</p> <h2>${request.customer.fullName || "Unknown customer"}</h2> <p class="lede">${request.jewelry.productCategory || request.jewelry.requestType}</p> </div> <dl class="summary-list"> <div><dt>Date submitted</dt><dd>${new Date(request.createdAt).toLocaleString()}</dd></div> <div><dt>Email</dt><dd>${request.customer.email}</dd></div> <div><dt>Phone</dt><dd>${request.customer.phone}</dd></div> <div><dt>Budget</dt><dd>${request.jewelry.budget || "Not provided"}</dd></div> <div><dt>Status</dt><dd>Saved in browser preview</dd></div> </dl> <p class="quote-note">${request.jewelry.notes || "No notes provided."}</p> </article> `).join("") : `<div class="empty-state">No customer requests saved yet.</div>`;
    };
    const renderSiteSystemStatus = async () => {
        ...
        try {
            const response = await fetchWithTimeout("/api/system-status", {}, 15e3);
            const status = await response.json();
            if (!response.ok || !status.ok) throw new Error(status.message || "Could not load system status.");
            const rows = [ [ "Resend email", status.resendConfigured ? "Configured" : "Missing RESEND_API_KEY" ], [ "Business inbox", status.resendBusinessEmail || contactEmail ], [ "Checkout API", status.stripeConfigured ? "Dynamic Stripe Checkout configured" : "Payment link fallback active" ], [ "Stripe webhook", status.stripeWebhookConfigured ? "Configured" : "Not configured" ], [ "Lead recovery database", status.leadRecoveryConfigured ? "Configured" : "Not configured" ], [ "Admin recovery key", status.adminSyncConfigured || status.cronConfigured ? "Configured" : "Not configured" ], [ "Live diamond API", status.lgdConfigured ? "Configured" : "Not configured" ] ];
            host.innerHTML = ` <article class="admin-request-card"> <div> <p class="eyebrow">Production readiness</p> <h2>${status.resendConfigured ? "Email is active" : "Email needs attention"}</h2> <p class="lede">Checkout currently uses ${status.stripeConfigured ? "dynamic Stripe Checkout" : "the Stripe payment-link fallback"}.</p> </div> <dl class="summary-list"> ${rows.map(([label, value]) => `<div><dt>${htmlSafe(label)}</dt><dd>${htmlSafe(value)}</dd></div>`).join("")} </dl> </article> `;
        } catch (error) {
    ...
    const renderLeadRecovery = async () => {
        ...
        try {
            ...
            host.innerHTML = payload.leads.length ? payload.leads.map(lead => ` <article class="admin-request-card" data-lead-id="${htmlSafe(lead.publicId)}"> <div> <p class="eyebrow">${htmlSafe(lead.type || "Website Lead")}</p> <h2>${htmlSafe(lead.customer?.fullName || lead.customer?.name || "Unknown customer")}</h2> <p class="lede">${htmlSafe(lead.source || lead.jewelry?.productCategory || "Website submission")}</p> </div> <dl class="summary-list"> <div><dt>Submitted</dt><dd>${new Date(lead.createdAt).toLocaleString()}</dd></div> <div><dt>Email</dt><dd>${htmlSafe(lead.customer?.email || "Not provided")}</dd></div> <div><dt>Phone</dt><dd>${htmlSafe(lead.customer?.phone || "Not provided")}</dd></div> <div><dt>Business email</dt><dd>${htmlSafe(lead.businessEmailStatus)}</dd></div> <div><dt>Customer email</dt><dd>${htmlSafe(lead.customerEmailStatus)}</dd></div> <div><dt>Status</dt><dd>${htmlSafe(lead.status)}</dd></div> <div><dt>Stripe</dt><dd>${htmlSafe(lead.stripeStatus || lead.checkout?.status || "N/A")}</dd></div> </dl> ${lead.lastError ? `<p class="form-error">${htmlSafe(lead.lastError)}</p>` : ""} <p class="quote-note">${htmlSafe(lead.jewelry?.notes || lead.jewelry?.productName || "No notes provided.")}</p> <div class="builder-actions"> <button class="button button-gold" type="button" data-retry-lead="${htmlSafe(lead.publicId)}">Retry Email</button> </div> </article> `).join("") : `<div class="empty-state">No saved leads found.</div>`;
        } catch (error) {
    ...
    const renderSeoDashboard = async () => {
        ...
        try {
            const response = await fetchWithTimeout("/api/admin/seo-dashboard", {
                headers: {
                    "x-admin-key": key
                }
            }, 2e4);
            ...
            host.innerHTML = ` <article class="admin-request-card"> <div><p class="eyebrow">Tracking readiness</p><h2>${integrations.ga4Configured ? "GA4 configured" : "GA4 setup required"}</h2><p class="lede">${htmlSafe(payload.googleDataMessage)}</p></div> <dl class="summary-list"> <div><dt>Search Console verification</dt><dd>${integrations.searchConsoleVerificationConfigured ? "Configured" : "Use existing verification or add env token"}</dd></div> <div><dt>Google reporting APIs</dt><dd>${integrations.analyticsApiConfigured || integrations.searchConsoleApiConfigured ? "Connected" : "Not connected"}</dd></div> <div><dt>Lead records sampled</dt><dd>${Number(conversions.availableLeadSample || 0)}</dd></div> <div><dt>Quote/custom requests</dt><dd>${Number(conversions.quoteSubmissions || 0)}</dd></div> <div><dt>Appointment requests</dt><dd>${Number(conversions.appointmentRequests || 0)}</dd></div> <div><dt>Checkout starts</dt><dd>${Number(conversions.checkoutStarts || 0)}</dd></div> <div><dt>Completed purchases</dt><dd>${Number(conversions.purchases || 0)}</dd></div> <div><dt>Organic search clicks (28 days)</dt><dd>${search.clicks === undefined ? "API not connected" : Number(search.clicks)}</dd></div> <div><dt>Search impressions (28 days)</dt><dd>${search.impressions === undefined ? "API not connected" : Number(search.impressions)}</dd></div> <div><dt>Average search position</dt><dd>${search.position === undefined ? "API not connected" : Number(search.position).toFixed(1)}</dd></div> <div><dt>GA4 sessions (28 days)</dt><dd>${ga.current ? Number(ga.current.sessions || 0) : "API not connected"}</dd></div> <div><dt>Session change vs prior 28 days</dt><dd>${ga.current ? change(Number(ga.current.sessions || 0), Number(ga.previous?.sessions || 0)) : "API not connected"}</dd></div> <div><dt>GA4 key events (28 days)</dt><dd>${ga.current ? Number(ga.current.keyEvents || 0) : "API not connected"}</dd></div> </dl> ${Array.isArray(search.topQueries) && search.topQueries.length ? `<div class="admin-query-list"><strong>Top Search Queries</strong>${search.topQueries.map(row => `<p>${htmlSafe(row.key)}: ${Number(row.clicks)} clicks, ${Number(row.impressions)} impressions, position ${Number(row.position).toFixed(1)}</p>`).join("")}</div>` : ""} <div class="builder-actions"><a class="button button-light" href="${payload.sitemapUrl}" target="_blank" rel="noopener">Open Sitemap</a><a class="button button-light" href="${payload.robotsUrl}" target="_blank" rel="noopener">Open Robots</a></div> </article>`;
        } catch (error) {
    ...
    const renderDiamondApiStatus = async () => {
        ...
        host.innerHTML = ` <article class="admin-request-card"> <div> <p class="eyebrow">Website Status</p> <h2>Inventory display ready</h2> <p class="lede">The website is ready for production data and policy-supported checkout review.</p> </div> <dl class="summary-list"> <div><dt>Status</dt><dd>Visual preview active</dd></div> <div><dt>Products</dt><dd>${allProducts().length}</dd></div> <div><dt>Diamond records</dt><dd>${liveDiamondInventory.length}</dd></div> </dl> <p class="quote-note">Confirm live inventory and payment processor settings before going live.</p> </article> `;
    };
    const renderJewelrySyncStatus = async () => {
        ...
        try {
            ...
            host.innerHTML = sync ? ` <article class="admin-request-card"> <div><p class="eyebrow">Latest supplier jewelry sync</p><h2>${htmlSafe(sync.status)}</h2></div> <dl class="summary-list"> <div><dt>Last sync</dt><dd>${new Date(sync.completed_at || sync.started_at).toLocaleString()}</dd></div> <div><dt>Added</dt><dd>${sync.added_count}</dd></div> <div><dt>Updated</dt><dd>${sync.updated_count}</dd></div> <div><dt>Hidden / unavailable</dt><dd>${sync.hidden_count}</dd></div> <div><dt>Failed</dt><dd>${sync.failed_count}</dd></div> </dl> ${(sync.errors || []).length ? `<pre class="admin-sync-errors">${htmlSafe(JSON.stringify(sync.errors, null, 2))}</pre>` : `<p class="quote-note">No sync errors recorded.</p>`} </article> ` : `<div class="empty-state">${payload.configured === false ? "DATABASE_URL must be configured before the first sync." : "No jewelry sync has run yet."}</div>`;
        } catch (error) {
    ...
    document.getElementById("admin-lead-recovery-list").addEventListener("click", async event => {
        ...
        try {
            const response = await fetchWithTimeout("/api/admin/lead-recovery", {
                ...
                body: JSON.stringify({
                    leadId: button.dataset.retryLead
                })
            }, 3e4);
            const payload = await response.json();
...
function cartPage() {
    ...
    shell(` <main> ${pageHero("Cart", "Your saved custom jewelry")} <section class="cart-layout"> <div class="cart-list"> ${cart.length ? cart.map((item, index) => ` <article class="cart-item"> <img src="${cartImageSrc(item)}" alt=""> <div><h3>${item.name}</h3><p class="muted">${Object.entries(item.selections).map(([k, v]) => `${k}: ${v}`).join(" | ")}</p></div> <strong>${item.pricingNote || money.format(numericPrice(item.price) * Math.max(1, Number(item.quantity || 1)))}</strong> <div class="quantity-controls" aria-label="Quantity controls"> <button class="icon-button" type="button" data-quantity="${index}" data-step="-1">-</button> <span>Qty ${Math.max(1, Number(item.quantity || 1))}</span> <button class="icon-button" type="button" data-quantity="${index}" data-step="1">+</button> </div> <button class="icon-button" type="button" data-remove="${index}">Remove</button> </article>`).join("") : `<div class="empty-state">Your cart is empty. Start with a custom jewelry piece.</div>`} </div> <aside class="summary-panel"> <p class="eyebrow">Cart Summary</p> <div class="price-row"><span>Total</span><strong>${money.format(total)}</strong></div> ${payableItems.length ? stripePayButton(payableTotal) : ""} <a class="button button-gold" href="${cart.length ? "#/checkout" : "#/products"}">${cart.length ? "Checkout" : "Shop Now"}</a> </aside> </section> ${aboutUs()} </main> `);
...
function checkout() {
    ...
    const payableItems = payableCartItems();
    const payableTotal = cartTotal(payableItems);
    const cartSummary = cart.length ? cart.map(item => `${item.name} - ${item.pricingNote || money.format(item.price)} - ${Object.entries(item.selections || {}).map(([key, value]) => `${key}: ${value}`).join(" | ")}`).join("\n") : "No saved cart items. Customer is requesting checkout/contact support.";
    shell(` <main> ${pageHero("Checkout", "Submit your jewelry inquiry", "Send your saved items and contact details so The Don Jewelers & Jewelry can confirm pricing, availability, deposit, and next steps.")} <section class="cart-layout"> <div class="cart-list"> ${cart.length ? cart.map(item => ` <article class="cart-item"> <img src="${cartImageSrc(item)}" alt=""> <div><h3>${item.name}</h3><p class="muted">${Object.entries(item.selections || {}).map(([key, value]) => `${key}: ${value}`).join(" | ")}</p></div> <strong>${item.pricingNote || money.format(item.price)}</strong> </article> `).join("") : `<div class="empty-state">No saved items yet. Submit the form below for direct checkout and quote support.</div>`} </div> <aside class="summary-panel"> <p class="eyebrow">Checkout Summary</p> <div class="price-row"><span>Estimated total</span><strong>${cart.length ? money.format(total) : "Request Pricing"}</strong></div> ${payableItems.length ? stripePayButton(payableTotal) : ""} <p class="quote-note">Final pricing is confirmed after review of metal, stone availability, sizing, and custom details.</p> <div class="checkout-policy-support"> <strong>Before payment or deposit</strong> <p>Review the policies below for returns, custom orders, shipping, payments, financing, warranty, privacy, and terms.</p> ${policyLinksHtml()} </div> </aside> </section> <section class="custom-form-section"> ${customRequestForm({
        formId: "checkout-form",
        requestType: "Product Inquiry Form",
        productCategory: "Checkout / Cart Inquiry",
        productName: "Website checkout inquiry"
    })} </section> ${aboutUs()} </main> `);
...
async function verifyAndTrackPurchase() {
    ...
    try {
        const response = await fetchWithTimeout(`/api/checkout-session-status?session_id=${encodeURIComponent(sessionId)}`, {
            headers: {
                Accept: "application/json"
            }
        }, 1e4);
        ...
        console.warn("Purchase analytics verification failed", {
...
const policyPages = {
    "refund-return-policy": {
        ...
        sections: [ [ "Ready-Made Jewelry", "Ready-made, non-custom jewelry may be eligible for an approved return when it is unworn, undamaged, unaltered, and returned with its original packaging and documentation. Contact The Don Jewelers & Jewelry within 7 calendar days of delivery for authorization. Eligibility is confirmed in writing before anything is shipped back." ], [ "Custom and Final Sale Items", "Custom jewelry, made-to-order items, resized items, engraved items, special orders, loose diamonds, watches, and any item identified as final sale are not returnable or exchangeable unless The Don Jewelers & Jewelry explicitly agrees otherwise in writing or a remedy is required by law." ], [ "Damage, Incorrect Items, and Workmanship", "Report a damaged shipment, incorrect item, or suspected workmanship issue promptly and no later than 48 hours after delivery when reasonably possible. Include the order number, packaging photos, and clear item photos. After inspection, an approved remedy may be repair, replacement, store credit, or refund, depending on the issue and applicable law." ], [ "Deposits", "Deposits may be non-refundable once sourcing, CAD design, production, consultation work, or other custom work has started. Deposits may be applied toward the approved order according to the order agreement." ], [ "Refund Method and Timing", "Approved refunds are issued back to the original payment method only. Refund processing may take 5 to 10 business days after approval, and additional timing may depend on the card issuer or payment processor." ], [ "Non-Refundable Fees", "Shipping fees, rush fees, CAD fees, appraisal fees, sizing fees, and financing fees are non-refundable unless otherwise required by applicable law." ], [ "Return Approval Required", "Customers must contact us before sending anything back. Returns without approval may be refused, returned to sender, or delayed. Chargebacks made without contacting us first may delay resolution because we need order records, photos, and communication history to review the issue." ] ]
    },
    "payment-policy": {
        ...
        sections: [ [ "Accepted Payments", "We accept major credit and debit cards and approved payment processors. Available payment methods may depend on order type, location, payment amount, and processor approval." ], [ "Payment Before Release", "Full payment is required before shipping, pickup, delivery, or release of any jewelry. Custom orders may require a deposit before work begins, and the remaining balance must be paid before delivery or pickup." ], [ "Cleared Payments", "Orders are not confirmed until payment clears. Payment verification may be required for high-value jewelry, custom work, diamonds, watches, or suspicious transactions." ], [ "Billing Verification", "Billing and shipping information must match when required by the payment processor, fraud tools, or our internal review. Fraud prevention checks may delay processing." ], [ "Order Review", "The Don Jewelers & Jewelry reserves the right to cancel suspicious, unverifiable, high-risk, abusive, or policy-violating orders. If an order is canceled, eligible payments will be handled through the original payment method." ] ]
    },
    "shipping-policy": {
        ...
        sections: [ [ "Insured and Tracked Shipping", "Every shipment is insured and includes tracking. Adult signature or direct signature may be required for high-value jewelry, diamonds, watches, and custom pieces." ], [ "When Custom Orders Ship", "Custom and made-to-order pieces ship only after production is complete, final quality control is passed, the delivery information is verified, and the remaining balance has cleared." ], [ "Delivery Service Options", "Customers may choose ground, two-day, expedited, or overnight shipping when the destination and carrier permit it. Available services, estimated delivery timing, and the shipping price are confirmed before shipment. Rush shipping changes transit time only and does not shorten production unless a separate rush-production agreement is approved." ], [ "Carrier Delays", "We are not responsible for delays caused by shipping carriers, weather, incorrect addresses, security holds, customs processes when applicable, or missed delivery attempts." ], [ "Address Accuracy", "Customers are responsible for providing a complete and accurate shipping address. Address changes may require identity or payment verification before shipment." ], [ "Delivery Inspection", "Customers must inspect the package upon delivery. Any shipping issue, damaged package, missing package, or delivery concern must be reported immediately so we can review the shipment and insurance process." ] ]
    },
    "custom-order-policy": {
        ...
        sections: [ [ "Made for the Client", "Custom orders are made specifically for the client. They may include engagement rings, diamond jewelry, pendants, bracelets, earrings, watches, nameplates, grillz, or other private jeweler projects." ], [ "CAD and Design Approval", "CAD or design approval is required before production when applicable. Once the client approves CAD, design direction, stone details, spelling, sizing, or layout, changes may cost extra and may extend the timeline." ], [ "Timeline", "Production timeline is usually 7 to 21 business days depending on complexity. Delays may happen due to diamond sourcing, casting, setting, polishing, certification, shipping, holidays, vendor schedules, or requested changes." ], [ "Final Sale", "Custom orders are final sale once production starts, except for a verified workmanship issue. Deposits may be non-refundable once design, sourcing, or production work has started." ], [ "Client Responsibility", "The client is responsible for confirming spelling, ring size, metal color, stone size, stone type, design details, and delivery information before approval. The Don Jewelers & Jewelry is not responsible for errors approved by the client." ] ]
    },
    "warranty-policy": {
        ...
        sections: [ [ "Covered Issues", "Warranty coverage applies to verified manufacturing defects only. Warranty review may require photos, inspection, order records, and reasonable time to evaluate the piece." ], [ "Not Covered", "Warranty does not cover normal wear, accidental damage, missing stones from impact, bent prongs, broken chains, resizing by another jeweler, unauthorized repairs, loss, theft, misuse, neglect, or damage from improper wear." ], [ "Jewelry Care", "Jewelry should be inspected regularly. Customers should avoid chemicals, hard impact, heavy lifting, sports, sleeping with fine jewelry, showering with fine jewelry, and activities that can bend prongs, weaken chains, or loosen stones." ], [ "Repairs", "Repairs outside warranty may be available for a fee. Any repair by another jeweler or unauthorized service provider may void warranty review for the affected area." ] ]
    },
    terms: {
        ...
        sections: [ [ "Policy Agreement", "Customers agree to all policies before purchasing, placing a deposit, approving CAD, requesting shipping, or submitting custom order details." ], [ "Product Photos and Natural Variation", "Product photos may vary slightly due to lighting, screen settings, photography, and natural variations. Diamond and gemstone weights may be approximate unless certified by a grading report or written order document." ], [ "Appraisals and Market Values", "Appraisals are estimates and may vary by market, appraiser, date, metal market, gemstone availability, and resale conditions. Appraisals are not a guarantee of resale value." ], [ "Pricing and Availability", "Prices may change based on metal market, diamond availability, gemstone availability, labor, custom requirements, vendor pricing, and order complexity. Errors in pricing, product information, or availability may be corrected." ], [ "Order Refusal or Cancellation", "The Don Jewelers & Jewelry may refuse or cancel orders for fraud, abuse, payment issues, unverifiable identity, chargeback risk, policy violations, or unavailable materials." ], [ "Dispute Resolution", "Any disputes should first be handled by contacting The Don Jewelers & Jewelry directly at the phone number or email listed on this website. Direct communication helps resolve order questions, shipping issues, payment concerns, and misunderstandings faster than third-party disputes." ], [ "Protective Purpose", "These policies are written to help protect customers and the business against fraud, chargebacks, payment abuse, shipping issues, unclear custom approvals, and misunderstandings." ] ]
    },
    "privacy-policy": {
        ...
        sections: [ [ "Information We Collect", "We collect customer information needed to process orders, appointments, shipping, payments, fraud checks, custom requests, and communication. This may include name, phone number, email, shipping address, billing information, order details, design notes, ring size, uploaded inspiration images, and communication history." ], [ "Payment Information", "Payment details are processed securely by third-party payment processors. The Don Jewelers & Jewelry does not sell customer payment information." ], [ "How Information Is Used", "Customer information may be used to provide quotes, confirm custom details, process payments, arrange insured shipping, communicate about orders, review fraud risk, handle support, and maintain order records." ], [ "Sharing Information", "We do not sell customer personal information. Customer information may be shared only with payment processors, shipping carriers, financing providers, fraud prevention tools, insurers, professional service providers, or service providers needed to complete the order or operate the website." ], [ "Customer Contact", "By submitting a form, placing an order, or contacting us, customers authorize The Don Jewelers & Jewelry to respond by phone, text, or email about the inquiry or order." ] ]
    },
    "financing-policy": {
        ...
        sections: [ [ "Third-Party Providers", "Financing is handled by third-party providers such as Affirm, Klarna, Afterpay, or other approved partners when available. The providers control application review, approval, terms, interest, payment schedule, fees, and account servicing." ], [ "No Guaranteed Approval", "The Don Jewelers & Jewelry does not guarantee financing approval. Financing availability may depend on provider rules, customer eligibility, purchase amount, location, and order type." ], [ "Customer Responsibility", "Customers remain responsible for any financing agreement they enter with a provider. Questions about payments, late fees, interest, credit reporting, or financing account terms should be directed to the financing provider." ], [ "Refunds on Financed Orders", "Refunds on financed orders are handled according to the financing provider's rules and timeline. Approval of a return or refund by The Don Jewelers & Jewelry does not automatically cancel a customer's financing obligations unless processed and confirmed through the provider." ] ]
    }
};
...
function policyPage(path) {
    ...
    shell(` <main> ${pageHero("Policy", policy.title, policy.intro, `<button class="button button-gold" id="print-terms" type="button">Print / Save Policy</button>`)} <section class="terms-viewer-section"> <article class="terms-document policy-document"> <p class="terms-intro">${policy.intro}</p> <dl class="summary-list policy-business-card"> <div><dt>Business</dt><dd>${businessName}</dd></div> <div><dt>Phone</dt><dd><a href="${phoneHref}">${phoneDisplay}</a></dd></div> <div><dt>Email</dt><dd><a href="mailto:${contactEmail}">${contactEmail}</a></dd></div> <div><dt>Service Area</dt><dd>${serviceArea}</dd></div> </dl> ${policy.sections.map(([heading, body]) => `<h2>${heading}</h2><p>${body}</p>`).join("")} <h2>Questions Before Purchase</h2> <p>Please contact ${businessName} before purchasing, returning, disputing, or approving a custom order if anything is unclear. We want every customer to understand the order, payment, delivery, and custom approval process before moving forward.</p> ${policyLinksHtml()} </article> </section> </main> `);
...
function router() {
    ...
    if (parts[0] === "diamonds" && parts[1]) return diamondInventoryPage(new URLSearchParams({
...
function clientNotFoundPage() {
    ...
    setSeo(`Page Not Found | ${businessName}`, "The requested page could not be found.", {
        path: currentRoutePath()
    });
    upsertMeta('meta[name="robots"]', "name", "robots", "noindex,follow");
    shell(` <main> ${pageHero("404", "Page not found", "The page may have moved or the address may be incorrect.", `<div class="hero-actions"><a class="button button-gold" href="/products">Browse Jewelry</a><a class="button button-dark" href="/start-custom-ring-design">Start Custom Ring Design</a><a class="button button-light" href="/">Return Home</a></div>`)} </main> `);
}
...
document.addEventListener("click", event => {
    ...
    if (href.startsWith("tel:")) trackEvent("phone_click", {
        link_location: currentRoutePath()
    });
    if (href.startsWith("mailto:")) trackEvent("email_click", {
        link_location: currentRoutePath()
    });
    if (/instagram\.com|facebook\.com|share\.google/i.test(href)) trackEvent("social_click", {
        social_network: /instagram/i.test(href) ? "instagram" : /facebook/i.test(href) ? "facebook" : "google_business_profile"
    });
    if (/financ|klarna|affirm|afterpay|acima/i.test(href + " " + (link.textContent || ""))) trackEvent("financing_option_click", {
        option_name: (link.textContent || "financing").trim().slice(0, 60)
    });
