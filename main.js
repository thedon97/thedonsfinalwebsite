...
const policyPages = {
  ...
  "shipping-policy": {
    ...
    sections: [
      ["Insured and Tracked Shipping", "Every shipment is insured and includes tracking. Adult signature or direct signature may be required for high-value jewelry, diamonds, watches, and custom pieces."],
      ["When Custom Orders Ship", "Custom and made-to-order pieces ship only after production is complete, final quality control is passed, the delivery information is verified, and the remaining balance has cleared."],
      ["Delivery Service Options", "Customers may choose ground, two-day, expedited, or overnight shipping when the destination and carrier permit it. Available services, estimated delivery timing, and the shipping price are confirmed before shipment. Rush shipping changes transit time only and does not shorten production unless a separate rush-production agreement is approved."],
