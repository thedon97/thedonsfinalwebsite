...
const emeraldRadianceMetals = [ [ "14K Yellow Gold", 1600 ], [ "14K White Gold", 1600 ], [ "14K Rose Gold", 1600 ], [ "18K Yellow Gold", 2200 ], [ "18K White Gold", 2200 ], [ "18K Rose Gold", 2200 ] ];

const azureMarquiseCarats = [ [ "1 carat", 1800 ], [ "1.5 carat", 2200 ], [ "2 carats", 2600 ], [ "2.5 carats", 3000 ], [ "3 carats", 3400 ], [ "3.5 carats", 3800 ], [ "4 carats", 4200 ], [ "4.5 carats", 4600 ], [ "5 carats", 5000 ], [ "5.5 carats", 5400 ], [ "6 carats", 5800 ] ];
...
const uploadedRingProducts = [ {
    ...
    price: 1600,
    estimate: 1600,
    priceLabel: "Starting at $1,600 in 14K gold",
    image: "ring-product-black-02.png",
    alt: "Emerald cut green gemstone ring in yellow gold with diamond band",
    lede: "A green emerald-cut center stone ring with a diamond pave band, available in 14K or 18K gold options. Starting at $1,600 before final stone and gold selections.",
    cta: "Request Emerald Radiance Ring Quote",
    badges: [ "Women's Ring", "Emerald Style", "Starting at $1,600" ],
    buttons: [ "Add to Cart", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    ...
    price: 950,
    estimate: 950,
    priceLabel: "Starting at $950 in 14K gold",
    ...
    price: 975,
    estimate: 975,
    priceLabel: "Starting at $975 in 14K gold",
    ...
    price: 4200,
    estimate: 4200,
    priceLabel: "Starting at $4,200 in 14K gold",
    ...
    price: 1800,
    estimate: 1800,
    priceLabel: "Starting at $1,800 for 1 carat",
    ...
    metalSurcharges: engagementRingMetalSurcharges,
    buttons: [ "Add to Cart", "Request Exact Weight & Specifications", "Custom Order Inquiry", "Financing Available" ],
    fields: [ [ "Diamond Size", azureMarquiseCarats ], ...ringQuoteFields("Marquise", [ "Cluster halo", "Statement ring" ]) ]
}, {
    ...
    price: 2400,
    estimate: 2400,
    priceLabel: "Starting at $2,400 in 14K gold",
...
const donyaFloralCollectionProducts = [
    {
        ...
        price: 2600,
        estimate: 2600,
        priceLabel: "Starting at $2,600 in 14K gold",
        metalSurcharges: engagementRingMetalSurcharges,
        ...
        buttons: [ "Add to Cart", "Request Pricing", "Start Your Order", "Financing Available" ],
        fields: [ [ "Diamond Size", queenAureliaCarats ], [ "Center Stone Shape", [ "Elongated Cushion" ] ], [ "Metal", metals ], [ "Ring Size", ringSizes ], [ "Collection", [ "Custom Jewelry & Collections" ] ], [ "Visible Design", [ "Elongated cushion-cut white center diamond, cathedral setting, and diamond-set leaf shoulders" ] ], [ "Production", [ "Made to Order" ] ], [ "Customization", [ "Confirm center-stone specifications and final pavé details during consultation" ] ] ],
    ...
    },
    {
        ...
        buttons: [ "Add to Cart", "Request Pricing", "Start Your Order", "Financing Available" ],
        fields: [ [ "Diamond Size", queenAureliaCarats ], [ "Center Stone Shape", [ "Round" ] ], [ "Metal", metals ], [ "Ring Size", ringSizes ], [ "Collection", [ "Custom Jewelry & Collections" ] ], [ "Visible Design", [ "Round white center diamond, layered bloom, white-diamond pavé petals, and cathedral shoulders" ] ], [ "Production", [ "Made to Order" ] ], [ "Customization", [ "Confirm center-stone specifications and final pavé details during consultation" ] ] ],
        notice: "Final metal, diamond specifications, ring size, production details, and pricing are confirmed before the order begins."
    },
    {
        ...
        buttons: [ "Add to Cart", "Request Pricing", "Start Your Order", "Financing Available" ],
        fields: [ [ "Diamond Size", queenAureliaCarats ], [ "Center Stone Shape", [ "Round" ] ], [ "Metal", metals ], [ "Ring Size", ringSizes ], [ "Collection", [ "Custom Jewelry & Collections" ] ], [ "Visible Design", [ "Round white center diamond, floral setting, pink-diamond pavé petals, and cathedral shoulders" ] ], [ "Production", [ "Made to Order" ] ], [ "Customization", [ "Confirm center-stone specifications and final pavé details during consultation" ] ] ],
        notice: "Final metal, diamond specifications, ring size, production details, and pricing are confirmed before the order begins."
    },
    {
        ...
        price: 2450,
        estimate: 2450,
        priceLabel: "Starting at $2,450 in 14K rose gold; 18K starts at $3,200",
        ...
        buttons: [ "Add to Cart", "Request Pricing", "Start Your Order", "Financing Available" ],
        fields: [ [ "Metal", [ [ "14K Rose Gold", 2450 ], [ "18K Rose Gold", 3200 ] ] ], [ "Collection", [ "Custom Jewelry & Collections" ] ], [ "Jewelry Type", [ "Women's Stud Earrings" ] ], [ "Visible Design", [ "Rose-gold spiral petals, pink-diamond micro-pavé, round white center diamonds, and post backs" ] ], [ "Production", [ "Made to Order" ] ], [ "Customization", [ "Confirm center-stone specifications, earring dimensions, backing, and final pavé details during consultation" ] ] ],
    ...
    },
    {
        ...
        price: 2450,
        estimate: 2450,
        priceLabel: "Starting at $2,450 in 14K yellow gold; 18K starts at $3,200",
        ...
        buttons: [ "Add to Cart", "Request Pricing", "Start Your Order", "Financing Available" ],
        fields: [ [ "Metal", [ [ "14K Yellow Gold", 2450 ], [ "18K Yellow Gold", 3200 ] ] ], [ "Collection", [ "Custom Jewelry & Collections" ] ], [ "Jewelry Type", [ "Women's Stud Earrings" ] ], [ "Visible Design", [ "Yellow-gold spiral petals, white-diamond micro-pavé, round white center diamonds, and post backs" ] ], [ "Production", [ "Made to Order" ] ], [ "Customization", [ "Confirm center-stone specifications, earring dimensions, backing, and final pavé details during consultation" ] ] ],
        notice: "Final metal, diamond specifications, dimensions, backing style, production details, and pricing are confirmed before the order begins."
    },
    {
        ...
        price: 2450,
        estimate: 2450,
        priceLabel: "Starting at $2,450 in 14K white gold; 18K starts at $3,200",
        ...
        buttons: [ "Add to Cart", "Request Pricing", "Start Your Order", "Financing Available" ],
        fields: [ [ "Metal", [ [ "14K White Gold", 2450 ], [ "18K White Gold", 3200 ] ] ], [ "Collection", [ "Custom Jewelry & Collections" ] ], [ "Jewelry Type", [ "Women's Stud Earrings" ] ], [ "Visible Design", [ "White-gold spiral petals, blue-diamond micro-pavé, round white center diamonds, and post backs" ] ], [ "Production", [ "Made to Order" ] ], [ "Customization", [ "Confirm center-stone specifications, earring dimensions, backing, and final pavé details during consultation" ] ] ],
        notice: "Final metal, diamond specifications, dimensions, backing style, production details, and pricing are confirmed before the order begins."
    }
];
...
function financingAnnouncement() {
    return ` <aside class="financing-announcement" aria-label="Jewelry financing options"> <span class="financing-pulse" aria-hidden="true"></span> <strong><span class="finance-desktop-copy">$500 first custom-order credit</span><span class="finance-mobile-copy">$500 custom-order credit</span></strong> <span class="finance-desktop-copy">New clients: $500 off an eligible custom order of $2,500+. Or use THEDON15 at checkout. Promotions cannot stack.</span> <span class="finance-mobile-copy">Eligible $2,500+ orders · Financing available · Terms apply</span> <span class="bnpl-logos" aria-label="Eligible financing providers"><span class="bnpl-logo affirm-logo">affirm</span><span class="bnpl-logo klarna-logo">Klarna.</span><span class="bnpl-logo afterpay-logo">Afterpay</span></span> <a href="${internalLink("jewelry-financing")}">Explore financing</a> </aside> `;
}
